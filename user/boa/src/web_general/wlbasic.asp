...
<div class="intro_main ">
	<p class="intro_title"><% multilang(LANG_WLAN_BASIC_SETTINGS); %></p>
	<p class="intro_content"><% multilang(LANG_PAGE_DESC_WLAN_BASIC_SETTING); %></p>
</div>
...
<div class="data_common data_common_notitle">
	<table>
		...
		<tr>
			<th width="26%"><% multilang(LANG_BAND); %>:</th>
		...
		<tr>
			<th width="26%"><% multilang(LANG_MODE); %>:</th>
			<td width="74%"><select size="1" name="mode" onChange="updateMode()">
				<% checkWrite("wlmode"); %>
				</select>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" value="<% multilang(LANG_MULTIPLE_AP); %>" name="multipleAP" onClick="showMultipleAP(document.wlanSetup, '/admin/wlmultipleap.asp')" class="inner_btn">
			</td>
		</tr>
		<tr>
			<th width="26%"><% multilang(LANG_SSID); %>:</th>
	...
	<div  id="optionfor11n" style="display:none">
		<table>
			<tr>
				<th width="26%"><% multilang(LANG_CHANNEL_WIDTH); %>:</th>
			...
			<tr <% checkWrite("wlan_qtn_hidden_function"); %> >
				<th width="26%"><% multilang(LANG_CONTROL_SIDEBAND); %>:</th>
	...
	<table>
		<tr>
			<th width="26%"><% multilang(LANG_CHANNEL_NUMBER); %>:</th>
		...
		<tr <% checkWrite("wlan_qtn_hidden_function"); %>>
			<th width="26%"><% multilang(LANG_RADIO_POWER); %>:</th>
		...
		<tr id="wl_limit_stanum" style="display:none">
			<th width="26%"><% multilang(LANG_STA_NUMBER); %>:</th>
			<td>
		...
		<tr>
			<th width="26%"><% multilang(LANG_ASSOCIATED_CLIENTS); %>:</th>
	  ...
	  <!--<tr id="repeater_SSID" style="display:none">
		...
		<tr id="wifi_regdomain_demo" style="display:none">
			<th width="26%"><% multilang(LANG_REGDOMAIN); %>:</th>
