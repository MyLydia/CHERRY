...
<div class="intro_main ">
	<p class="intro_title"><% multilang(LANG_PORT_FORWARDING); %></p>
	<p class="intro_content"> <% multilang(LANG_PAGE_DESC_NAT_FIREWALL_FILTER_TABLE); %></p>
</div>
...
<div class="data_common data_common_notitle">
	<table>
		<tr>
			<th width="30%"><% multilang(LANG_PORT_FORWARDING); %>:</th>
			<td width="40%">
...
<div class="data_common data_common_notitle">
	<table>
		<tr>
			<th width="30%"><% multilang(LANG_ENABLE); %>
				<input type="checkbox" name="fw_enable" value="1" checked>
			</th>
			<th width="70%"><% multilang(LANG_APPLICATION); %>
...
<div class="btn_ctl">
	<input class="link_bg" type="submit" value="<% multilang(LANG_ADD); %>" name="addPortFw" onClick="return addClick(this)">
...
<div class="column">
	<div class="column_title">
		...
		<p> <% multilang(LANG_CURRENT_PORT_FORWARDING_TABLE); %></p>
...
<div class="btn_ctl">
	<input class="link_bg" type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="deleteSelPortFw" onClick="return deleteClick(this)">
	<input class="link_bg" type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="deleteAllPortFw" onClick="return deleteAllClick(this)">
</div>
	<script>
