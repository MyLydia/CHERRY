...
<div id="wlan_security_table" style="display:none" class="data_common data_common_notitle">
	...
	<table id="show_8021x_eap" style="display:none">
		<tr>
			...
			<% multilang(LANG_PASSWORD); %>:<input type="password" id="radius_pass" name="radiusPass" size="20" maxlength="64" value="12345">
			</td>
		</tr>
	...
	<table id="show2_8021x_eap" style="display:none">
		<tr>
			...
			<% multilang(LANG_PASSWORD); %>:<input type="password" id="radius2_pass" name="radius2Pass" size="20" maxlength="64" value="12345">
			</td>
		</tr>
	</table>								
