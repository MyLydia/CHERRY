...
function adslConnectionTypeSelection()
{
   if(4 == document.ethwan.ctype.value){
       document.ethwan.disableLanDhcp.checked = true;
   }else{
       document.ethwan.disableLanDhcp.checked = false;
   }
...
<table>
	...
	<% ShowConnectionType() %>
    <tr>
		<th><% multilang(LANG_DISABLE_LAN_DHCP); %>: </th>
	  <td><input type="checkbox" name="disableLanDhcp" size="2" maxlength="2" value="ON" >
		</td>
	</tr>
	<tr id=tbmtu>
		<th>MTU:  </th>
