...
<tr>
	<td>	<input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="apply" onClick="return saveClick(this)"></td>
</tr>
   
<tr>
	<th<% multilang(LANG_SAVE_LOG_TO_FILE); %>:</th>
	<td><input type="submit" value="<% multilang(LANG_SAVE); %>..." name="save_log" onClick="return on_submit(this)"></td>
</tr>
<tr>
	<th><% multilang(LANG_CLEAR_LOG); %>:</th>
	<td><input type="submit" value="<% multilang(LANG_RESET); %>" name="clear_log" onClick="return on_submit(this)"></td>
</tr>
</table>
<table>
<tr><hr size=1 noshade align=top></tr>
