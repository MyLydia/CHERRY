...
<body>
<blockquote>
<h2 class="page_title"><% multilang(LANG_TIME_ZONE); %><% multilang(LANG_CONFIGURATION); %></h2>
<table>
  <tr><td>
...
<table>
	<tr>
	<th> <% multilang(LANG_CURRENT_TIME); %> : </th>
	<td>
	...
	<tr><th><% multilang(LANG_TIME_ZONE_SELECT); %> : </th>
	    <td>
	...
	<tr><th colspan="2">
		...
		value="ON">&nbsp;&nbsp;<% multilang(LANG_ENABLE_DAYLIGHT_SAVING_TIME); %><br>
	    </th>
	</tr>
	...
	<tr><th colspan="2">
		...
		value="ON" 
		ONCLICK=updateState(document.time)>&nbsp;&nbsp;<% multilang(LANG_ENABLE_SNTP_CLIENT_UPDATE); %><br>
	    </th>
	</tr>
	<tr>
	...
	<tr>
	<th> SNTP <% multilang(LANG_SERVER); %> : </th>
	<td>
  ...
  <p><input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="save" onClick="return saveChanges(document.time,this)">
&nbsp;&nbsp;
