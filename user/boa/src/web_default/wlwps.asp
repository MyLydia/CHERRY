...
<script>
  if (autolockdown_stat) {
	...
	&nbsp;&nbsp;
  	<input type="submit" value="<% multilang(LANG_UNLOCK); %>" name="unlockautolockdown" onClick="return unlockdownClicked(this)">
	</td>  
</tr>
<tr>
...
<tr>
  ...
  <td>
  	<input type="submit" value="<% multilang(LANG_START_PIN); %>" name="triggerPIN" onClick="return triggerPINClicked(this)"></td>
	</td>  
</tr>
<script>
  if (!isClient) {
...
<tr>
  ...
  <td>
  	<input type="submit" value="<% multilang(LANG_START_PBC); %>" name="triggerPBC" onClick="return triggerPBCClicked(this)"></td>
	</td>  
</tr>
