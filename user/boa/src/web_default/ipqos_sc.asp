...
<td colspan="2"><hr size=1 noshade align=left></td>
...
<tr>
	<% dft_qos(); %>
	<td><input type=submit value="<% multilang(LANG_APPLY_CHANGES); %>" name=admin onClick="return on_submit(this)"></td>
</tr>
</table>
...
<td colspan="2"><hr size=1 noshade align=left></td>
<table>
<tr><th colspan="2"><u><% multilang(LANG_SPECIFY_TRAFFIC_CLASSIFICATION_RULES); %></u></th></tr>
</table>
...
<tr><th><% multilang(LANG_SOURCE); %> IP:</th><td><input type=text name=sip size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><th><% multilang(LANG_SOURCE_MASK); %>:</th><td><input type=text name=smask size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><th><% multilang(LANG_SOURCE_PORT); %>:</th><td><input type=text name=sport size=10 maxlength=5 onChange="onchange_sel1();"></td></tr>
<tr><th><% multilang(LANG_DESTINATION); %> IP:</th><td><input type=text name=dip size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><th><% multilang(LANG_DESTINATION_MASK); %>:</th><td><input type=text name=dmask size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><th><% multilang(LANG_DESTINATION_PORT); %>:</th><td><input type=text name=dport size=10 maxlength=5 onChange="onchange_sel1();"></td></tr>
	<th><% multilang(LANG_PHYSICAL_PORT); %>:</th>
...
<td colspan="2"><hr size=1 noshade align=left></td>
<table>
<tr><th colspan="2"><u><% multilang(LANG_ASSIGN_PRIORITY_AND_OR_IP_PRECEDENCE_AND_OR_TYPE_OF_SERVICE_AND_OR_DSCP); %></u></th></tr>
</table>
<table>
<tr><th><% multilang(LANG_OUTBOUND_PRIORITY); %>:</th>
	<td>
		<% pq_egress(); %>
	</td>
</tr>
...
<tr>
	<td><input type="submit" value="<% multilang(LANG_ADD); %>" name=addqos onClick="return addClick(this)"></td>
...
<form action=/boaform/formIPQoS method=POST name=qostbl>
  ...
  <br>
  <input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name=delSel onClick="return deleteClick(this)">&nbsp;&nbsp;
  <input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name=delAll onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
