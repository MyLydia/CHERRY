...
<body>
<blockquote>
<h2 class="page_title"><% multilang(LANG_ROUTING); %><% multilang(LANG_CONFIGURATION); %></h2>
...
<table width="600">
  ...
  <tr>
      ...
      <td><input type="text" name="destNet" size="15" maxlength="15"></td>
  </tr>
  <tr>
      <th><% multilang(LANG_SUBNET_MASK); %>:</th>
      <td><input type="text" name="subMask" size="15" maxlength="15"></td>
  </tr>
  <tr>
      <th><% multilang(LANG_NEXT_HOP); %>:</th>
      <td><input type="text" name="nextHop" size="15" maxlength="15"></td>
  </tr>
  <tr>
  ...
  <input type="submit" value="<% multilang(LANG_ADD_ROUTE); %>" name="addRoute" onClick="return addClick(this)">&nbsp;&nbsp;
  <input type="submit" value="<% multilang(LANG_UPDATE); %>" name="updateRoute" onClick="return addClick(this)">&nbsp;&nbsp;
  <input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delRoute" onClick="return deleteClick(this)">&nbsp;&nbsp;
