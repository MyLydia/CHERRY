...
<blockquote>
<h2 class="page_title">Active Wireless Client Table
<script>
	init();
	if (vap_id == 1) {
		document.write(" - AP1");
...
<tr bgcolor=#7f7f7f>
<td width="100" class="table_item">MAC Address</td>
<td width="60" class="table_item">Mode</td>
<td width="60" class="table_item">Tx Packet</td>
<td width="60" class="table_item">Rx Packet</td>
<td width="60" class="table_item">Tx Rate (Mbps)</td>
<td width="60" class="table_item">Power Saving</td>
<td width="60" class="table_item">Expired Time (s)</td></tr>
...
<tr bgcolor=#7f7f7f><td width="100" class="table_item">MAC Address</td>
<td width="60" class="table_item">>Mode</td>
<td width="60" class="table_item">Tx Packet</td>
<td width="60" class="table_item">Rx Packet</td>
<td width="60" class="table_item">Tx Rate (Mbps)</td>
...
<td width="60" class="table_item">Mode</td>
<td width="60" class="table_item">Tx Packet</td>
<td width="60" class="table_item">Rx Packe</td>
<td width="60" class="table_item">Tx Rate (Mbps)</td>
<td width="60" class="table_item">Power Saving</td>
<td width="60" class="table_item">Expired Time (s)</td></tr>
