...
function showDhcpv6Svr()
{
	...
	if (document.dhcpd.dhcpdenable[0].checked == true)
		...
		html+= '<input type="button" value="<% multilang(LANG_SHOW_CLIENT); %>" name="dhcpClientTblv6" onClick="openWindow(\'/dhcptblv6.asp\', \'\')" >'+
			'</td>'+
			'</tr>';
		...
		html += '<tr>'+
			...
			'<td><input type="submit" value="<% multilang(LANG_ADD); %>" name="addDomain" onClick="return on_submit(this)">&nbsp;&nbsp;</td>'+
			'</tr>'+ 
			'<br>'+
			'<br>'+
			...
			'</table>'+
			'<br>'+	
			'<input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delDomain" onClick="return on_submit(this)">&nbsp;&nbsp;'+
			'<input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="delAllDomain" onClick="return on_submit(this)">&nbsp;&nbsp;&nbsp;'+
			...
			'<td><input type="submit" value="<% multilang(LANG_ADD); %>" name="addNameServer" onClick="return on_submit(this)">&nbsp;&nbsp;</td>'+
			'</tr>'+ 
			'<br>'+
			'<br>'+
			'<table border=0 width="300" cellspacing=4 cellpadding=0>'+
			...
			'</table>'+
			'<br>'+	
			'<input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delNameServer" onClick="return on_submit(this)">&nbsp;&nbsp;'+
			'<input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="delAllNameServer" onClick="return on_submit(this)">&nbsp;&nbsp;&nbsp;';
		...
		document.getElementById('displayDhcpSvr').innerHTML=
			...
			'<input type="button" value="<% multilang(LANG_SHOW_CLIENT); %>" name="dhcpClientTblv6" onClick="openWindow(\'/dhcptblv6.asp\', \'\')" >&nbsp;&nbsp;'+
			'<input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="save" onClick="return on_submit(this)"></tr>';
}
...
<h2 class="page_title">DHCPv6 <% multilang(LANG_SETTINGS); %></h2>
...
<table>
  <tr>
  <th>DHCPv6 <% multilang(LANG_MODE); %>: </th>
  <td>
