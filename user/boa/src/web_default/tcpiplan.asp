...
<table>
  ...
  <tr>
      ...
      <td><input type="text" name="ip" id="ip" size="15" maxlength="15" value=<% getInfo("lan-ip"); %>></td>
  </tr>
  <tr>
      <th><% multilang(LANG_SUBNET_MASK); %>:</th>
      <td><input type="text" name="mask" id="mask" size="15" maxlength="15" value="<% getInfo("lan-subnet"); %>"></td>
  </tr>
