...
<table>
  ...
  <tr>
    <td colspan=4>
      <input type="submit" value="Apply" name="addServer" onClick="return setL2tpServer(this)">
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td colspan=4>
      <input type="submit" value="Add" name="addAccount" onClick="return addL2tpAccount(this)">
    </td>
  </tr>
</table>
<table>
...
<table>
  ...
  <tr>
    <td colspan=4>
      <input type="submit" value="Add" name="addClient" onClick="return addL2tpClient(this)">
    </td>
  </tr>
</table>
