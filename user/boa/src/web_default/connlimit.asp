...
<body>
<blockquote>
<h2 class="page_title"><% multilang(LANG_CONNECTION_LIMIT); %></h2>
...
<tr><th><% multilang(LANG_CONNECTION_LIMIT); %>:</th>
	<td>
...
<tr><th><% multilang(LANG_GLOBAL); %> TCP <% multilang(LANG_CONNECTION_LIMIT); %>:</th>
	<td><input type="text" name="tcpconnlimit" size="4" maxlength="4" value=<% getInfo("connLimit-tcp"); %>> &nbsp;(<% multilang(LANG_0_FOR_NO_LIMIT); %>) &nbsp; </td>
</tr>
<tr><th><% multilang(LANG_GLOBAL); %> UDP <% multilang(LANG_CONNECTION_LIMIT); %>:</th>
	<td><input type="text" name="udpconnlimit" size="4" maxlength="4" value=<% getInfo("connLimit-udp"); %> > &nbsp;(<% multilang(LANG_0_FOR_NO_LIMIT); %>) &nbsp; </td>
</tr>
<tr><td><input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="apply" onClick="return on_submit(this)">&nbsp;&nbsp;
...
<table>
	...
	<tr>
		...
		<td><input type="text" name="connnum" size="3" maxlength="5"></td>
		</td>
	</tr>
	<tr>
		<td>
...
<table>
  <tr><td><hr size=1 noshade align=top></td></tr>
  <tr><th><% multilang(LANG_CURRENT_CONNECTION_LIMIT_TABLE); %>:</th></tr>
</table>
<table>
<% connlmitList(); %>
</table>
