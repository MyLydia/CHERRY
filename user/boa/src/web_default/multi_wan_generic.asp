...
<input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="apply" onClick="return applyCheck(this)">&nbsp; &nbsp; &nbsp; &nbsp;
<input type="submit" value="<% multilang(LANG_DELETE); %>" name="delete" onClick="return deleteCheck(this)">
