...
<table border=0 width="600" cellspacing=0 cellpadding=0>
  ...
  <tr>
    <td colspan=4>
      <input type="submit" value="Apply" name="addServer" onClick="return setPptpServer(this)">
    </td>
  </tr>
</table>
...
<table border=0 width="600" cellspacing=0 cellpadding=0>
  ...
  <tr>
    <td colspan=4>
      <input type="submit" value="Add" name="addAccount" onClick="return addPptpAccount(this)">
    </td>
  </tr>
</table>
...
<input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delSelAccount" onClick="return on_submit(this)">&nbsp;&nbsp;
<input type="submit" value="<% multilang(LANG_SAVE); %>" name="saveAccount" onClick="return on_submit(this)">
...
<table border=0 width="600" cellspacing=0 cellpadding=0>
  ...
  <tr>
    <td colspan=4>
      <input type="submit" value="Add" name="addClient" onClick="return addPptpClient(this)">
    </td>
  </tr>
</table>
...
<input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delSelClient" onClick="return on_submit(this)">&nbsp;&nbsp;
