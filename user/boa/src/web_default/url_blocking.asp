...
<body>
<blockquote>
<h2 class="page_title">URL<% multilang(LANG_BLOCKING); %></h2>
...
<tr>
	<th>URL <% multilang(LANG_BLOCKING); %>:</th>
	<td>
...
<tr>
	<th><% multilang(LANG_FQDN); %>:<th>
	<td><input type="text" name="urlFQDN" size="15" maxlength="125">&nbsp;&nbsp;</td>
	<td><input type="submit" value="<% multilang(LANG_ADD); %>" name="addFQDN" onClick="return addFQDNClick(this)"></td>
</tr>
<br>
<br>
<table>
...
<table>
<tr><td>
<input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delFQDN" onClick="return deleteClick(this)">&nbsp;&nbsp;
<input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="delFAllQDN" onClick="return deleteAllClick(this)"></td>
</tr>
<tr><td><hr size=1 noshade align=top></td></tr>
</table>
 <script>
...
<tr>
	<th><% multilang(LANG_KEYWORD); %>:</th>
	<td><input type="text" name="Keywd" size="15" maxlength="18">&nbsp;&nbsp;</td>
	<td><input type="submit" value="<% multilang(LANG_ADD); %>" name="addKeywd" onClick="return addKeywordClick(this)"></td>
</tr>
<br>
<br>
<table>
...
<br>
<input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delKeywd" onClick="return deleteClick(this)">&nbsp;&nbsp;
<input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="delAllKeywd" onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
