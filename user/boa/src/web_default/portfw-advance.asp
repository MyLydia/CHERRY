...
<body>
<blockquote>
<h2 class="page_title"><% multilang(LANG_PORT_FORWARDING); %> - <% multilang(LANG_ADVANCED_SETTINGS); %></h2>

<form action=/boaform/formPFWAdvance method=POST name="portfwAdvance">
   <table>
      <hr size=2 noshade align=top>
      <tr>
          <td class="table_item"><% multilang(LANG_CATEGORY); %>: 
   ...
   <table>
      <hr size=2 noshade align=top>
      <tr>      
         <td width="150"><font size=2><b><% multilang(LANG_AVAILABLE_RULES); %></b></td>
         <td width="100"></td>
         <td width="150"><font size=2><b><% multilang(LANG_APPLIED_RULES); %></b></td>
      </tr>      
    ...
    <tr>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      
      <input type=submit value="<% multilang(LANG_ADD); %>" name="save" onClick="return PFWApply(this)">&nbsp;&nbsp;
    </tr>      
      
   <table>
    <tr><hr size=1 noshade align=top></tr>
    <tr><font size=2><b><% multilang(LANG_PORT_FORWARDING_ADVANCE_TABLE); %>:</b></font></tr>
    <% showPFWAdvTable(); %>
   </table>
   ...
   <input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delRule" onClick="return on_submit(this)">&nbsp;&nbsp;  
   <input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="delAllRule" onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
