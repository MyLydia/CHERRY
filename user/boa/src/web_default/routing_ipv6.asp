...
<table width="600">
  ...
  <input type="submit" value="<% multilang(LANG_ADD_ROUTE); %>" name="addV6Route" onClick="return addClick(this)">&nbsp;&nbsp;
  <input type="submit" value="<% multilang(LANG_UPDATE); %>" name="updateV6Route" onClick="return addClick(this)">&nbsp;&nbsp; 
  <input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delV6Route" onClick="return deleteClick(this)">&nbsp;&nbsp;
  <input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="delAllV6Route" onClick="return deleteAllClick(this)">&nbsp;&nbsp;
