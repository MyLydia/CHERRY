...
<body>
<blockquote>
<h2 class="page_title">GRE Configuration</h2>
<form action=/boaform/formGRE method=POST name="gre">

<table>
  <tr><td>
    <% multilang(LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_PARAMETERS_FOR_GRE); %>
  </td></tr>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
	<tr>
		<td lign=left width=30%><font size=2><b>GRE:</b></td>
		<td width=70%>
		...
		<td><input type="submit" value=<% multilang(LANG_APPLY_CHANGES); %> name="greSet" onClick="return on_submit(this)"></td>
	</tr>	
</table>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
	...
	<tr>
		<td lign=left width=30%><font size=2><b><% multilang(LANG_NAME); %>:</b></td>
		<td width=70%><input type="text" name="grename" size="32" maxlength="256"></td>
	</tr>
	<tr>
		<td lign=left width=30%><font size=2><b><% multilang(LANG_ADMIN_STATUS); %>:</b></td>
		<td width=70%>
	...
	<tr>
		<td lign=left width=30%><font size=2><b>Checksum:</b></td>
		<td width=70%>
	...
	<tr>
		<td lign=left width=30%><font size=2><b>Sequencing:</b></td>
		<td width=70%>
	...
	<tr>
		<td lign=left width=30%><font size=2><b>Key:</b></td>
		<td width=70%>
	...
	<tr>
		<td lign=left width=30%><font size=2><b>Key value:</b></td>
		<td width=70%><input type="text" name="keyValue" id="keyValue" size="6" maxlength="10"></td>
	</tr>
		<tr>
		<td lign=left width=30%><font size=2><b>DSCP:</b></td>
		<td width=70%>
	...
	<tr>
		<td lign=left width=30%><font size=2><b>GRE Endpoint:</b></td>
		<td width=70%><input type="text" name="greIP1" size="15" maxlength="125"></td>
	</tr>
	<tr>
		<td><font size=2><b>GRE Backup Endpoint:</b></td>
		<td width=70%><input type="text" name="greIP2" size="15" maxlength="125"></td>
	</tr>
	<tr>
		<td lign=left width=30%><font size=2><b>802.1Q <% multilang(LANG_VLAN_ID); %> :</b></td>
		<td width=70%><input type="text" name="grevid" id="grevid" size="6" maxlength="4">(1-4094),empty means no VLAN tag</td>
	</tr>
	<tr>
		<td lign=left width=30%><font size=2><b>Up Bandwidth:</b></td>
		<td width=70%><input type="text" name="uprate" id="uprate" size="6" maxlength="5">kbps,empty means no limitation</td>
	</tr>
	<tr>
		<td lign=left width=30%><font size=2><b>Down Bandwidth:</b></td>
		<td width=70%><input type="text" name="downrate" id="downrate" size="6" maxlength="5">kbps,empty means no limitation</td>
	</tr>
</table>

	<br>	
	<input type="submit" value=<% multilang(LANG_ADD); %> name="add" onClick="return saveChanges(this)">
	<input type="submit" value=<% multilang(LANG_MODIFY); %> name="modify"P onClick="return saveChanges(this)">
	<input type="submit" value=<% multilang(LANG_REMOVE); %> name="delgre" onClick="return saveChanges(this)">
	...
	<table border=0 width="800" cellspacing=4 cellpadding=0>
		<tr><font size=2><b>GRE <% multilang(LANG__TABLE); %>:</b></font></tr>
		<% showGRETable(); %>
	</table>
	<br>
