...
<body>
<blockquote>
<h2 class="page_title">Multiple APs</h2>
...
<tr bgcolor=#7f7f7f>
   <td class="table_item" align="center">No.</td>
   <td class="table_item" align="center">Enable</td>
   <td class="table_item" <% checkWrite("wlan_qtn_hidden_function"); %> align="center">Band</td>
   <td class="table_item" align="center">SSID</td>
   <td class="table_item" <% checkWrite("wlan_qtn_hidden_function"); %> align="center">Data Rate</td>
   <td class="table_item" align="center">Broadcast SSID</td>
   <td class="table_item" align="center">WMM</td>
   <td class="table_item" align="center">Relay Blocking</td>   
   <td class="table_item" id="wl_limit_stanum_div" align="center" style="display:none"><% multilang(LANG_STA_NUMBER); %></td>
   <td class="table_item" align="center">Active Client List</td>
   <td class="table_item" id="wl_txbf_div" align="center" style="display:none"><% multilang(LANG_TXBF); %></td>
   <td class="table_item" id="wl_txbfmu_div" align="center" style="display:none"><% multilang(LANG_TXBF_MU); %></td>
   <td class="table_item" id="wl_mc2u_div" align="center" style="display:none"><% multilang(LANG_MC2U); %></td>
</tr>
...
<tr>
	...
	<td id="wl_txbf_div4" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
		<select name=wl_txbf_ssid4 onChange="UpdateTxBf(document.MultipleAP, 4)">
			<option value="0">Disabled</option>
			<option value="1">Enabled</option>
		</select>
	</td>
	<td id="wl_txbfmu_div4" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
		<select name=wl_txbfmu_ssid4>
			<option value="0">Disabled</option>
			<option value="1">Enabled</option>
		</select>
	</td>
	<td id="wl_mc2u_div4" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
...
<input type="hidden" value="/admin/wlmultipleap.asp" name="submit-url">
  <input type="submit" value="Apply Changes"  onClick="return saveChanges(document.MultipleAP, wlan_idx)">&nbsp;&nbsp;
