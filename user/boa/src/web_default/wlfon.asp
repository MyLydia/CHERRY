...
<body>
<blockquote>
<h2 class="page_title">FON Spot Settings</h2>
...
<!--   <td align="center"><font size=2><b>No.</b></td>-->
   <td align="center" class="table_item">Enable</td>
   <td align="center" class="table_item">Band</td>
   <td colspan="2" align="center" class="table_item">SSID</td>
   <td align="center" class="table_item">Data Rate</td>
   <td align="center" class="table_item">Broadcast SSID</td>
   <td align="center" class="table_item">WMM</td>
   <td align="center" class="table_item">Relay Blocking</td>   
   <td align="center" class="table_item">Active Client List</td>
</tr>
