...
<body>
<blockquote>
<h2 class="page_title"><% multilang(LANG_ADDRESS_MAPPING_RULE); %><% multilang(LANG_CONFIGURATION); %></h2>
...
<% AddressMapList(); %>
 ...
 <br><input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="deleteSelAddressMap" onClick="return deleteClick(this)">&nbsp;&nbsp;
     <input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="deleteAllAddressMap" onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
     <input type="hidden" value="/multi_addr_mapping.asp" name="submit-url">
     <input type="hidden" name="postSecurityFlag" value="">
 <script>
