...
<blockquote>
<h2 class="page_title"><% multilang(LANG_MCAST_VLAN); %></h2> 
	<table>
		...
		<td class="td1"></td>
		<td class="td2">
		<input type="submit" class="button2" value="<% multilang(LANG_APPLY); %>" id="modify" style="display:none" onclick="return ModifyApply();" />
		<input name="back" type="button" id="back" value="<% multilang(LANG_UNDO); %>"  class="button2" onclick="back2add()" style="display:none"/>
		</td>
		</tr>		
		<div align="left" style="padding-left:20px;"><br>
			<table id="lstrc" border="1" style="border:2px solid;">
				<tr class="hdb" align="center" nowrap>
					<th bgcolor="#808080" width="200"><% multilang(LANG_INTERFACE); %></th>
					<th bgcolor="#808080" width="100"><% multilang(LANG_MCAST_VLAN); %></th>
					<th bgcolor="#808080" width="100"><% multilang(LANG_MODIFY); %></th>
				</tr>
			</table>
		</div>
