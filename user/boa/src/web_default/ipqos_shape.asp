...
<h2 class="page_title">IP QoS <% multilang(LANG_TRAFFIC_SHAPING); %></h2>
<form action="/boaform/formQosShape" method="post" name="qosShape">

<table>
<tr><td><font size=2><% multilang(LANG_ENTRIES_IN_THIS_TABLE_ARE_USED_FOR_TRAFFIC_CONTROL); %></font></td></tr>
<tr><td><hr size=1 noshade align=top></td></tr>
</table>

<p><% multilang(LANG_TOTAL_BANDWIDTH_LIMIT); %>:<input type="text" id="totalbandwidth" size="6" maxlength="6" value="1024">Kb</p>
...
<tr class="hdb" align="center" nowrap>
	...
	<td bgcolor="#808080"><% multilang(LANG_WAN_INTERFACE); %></td>
	<td bgcolor="#808080"><% multilang(LANG_PROTOCOL); %></td>
	<td bgcolor="#808080"><% multilang(LANG_SOURCE); %> Port</td>
	<td bgcolor="#808080"><% multilang(LANG_DESTINATION); %> Port</td>
	<td bgcolor="#808080"><% multilang(LANG_SOURCE); %> IP</td>
	<td bgcolor="#808080"><% multilang(LANG_DESTINATION); %> IP</td>
	<td bgcolor="#808080"><% multilang(LANG_RATE); %>(kb/s)</td>
	<td bgcolor="#808080"><% multilang(LANG_DELETE); %></td>
</tr>
</table>
...
<tr align="left">
<td>
	<input type="button" class="button" onClick="on_Add()" value="<% multilang(LANG_ADD); %>">
</td>
<td>
	<input type="button" class="button" onClick="on_submit(this);" value="<% multilang(LANG_APPLY_CHANGES); %>">
</td>
<td>
	<input type="button" class="button" onClick="on_apply_bandwidth(this);" value="<% multilang(LANG_APPLY_TOTAL_BANDWIDTH_LIMIT); %>">
</td>
</tr>
</table>
...
<br>
<input type="button" name="apply" value="save" onClick="on_apply(on_submit);" style="width:80px">
</div>
