...
<table id=body_header>
		<tr>
         ...
         <br>
<input type='submit' onClick='return btnApply(this)' value='<% multilang(LANG_APPLY); %>' name="save"><input type='button' onClick='return btnCancel()' value='<% multilang(LANG_CANCEL); %>'>
</div>
