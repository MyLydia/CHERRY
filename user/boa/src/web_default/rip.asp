...
<table>
	<tr>
		...
		<td><input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="ripSet" onClick="return on_submit(this)"></td>
	</tr>
</table>
<table>
	<tr><td><hr size=1 noshade align=top></td></tr>
...
<table> 
	...
	<br>
	<td><input type="submit" value="<% multilang(LANG_ADD); %>" name="ripAdd" onClick="return on_submit(this)"></td>
...
<table>
	...
	<br>
	<input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="ripDel" onClick="return deleteClick(this)">&nbsp;&nbsp;  
	<input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="ripDelAll" onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
