...
<input type="submit" value="<% multilang(LANG_ASSIGN); %> IP" name="addIP" onClick="return addClick(this)">&nbsp;&nbsp;
<input type="submit" value="<% multilang(LANG_DELETE_ASSIGNED_IP); %>" name="delIP" onClick="return on_submit(this)">&nbsp;&nbsp; 
