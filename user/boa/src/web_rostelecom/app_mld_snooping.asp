...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000">
	<blockquote>
		...
		<DIV align="left" style="padding-left:20px; padding-top:5px">
			<form id="form" action=/boaform/admin/formMLDSnooping method=POST name="mldsnoop">				
				<table>
				...
				<br>
				<input type="submit" class="button" name="apply" value="<% multilang(LANG_APPLY_CHANGES); %>"> 
				<input type="hidden" name="submit-url" value="/admin/app_mld_snooping.asp">
			<script>
