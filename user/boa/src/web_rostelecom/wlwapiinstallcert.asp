...
<BODY>
<blockquote>
<h2 class="page_title">WAPI <% multilang(LANG_CERTIFICATION_INSTALLATION); %></h2>
...
<table>
 ...
 <!--
  ...
  -->
  <tr>
      <th>ASU <% multilang(LANG_CERTIFICATION); %>:&nbsp;&nbsp;&nbsp;&nbsp;</th>
      <td><input type="file" value=<% multilang(LANG_CHOOSE_FILE); %> name="asu_binary" size=20></td>
  </tr>
<!--  <tr>
...
-->
  <tr>
      <th>User <% multilang(LANG_CERTIFICATION); %>:&nbsp;&nbsp;&nbsp;&nbsp;</th>
      <td><input type="file" value=<% multilang(LANG_CHOOSE_FILE); %> name="user_binary" size=20></td>
  </tr>
  </table>
    <p> <input onclick=sendClicked(this.form) type=button value="<% multilang(LANG_UPLOAD); %>" name="send">&nbsp;&nbsp;
        <input type="reset" value="<% multilang(LANG_RESET); %>" name="reset">
