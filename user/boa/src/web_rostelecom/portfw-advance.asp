...
<form action=/boaform/formPFWAdvance method=POST name="portfwAdvance">
   ...
   <table>
    ...
    <tr>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      
      <input type=submit value="<% multilang(LANG_ADD); %>" name="save" onClick="return PFWApply()">&nbsp;&nbsp;
    </tr>      
   ...
   <input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="delRule">&nbsp;&nbsp;  
   <input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="delAllRule" onClick="return deleteAllClick()">&nbsp;&nbsp;&nbsp;
