...
<table>
<form action=/boaform/admin/formPortFw method=POST name="formPortFwAdd">
...
<tr><th><% multilang(LANG_PORT_FORWARDING); %>:
	...
	<td><input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="apply">&nbsp;&nbsp;
</td></tr>
<tr><td><hr size=1 noshade align=top></td></tr>
</table>
<table>
...
<table>
	...
	<tr>
		<td>
			...
			<input type="hidden" value="/admin/fw-portfw.asp" name="submit-url">
		</td>
	</tr>
...
<form action=/boaform/admin/formPortFw method=POST name="formPortFwDel">
	<table>
