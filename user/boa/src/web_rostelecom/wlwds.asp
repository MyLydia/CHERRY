...
<table width="800">
	...
	<tr>
	   ...
	   <td><input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="wdsSet">&nbsp;&nbsp;</td>
	</tr>
</table>
...
<% checkWrite("wl_txRate"); %>
	...
	<tr>
		<td colspan=2>
			<input type="submit" value="<% multilang(LANG_ADD); %>" name="addWdsMac" onClick="return addClick()">&nbsp;&nbsp;
...
<form action=/boaform/admin/formWlWds method=POST name="formWlWdsDel">
  ...
  <br>
  <input type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="deleteSelWdsMac" onClick="return deleteClick()">&nbsp;&nbsp;
  <input type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="deleteAllWdsMac" onClick="return deleteAllClick()">&nbsp;&nbsp;&nbsp;
  <input type="reset" value="<% multilang(LANG_RESET); %>" name="reset">
  <input type="hidden" value="/admin/wlwds.asp" name="submit-url">
  <input type="hidden" name="wlan_idx" value=<% checkWrite("wlan_idx"); %>>
 <script>
