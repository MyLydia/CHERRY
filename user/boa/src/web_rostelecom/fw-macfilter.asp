...
<body>
<blockquote>
<h2 class="page_title"><% multilang(LANG_MAC_FILTERING_FOR_BRIDGE_MODE); %></h2>
...
<tr><th><% multilang(LANG_OUTGOING_DEFAULT_ACTION); %>&nbsp;&nbsp;
...
<tr><th><% multilang(LANG_INCOMING_DEFAULT_ACTION); %>&nbsp;&nbsp;
   	<input type="radio" name="inAct" value=0 <% checkWrite("macf_in_act0"); %>><% multilang(LANG_DENY); %>&nbsp;&nbsp;
   	<input type="radio" name="inAct" value=1 <% checkWrite("macf_in_act1"); %>><% multilang(LANG_ALLOW); %>&nbsp;&nbsp;</th>
<th><input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="setMacDft">&nbsp;&nbsp;
...
<tr>
	<th>
        <% multilang(LANG_DESTINATION); %> <% multilang(LANG_MAC_ADDRESS); %>: 
        </th>
        <td>
...
<tr>
	...
	<input type="radio" name="filterMode" value="Allow">&nbsp;&nbsp;<% multilang(LANG_ALLOW); %><br></font>
	</td>
	<td><font size=2>
