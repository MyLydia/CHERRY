...
<form action=/boaform/admin/formFilter method=POST name="formFilterAdd">
	<tr><td><font size=2><b><% multilang(LANG_DEFAULT_ACTION); %></b>&nbsp;&nbsp;
		<input type="radio" name="outAct" value=0 <% checkWrite("ipf_out_act0"); %>><% multilang(LANG_WHITE_LIST); %>&nbsp;&nbsp;
		<input type="radio" name="outAct" value=1 <% checkWrite("ipf_out_act1"); %>><% multilang(LANG_BLACK_LIST); %>&nbsp;&nbsp;
	</font></td><tr>
	<tr><td><hr size=1 noshade align=top></td></tr>	
<tr>
	<th>
...
<tr>
	<th>
	<% multilang(LANG_DESTINATION); %> <% multilang(LANG_IP_ADDRESS); %>:  <input type="text" name="dip" size="10" maxlength="15">&nbsp;&nbsp;</th>
...
<tr>
	...
	<input type="hidden" value="/admin/fw-ipportfilter_rg.asp" name="submit-url">
	</td>
</tr>
<tr><td><hr size=1 noshade align=top></td></tr>
</form>
