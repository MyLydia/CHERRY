...
<form action="form2RoseWizard3.cgi" method=POST name="RoseWizard3">
	<div class="data_common data_common_notitle">
		<table>
			<tr>
				<th width="25%"><% multilang(LANG_CHOOSE_BRANCH); %></th>
				<th>
				<select name="branch" id="branch" size=1 onchange = "onChangeBranch();">
				</select>
				</th>
				<td rowspan="3" class="data_prompt_td_info">
					<% multilang(LANG_PLEASE_SELECT_THE_MACRO_REGIONAL_BRANCH_AND_THE_BRANCH_WHERE_YOU_ARE); %>
				</td>
			</tr>
			<tr>
				<th width="25%"><% multilang(LANG_CHOOSE_CITY); %></th>
				<th>
			...
			<tr>
				<th width="25%"><% multilang(LANG_CHOOSE_SERVICE); %></th>
				<th>
		...
		<table>
			<tr>
				...
				<select name="branch" size=1>
				    <option value="0"><% multilang(LANG_NORTHWEST); %></option>
				    <option value="1"><% multilang(LANG_VOLGA); %></option>
				    <option value="2"><% multilang(LANG_URAL); %></option>
				</select>
				</th>
				<td rowspan="3" class="data_prompt_td_info">
					<% multilang(LANG_PLEASE_SELECT_THE_MACRO_REGIONAL_BRANCH_AND_THE_BRANCH_WHERE_YOU_ARE); %>
			...
			<tr>
				...
				<select name="city" size=1>
				    <option value="0"><% multilang(LANG_NIZHNY_NOVGOROD); %></option>
				    <option value="1"><% multilang(LANG_YOSHKAR_OLA); %></option>
				    <option value="2"><% multilang(LANG_CHEBOKSARY); %></option>
				</select>
				</th>
			</tr>
			<tr>
