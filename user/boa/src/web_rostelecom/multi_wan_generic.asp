...
<BODY onLoad="on_init();">
<blockquote>
<h2 class="page_title"><% getWanIfDisplay(); %> <% multilang(LANG_WAN); %></h2>
...
<table>
	...
	<tr>
		<th><% multilang(LANG_ENABLE_VLAN); %>: 
		<input type="checkbox" name="vlan" size="2" maxlength="2" value="ON" onClick=vlanClicked()></th>
	</tr>
	<tr>
...
<div ID=dgwshow>
<table>
<th><% multilang(LANG_DEFAULT_ROUTE); %>:
