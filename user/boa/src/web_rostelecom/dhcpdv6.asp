...
function showDhcpv6Svr()
{
	...
	if (document.dhcpd.dhcpdenable[0].checked == true)
		...
		document.getElementById('displayDhcpSvr').innerHTML=
			...
			'<input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="save"></tr>';
}
...
<form action=/boaform/admin/formDhcpv6Server method=POST name="dhcpd">
<table>
...
<table>
  ...
  <tr><td ID="displayDhcpSvr"></td></tr>
   ...
   <br>
      <input type="hidden" value="/admin/dhcpdv6.asp" name="submit-url">
