...
<tr>
	<td><input type="submit" value="Apply Changes" name="apply" onClick="return saveClick()"></td>
</tr>
   
<tr>
	<th>Save Log to File:</th>
	<td><input type="submit" value="Save..." name="save_log"></td>
</tr>
<tr>
	<th>Clear Log:</th>
	<td><input type="submit" value="Reset" name="clear_log"></td>
</tr>
</table>
