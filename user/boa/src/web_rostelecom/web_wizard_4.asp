...
function checkIPTVSetting()
{
	...
	{
		alert("<% multilang(LANG_CAN_T_BIND_THE_LAN_PORT_THAT_PC_CONNECTS_TO_IPTV_PORT_PLEASE_CHANGE_THE_IPTV_PORT); %>");
		return false;
	}
...
function checkVOIPSetting()
{
	...
	{
		alert("<% multilang(LANG_CAN_T_BIND_THE_LAN_PORT_THAT_PC_CONNECTS_TO_VOIP_PORT_PLEASE_CHANGE_THE_VOIP_PORT); %>");
		return false;
	}
...
function onClickContinue(index)
{
	...
	else if(serviceType == 5)
	{
		...
		else
		{
			...
			{
				alert("<% multilang(LANG_IPTV_AND_VOIP_CAN_NOT_BIND_THE_SAME_LAN_PORT); %>");
...
<form action=/boaform/form2WebWizard4 method=POST name="WebWizard4">
	...
	<div class="data_common data_common_notitle">
		<table>
			...
			<tr id="pppVlan" style="display:none;">
				<th width="25%"><% multilang(LANG_VLAN_ID); %>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
				<th>
		...
		<table>
			<tr>
				<td colspan="2" class="data_prompt_td_info" style="padding-top:40px; padding-bottom:40px;">
					<% multilang(LANG_SELECT_PORTS_THAT_WILL_BE_USED_TO_CONNECT_THE_SETTOP_BOX_AFTER_SETTING_UP_THE_SETTOP_BOX_CONNECT_THE_SELECTED_DEVICE_TO_THE_SELECTED_LAN_PORT); %>
				</td>
			</tr>
			<tr>
				<th colspan="2">
				    <div>
				        <p class="portbox_title"><% multilang(LANG_SELECT_PORT_TO_CONNECT_STB); %></p>
			...
			<tr id="iptvVlan" style="display:none;">
				<th width="46%" style="text-align:right;"><% multilang(LANG_VLAN_ID); %>
				&nbsp;&nbsp;</th>
				<th>
	...
	<div class="data_common data_common_notitle" display="none">
		<table>
			<tr>
				<td colspan="2" class="data_prompt_td_info" style="padding-top:40px; padding-bottom:40px;">
					<% multilang(LANG_SELECT_PORT_TO_CONNECT_SIP_PHONE); %>
				</td>
			</tr>
			<tr>
				<th colspan="2">
				    <div>
				        <p class="portbox_title"><% multilang(LANG_SELECT_PORT_TO_CONNECT_SIP_PHONE); %></p>
				        <div class="portbox_content">
				            <p class="portbox_text">
				                <span id="span1">Lan1</span>
				                <span>Lan2</span>
