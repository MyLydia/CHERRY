...
<body onLoad="on_init();">
<blockquote>
<h2 class="page_title">RADVD <% multilang(LANG_CONFIGURATION); %></h2>

<form action=/boaform/admin/formRadvdSetup method=POST name="radvd">
<table>
  <tr><td><font size=2>
...
<table>
  ...
  <tr><th><% multilang(LANG_ADVOTHERCONFIGFLAG); %>:&nbsp;&nbsp;</th>  
      <td>
...
<table>
  ...
  <table >
  <tr><th><% multilang(LANG_ENABLE_ULA); %>: &nbsp;&nbsp;</th>  
      <td>
  ...
  <tr>
      <th><% multilang(LANG_ULA_PREFIX); %>:</th>
      <td><input type="text" name="ULAPrefix" size="48" maxlength="48" value=<% getInfo("V6ULAPrefix"); %>></td>
  </tr><br>

  <tr>
      <th><% multilang(LANG_ULA_PREFIX_LEN); %>:</th>
      <td><input type="text" name="ULAPrefixlen" size="10" maxlength="10" value=<% getInfo("V6ULAPrefixlen"); %>></td>
  </tr><br>
  <tr>
      <th><% multilang(LANG_ULA_PREFIX_VALID_TIME); %>:</th>
      <td><input type="text" name="ULAPrefixValidTime" size="10" maxlength="10" value=<% getInfo("V6ULAPrefixValidLifetime"); %>></td>
  </tr><br>
  <tr>
      <th><% multilang(LANG_ULA_PREFIX_PREFERED_TIME); %>:</th>
      <td><input type="text" name="ULAPrefixPreferedTime" size="10" maxlength="10" value=<% getInfo("V6ULAPrefixPreferredLifetime"); %>></td>
  </tr><br><br>
  </div>
  ...
  <tr>
      <th><% multilang(LANG_PREFIX_MODE); %>:</th>
  ...
  <div ID="radvdID" style="display:none">
       <table>
         ...
         <tr><th><% multilang(LANG_ADVAUTONOMOUS); %>:</b>&nbsp;&nbsp;</th>  
             <td>
  ...
  <br>
      ...
      <input type="hidden" value="/admin/radvdconf.asp" name="submit-url">
