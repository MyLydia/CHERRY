...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_MAC_BASED_ASSIGNMENT); %></font></h2>

<table>
  <tr><td><font size=2>
 <% multilang(LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_STATIC_IP_BASE_ON_MAC_ADDRESS_YOU_CAN_ASSIGN_DELETE_THE_STATIC_IP_THE_HOST_MAC_ADDRESS_PLEASE_INPUT_A_STRING_WITH_HEX_NUMBER_SUCH_AS_00_D0_59_C6_12_43); %>
  </font></td></tr>
  <tr><td><hr size=1 noshade align=top></td></tr>
</table>

<form action=/boaform/admin/formmacBase method=POST name="macBase">
...
<table>
<tr>
        <th><% multilang(LANG_MAC_ADDRESS); %> (xx-xx-xx-xx-xx-xx): </th> 
        <td><input type="text" name="hostMac" size="20" maxlength="17">&nbsp;&nbsp;</td>
</tr>
<tr>
        <th><% multilang(LANG_ASSIGNED_IP_ADDRESS); %> (xxx.xxx.xxx.xxx): </th>
        <td><input type="text" name="hostIp" size="20" maxlength="15">&nbsp;&nbsp;</td>
</tr>
</table>

<input type="submit" value="<% multilang(LANG_ASSIGN); %> IP" name="addIP" onClick="return addClick()">&nbsp;&nbsp;
<input type="submit" value="<% multilang(LANG_DELETE_ASSIGNED_IP); %>" name="delIP">&nbsp;&nbsp; 
<input type="hidden" value="/admin/macIptbl.asp" name="submit-url">
<input type="button" value="<% multilang(LANG_CLOSE); %>" name="close" onClick="javascript: window.close();">

<tr><hr size=1 noshade align=top></tr>
<table
  <tr><font size=2><b><% multilang(LANG_MAC_BASED_ASSIGNMENT); %><% multilang(LANG_TABLE_2); %>:</b></font></tr>
  <% showMACBaseTable(); %>
</table>
