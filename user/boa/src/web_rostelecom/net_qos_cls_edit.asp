...
var connTypes = new it_nr("connlst", 
 new it(0, ""),
 new it(4, "Other"),
 new it(1, "TR069"), 
 new it(2, "INTERNET"), 
 new it(3, "INTERNET_TR069"), 
 new it(8, "Voice"), 
 new it(9, "Voice_TR069"),
 new it(10, "Voice_INTERNET"),
 new it(11, "Voice_INTERNET_TR069"));
 
 var applications = new it_nr("applst", 
 new it(0, ""),
 new it(21, "Telnet"),
 new it(22, "SSH"),
 new it(23, "FTP"), 
...
var ipversions = new Array("<% multilang(LANG_PLEASE_SELECT_IP_VERSION); %>", "IPv4", "IPv6");
//default
quekeys.add(new it("", ""));
<% initRulePriority(); %>
...
var opts = new Array(new Array("prio", quekeys), new Array("proto", protos),
	...
	new Array("conntype", connTypes), new Array("application", applications));
...
function on_submit() 
{
	with (document.forms[0]) {
		...
		*/
		...
		{
			sbmtstr = sbmtstr+"&application="+application.value;
		}		
		else if(qostype_select_type==6)
		{
			// dhcp opt Base
...
function displayByType() 
{
	...
	with (document.all) {
		...
		conn_type_base.style.display = 'none';
		application_base.style.display = 'none';
...
function displayEach(qostype_select_type)
{
	...
	document.all.conn_type_base.style.display = "none";
	document.all.application_base.style.display = 'none';
	...
	{
		document.all.conn_type_base.style.display = "block";
	}
	else if(qostype_select_type==5)
	{
		document.all.application_base.style.display = "block";
	}	
	else if(qostype_select_type==6)
	{ //DHCP option based
	...
	<blockquote>
		<DIV align="left" style="padding-left:20px; padding-top:5px;">
			<form id="form" action="/boaform/admin/formQosRuleEdit" method="post"  name="qosrule">
				<h2 class="page_title"><% multilang(LANG_ADD_QOS_CLASSIFICATION_RULES); %></h2>				
				<div class="tip" style="width:90% ">
					&nbsp;&nbsp;<% multilang(LANG_THIS_PAGE_IS_USED_TO_ADD_A_IP_QOS_CLASSIFICATION_RULE); %><br>
				</div>
				<br>				
				...
				<table>				
				       <tr><th><% multilang(LANG_RULE); %><% multilang(LANG_NAME); %>:</th><td><input type="text" id="name" size="22" style="width:200px "></td></tr>					
					<tr><th><% multilang(LANG_RULE); %>Order:</th><td><input type="text" id="qos_order" size="22" style="width:200px "></td></tr>
					<tr><td colspan="2">&nbsp; </td></tr>
					<tr><th colspan="2"><% multilang(LANG_ASSIGN); %> IP <% multilang(LANG_PRECEDENCE); %>/DSCP/802.1p</th></tr>					
					<tr><td colspan="2">&nbsp; </td></tr>
					<tr><th><% multilang(LANG_PRECEDENCE); %>:</th><td><select id="prio" size="1"></select></td></tr>
					<!--
					<tr><th> <div id='vid_mark'  style="display:<% check_display("vid_mark"); %>;"><% multilang(LANG_VLAN_ID); %> (1~4095): </div></td><td><div id='vid_mark_input'  style="display:<% check_display("vid_mark"); %>;"><input type="text" id="mvid" size="15" maxlength="4"></div></td></tr>					
					-->
					<tr><th>DSCP:</th><td><select id="mdscp" size="1"></select></td></tr>
					<tr><th>802.1p:</th><td><select id="m1p" size="1"></select></td></tr>
					
					<tr><td colspan="2">&nbsp; </td></tr>
					<tr><th colspan="2"><% multilang(LANG_SPECIFY_TRAFFIC_CLASSIFICATION_RULES); %></th></tr>
					<tr><td colspan="2">&nbsp; </td></tr>
					...
					<tr>
						...
						<td><font size=2><input type="radio"  name=qos_rule_type value=0 onClick=ruleType_click();><% multilang(LANG_PORT); %></td>	
						<td><font size=2><input type="radio"  name=qos_rule_type value=1 onClick=ruleType_click();><% multilang(LANG_ETHERY_TYPE); %></td>	
						<td><font size=2><input type="radio"  name=qos_rule_type value=2 onClick=ruleType_click();><% multilang(LANG_IP_PROTOCOL); %></td>	
						<td><font size=2><input type="radio"  name=qos_rule_type value=3 onClick=ruleType_click();><% multilang(LANG_MAC_ADDRESS); %></td>	
						<td><font size=2><input type="radio"  name=qos_rule_type value=4 onClick=ruleType_click();><% multilang(LANG_CONNECTION_TYPE); %></td>
						<td><font size=2><input type="radio"  name=qos_rule_type value=5 onClick=ruleType_click();><% multilang(LANG_APPLICATION); %></td>
						<% ipqos_dhcpopt(); %>
					</tr>
					</table>
					
					<tr><div id='wan_interface'  style="display:<% check_display("wan_interface"); %>;" > <th colspan="2"><% multilang(LANG_WAN); %>:</t><th><select id="outif" size="1" onChange="onchange_sel1();"><% if_wan_list("queueITF"); %></select></td></div></tr>
	
	
					<div id="port_base" style="display:none;">
				       <table>
				        <tr><td colSpan="1">&nbsp; </td></tr>
					<tr><th colspan="2"><% multilang(LANG_PHYSICAL_PORT); %>:</th><td><select id="phypt" size="1" onChange="onchange_sel1();"></select></td></tr>
				       </table>
				</div>
				...
				<div id="ip_proto_base" style="display:none;">
					...
					<table>
					<tr><td colSpan="1">&nbsp; </td></tr>
					<tr><th><% multilang(LANG_PROTOCOL); %>:</th><td><select id="proto" size="1" onChange="onChange_proto();"></select></td></tr>
					<tr><th>DSCP:</th><td><select id="dscp" size="1" onChange="onchange_sel1();"></select></td></tr>
					</table>
					<div id='ip4tbl' style="display:block;">
					<table cellSpacing="1" cellPadding="0" border="0">
						<tr><th><% multilang(LANG_SOURCE); %> IP: </th><td><input type="text" id="sip" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>
						<tr><th><% multilang(LANG_SOURCE_MASK); %>: </th><td><input type="text" id="smsk" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>					
						<tr><th><% multilang(LANG_DESTINATION); %> IP: </th><td><input type="text" id="dip" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>
						<tr><th><% multilang(LANG_DESTINATION_MASK); %>: </th><td><input type="text" id="dmsk" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>					
					</table>				
					</div>
				
					<div id='ip6tbl' style="display:none">
					<table>
						<tr><th><% multilang(LANG_SOURCE); %> IP: </th><td><input type="text" id="sip6" size="36" maxlength="39" style="width:200px " onChange="onchange_sel1();"></td></tr>
						<tr><th><% multilang(LANG_SOURCE_PREFIX_LENGTH); %>: ></th><td><input type="text" id="sip6PrefixLen" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>					
						<tr><th><% multilang(LANG_DESTINATION); %> IP: </th><td><input type="text" id="dip6" size="36" maxlength="39" style="width:200px " onChange="onchange_sel1();"></td></tr>
						<tr><th><% multilang(LANG_DESTINATION_PREFIX_LENGTH); %>: </th><td><input type="text" id="dip6PrefixLen" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>					
					</table>
					 </div>
					<table cellSpacing="1" cellPadding="0" border="0">
					<tr><th><% multilang(LANG_SOURCE_PORT); %>: </th><td><input type="text" id="spts" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();">:<input type="text" id="spte" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();"></td></tr>
					<tr><th><% multilang(LANG_DESTINATION_PORT); %>: </th><td><input type="text" id="dpts" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();">:<input type="text" id="dpte" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();"></td></tr>
				...
				<div id="mac_base" style="display:none;">
					<table>
					<tr><td colSpan="1">&nbsp; </td></tr>
					<tr><th><% multilang(LANG_SOURCE); %> MAC:</th><td><input type="text" id="smac" size="17" maxlength="17" style="width:200px " onChange="onchange_sel1();"></td></tr>
					<tr><th><% multilang(LANG_DESTINATION); %> MAC:</th><td><input type="text" id="dmac" size="17" maxlength="17" style="width:200px " onChange="onchange_sel1();"></td></tr>
					</table>
				</div>	
				...
				<div id="ether_type_base" style="display:none;">
					<table>
					<tr><td colSpan="1">&nbsp; </td></tr>
					<tr><th>Ethernet Type:</th><td><b>0x</b><input type="text" id="ethType" size="5" maxlength="5" style="width:97px" onChange="onchange_sel3();"></td></tr>
					</table>
				</div>

				<div id="conn_type_base" style="display:none;">
					<table>
					<tr><td colSpan="1">&nbsp; </td></tr>
					<tr><td><% multilang(LANG_CONNECTION_TYPE); %>:</td><td><select id="conntype" size="1"></select></td></tr>
					</table>
				</div>

				<div id="application_base" style="display:none;">
					<table>
					<tr><td colSpan="1">&nbsp; </td></tr>
					<tr><td><% multilang(LANG_APPLICATION); %>:</td><td><select id="application" size="1"></select></td></tr>
					</table>
				</div>	

				<div id="dhcp_opt_base" style="display:none;">
				<table>
                                    	<tr><th><% multilang(LANG_DHCP_OPTIONS); %>: </th>
                               
						<td width="160px"><font size=2><input type="radio"  name=dhcpopt_type value=0 onClick=dhcpopt_click();><% multilang(LANG_OPTION_60); %></td>	
						<td width="160px"><font size=2><input type="radio"  name=dhcpopt_type value=1 onClick=dhcpopt_click();><% multilang(LANG_OPTION_61); %></td>
						<td width="160px"><font size=2><input type="radio"  name=dhcpopt_type value=2 onClick=dhcpopt_click();><% multilang(LANG_OPTION_125); %></td>	
...
<div id="dhcp_opt_base_opt60" style="display:none;">
	<table>
<tr>
    <font size=2><% multilang(LANG_OPTION_60); %>:</td>
</tr>
<tr class="dhcp_opt_60">
    <td><font size=2>&nbsp;&nbsp;&nbsp;&nbsp;<% multilang(LANG_VALUE); %>:</td>
...
<div id="dhcp_opt_base_opt61" style="display:none;">                                  
	<table>
	<td font size=2><% multilang(LANG_DHCP_OPTIONS_61); %>:</td>

<tr class="dhcp_opt_61">
	<td><font size=2>&nbsp;&nbsp;&nbsp;&nbsp;<% multilang(LANG_IAID); %>:</td>
	<td><input type="text" name="opt61_iaid" size="20" maxlength="10"></td>
</tr>
<tr class="dhcp_opt_61">
	<td><font size=2>&nbsp;&nbsp;&nbsp;&nbsp;<% multilang(LANG_DUID_TYPE); %>:</td>
...
<div id="dhcp_opt_base_opt125" style="display:none;">                                  
	<table>
    <td font size=2><% multilang(LANG_DHCP_OPTIONS_125); %>:</td>
</tr>
...
<p>
				<div id="configuration_2" style="display:none;">
					<table>
					<tr><td colSpan="2">&nbsp; </td></tr>
					<tr><th colSpan="2"><% multilang(LANG_CONFIGURATION); %> - 2</th></tr>
					<tr><th>802.1p:</th><td><select id="vlan1p" size="1" onChange="onchange_sel2();"></select></td></tr>
					</table>
				</div>	
				</div>
				...
				<hr class="sep" size="1" width="100%">
				<br>
				<input type="button" class="button" onClick="on_submit();" value="<% multilang(LANG_APPLY_CHANGES); %>">
