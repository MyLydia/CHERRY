	...
	<div class="data_common data_common_notitle">
		<table>
			<tr class="data_prompt_info">
				<th colspan="2"><font size="6px" color="green"><% multilang(LANG_CONNECTION_TO_ADSL_THE_DEVICE_WILL_BE_AVAILABLE_THROUGH); %></font></th>
			</tr>
			<tr class="data_prompt_info">
				<th>
			...
			<tr class="data_prompt_info">
				<th><font size="4px" color="red"><% multilang(LANG_WARNING_DO_NOT_POWER_OFF_THE_DEVICE); %></font></th>
			</tr>
		</table>
