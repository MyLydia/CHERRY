...
<form action=/boaform/admin/formRouting method=POST name="route">
<table width="600">
  <tr><td><font size=2>
...
<table width="600">
  ...
  <input type="button" value="<% multilang(LANG_SHOW_ROUTES); %>" name="showRoute" onClick="routeClick('/admin/routetbl.asp')">
<table width="600">
  <tr><td><hr size=1 noshade align=top></td></tr>
</table>
<table width="600">
  ...
  <br>
      <input type="hidden" value="/admin/routing.asp" name="submit-url">
</form>
</blockquote>
</body>
