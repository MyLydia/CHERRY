...
<body>
<blockquote>
<h2 class="page_title"><% multilang(LANG_DYNAMIC); %> DNS <% multilang(LANG_CONFIGURATION); %></h2>
...
<table>
  ...
  <tr>
      <th>DDNS <% multilang(LANG_PROVIDER); %>:</th>
      <td width="70%">
...
<table border=0 width="800" cellspacing=4 cellpadding=0>
  ...
  <br>
      <input type="hidden" value="/admin/ddns.asp" name="submit-url">
