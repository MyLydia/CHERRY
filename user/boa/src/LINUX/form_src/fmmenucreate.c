...
#define GPON_TYPE_STR "GPON Type"
...
#endif
#ifdef IP_ACL
  {"IPv6 ACL", MENU_URL, "aclv6.asp", "IPv6 ACL Configuration", 0, 0, MENU_DISPLAY, LANG_IPV6_ACL},
#endif
  {0, 0, 0, 0, 0, 0, 0, 0}
};
#endif
...
static struct RootMenu childmenu_wapi2[] = {
	{"Certification Installation", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlwapiinstallcert.asp&wlan_idx=2", "WAPI certificate install", 0, 0, MENU_DISPLAY, LANG_CERTIFICATION_INSTALLATION},
	//{"Key Update", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlwapiRekey.asp&wlan_idx=2", "WAPI key update", 0, 0, MENU_DISPLAY},
	{0, 0, 0, 0, 0, 0, 0, 0}
};
...
#endif
#ifdef WLAN_MESH
	{"MESH", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlmesh.asp&wlan_idx=0", "MESH Settings", 0, 0, MENU_DISPLAY, LANG_WLAN_MESH},
#endif
#if defined(WLAN_CLIENT) || defined(WLAN_SITESURVEY)
#ifdef CONFIG_00R0
	{"Wi-Fi Radar", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlsurvey.asp&wlan_idx=0", "Wi-Fi Radar", 0, 0, MENU_DISPLAY, LANG_SITE_SURVEY},
#else
...
#endif
#ifdef WLAN_MESH
	{"MESH", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlmesh.asp&wlan_idx=1", "MESH Settings", 0, 0, MENU_DISPLAY, LANG_WLAN_MESH},
#endif
#if defined(WLAN_CLIENT) || defined(WLAN_SITESURVEY)
#ifdef CONFIG_00R0
	{"Wi-Fi Radar", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlsurvey.asp&wlan_idx=1", "Wi-Fi Radar", 0, 0, MENU_DISPLAY, LANG_SITE_SURVEY},
#else
...
#if defined(TRIBAND_SUPPORT)
struct RootMenu childmenu_wlan2[] = {
	{"Basic Settings", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlbasic.asp&wlan_idx=2",	"Setup wireless basic configuration", 0, 0, MENU_DISPLAY, LANG_BASIC_SETTINGS},
	{"Advanced Settings", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wladvanced.asp&wlan_idx=2",   "Setup wireless advanced configuration", 0, 0, MENU_DISPLAY, LANG_ADVANCED_SETTINGS},
	{"Security", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlwpa.asp&wlan_idx=2", "Setup wireless security", 0, 0, MENU_DISPLAY, LANG_SECURITY},
#ifdef WLAN_11R
	{"Fast Roaming", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlft.asp&wlan_idx=2", "Fast BSS Transition", 0, 0, MENU_DISPLAY, LANG_FAST_ROAMING},
#endif
#ifdef WLAN_ACL
	{"Access Control", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlactrl.asp&wlan_idx=2",	"Setup access control list for wireless clients", 0, 0, MENU_DISPLAY, LANG_ACCESS_CONTROL},
#endif
#ifdef WLAN_WDS
	{"WDS", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlwds.asp&wlan_idx=2", "WDS Settings", 0, 0, MENU_DISPLAY, LANG_WDS},
#endif
#ifdef WLAN_MESH
	{"MESH", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlmesh.asp&wlan_idx=2", "MESH Settings", 0, 0, MENU_DISPLAY, LANG_WLAN_MESH},
#endif
#if defined(WLAN_CLIENT) || defined(WLAN_SITESURVEY)
#ifdef CONFIG_00R0
	{"Wi-Fi Radar", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlsurvey.asp&wlan_idx=2", "Wi-Fi Radar", 0, 0, MENU_DISPLAY, LANG_SITE_SURVEY},
#else
	{"Site Survey", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlsurvey.asp&wlan_idx=2", "Wireless Site Survey", 0, 0, MENU_DISPLAY, LANG_SITE_SURVEY},
#endif
#endif
#ifdef CONFIG_WIFI_SIMPLE_CONFIG	// WPS
	{"WPS", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlwps.asp&wlan_idx=2", "Wireless Protected Setup", 0, 0, MENU_DISPLAY, LANG_WPS},
#endif
#ifdef CONFIG_RTL_WAPI_SUPPORT
	{"WAPI", MENU_FOLDER, &childmenu_wapi2, "",
		sizeof (childmenu_wapi2) / sizeof (struct RootMenu) - 1, 0, MENU_DISPLAY, LANG_WAPI},
#endif
	{"Status", MENU_URL, "boaform/formWlanRedirect?redirect-url=/wlstatus.asp&wlan_idx=2", "Wireless Current Status", 0, 0, MENU_DISPLAY, LANG_STATUS},
	{0, 0, 0, 0, 0, 0, 0, 0}
};
#endif /* defined(TRIBAND_SUPPORT) */
...
{"LAN", MENU_URL, "tcpiplan.asp", "LAN Interface Settings", 0, 0, MENU_DISPLAY, LANG_LAN},
#ifdef CONFIG_RTL867X_VLAN_MAPPING
{"VLAN Mapping",MENU_URL,"net_vlan_mapping.asp","VLAN Mapping Status",0,0,MENU_DISPLAY,  LANG_VLAN_MAPPING},
#endif
  {0, 0, 0, 0, 0, 0, 0, 0}
};
...
struct RootMenu childmenu_wlan[] = {
  ...
  {"wlan2 (2.4GHz)", MENU_FOLDER, &childmenu_wlan2, "", sizeof (childmenu_wlan2) / sizeof (struct RootMenu) - 1, 0, MENU_DISPLAY, LANG_WLAN2_2_4GHZ},
...
#endif
#ifdef WLAN_MESH
  {"MESH", MENU_URL, "wlmesh.asp", "MESH Settings", 0, 0, MENU_DISPLAY, LANG_WLAN_MESH},
#endif
#if defined(WLAN_CLIENT) || defined(WLAN_SITESURVEY)
#ifdef CONFIG_00R0
...
struct RootMenu childmenu_wan[] = {
  ...
  {"GRE Settings", MENU_URL, "gre.asp", "Setup GRE WAN", 0, 0, MENU_DISPLAY, LANG_GRE_SETTINGS},
#endif
...
struct RootMenu childmenu_adv[] = {
  ...
  {"LAN Device Table", MENU_URL, "landevice.asp", "LAN Device Table", 0, 0, MENU_DISPLAY, LANG_LAN_DEVICE_TABLE},
#endif
#ifndef CONFIG_SFU
  ...
  {"SNMP", MENU_URL, "snmpv3.asp", "SNMP Protocol Configuration", 0, 0, MENU_DISPLAY, LANG_SNMP},
#endif
...
struct RootMenu childmenu_diag[] = {
  ...
  {"EthOAM", MENU_URL, "ethoam.asp", "Ethernet OAM", 0,   0, MENU_DISPLAY, LANG_ETH_OAM},
#endif 
  {0, 0, 0, 0, 0, 0, 0, 0}
};
struct RootMenu childmenu_admin[] = {
  ...
  {GPON_TYPE_STR, MENU_URL, "gpon_type.asp", "GPON Type", 0, 0, MENU_HIDDEN, LANG_GPON_TYPE},
#endif
#endif
...
#endif
#ifdef CONFIG_RTK_L34_ENABLE
  {"Multicast Vlan", MENU_URL, "app_iptv.asp", "Multicast Vlan", 0, 0, MENU_DISPLAY, LANG_MCAST_VLAN},
#endif  
#if defined(CONFIG_GPON_FEATURE)
...
#endif
  {"Advanced",  MENU_URL,   "voip_advanced.asp",        "Setup VoIP Advanced Settings",     0, 0, MENU_DISPLAY, LANG_ADVANCED},
...
//{"Config",    MENU_URL,   "voip_config.asp",          "Configuration Upload/Download",    0, 0, MENU_DISPLAY, LANG_CONFIG},
  ...
  {"Call History",  MENU_URL,   "voip_callhistory.asp",     "Call History",                     0, 0, MENU_DISPLAY, LANG_VOIP_CALLHISTORY},
...
#endif
{"LAN", MENU_FOLDER, &childmenu_lan, "",
   sizeof (childmenu_lan) / sizeof (struct RootMenu) - 1, 0, MENU_DISPLAY, LANG_LAN},
...
#ifdef CONFIG_00R0
			setMenuVisibilityByName(menu, GPON_TYPE_STR, MENU_DISPLAY);
#endif
		}
