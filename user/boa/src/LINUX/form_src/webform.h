...
extern void SendWebHeadStr(int eid, request * wp, int argc, char **argv);
...
#endif
#ifdef WLAN_11K
extern void ShowDot11k_v(int eid, request * wp, int argc, char **argv);
#endif
...
extern void extra_wlbasic(int eid, request * wp, int argc, char **argv);
extern void extra_wladvanced(int eid, request * wp, int argc, char **argv);
...
#ifdef CONFIG_00R0
extern void ShowConnectionTypeForBridge(int eid, request * wp, int argc, char **argv);
#endif
#endif
...
extern void formVLANMapping(request * wp, char *path, char *query);
extern int itfSelList(int eid, request * wp, int argc, char **argv);
extern int mappingInputList(int eid, request * wp, int argc, char **argv);
#endif
#endif
...
#ifdef CONFIG_00R0
extern void ShowPPPIPSettings_admin(int eid, request * wp, int argc, char **argv);
#endif
...
extern void ShowMLDSetting(int eid, request * wp, int argc, char **argv);

#ifdef CONFIG_00R0
extern void ShowRIPv2Setting(int eid, request * wp, int argc, char **argv);
#endif
...
extern void formCatv(request * wp, char *path, char *query);
extern int fmcatv_checkWrite(int eid, request * wp, int argc, char **argv);
#endif 
