...
#if 0 //bruce, tmp for 98D Triband
#define CONFIG_WLAN
#define CONFIG_USE_PCIE_SLOT_0
#define CONFIG_SLOT_0_8822BE
#define CONFIG_USE_PCIE_SLOT_1
#define CONFIG_SLOT_1_8822BE
#define CONFIG_WLAN_HAL_8822BE
#define CONFIG_BAND_5G_ON_WLAN0
#define CONFIG_RTL_5G_SLOT_0
//#define CONFIG_RTL_5G_SLOT_1
#define CONFIG_RTL_TRIBAND_SUPPORT
//#define CONFIG_USB_AS_WLAN1

#define CONFIG_RTK_DEV_AP
#endif //bruce
...
#define IS_AC_SUPPORT (!defined(CONFIG_RTL_8812AR_VN_SUPPORT) && \
...
#if (!defined(WLAN_DUALBAND_CONCURRENT) && (defined(CONFIG_RTL_8812_SUPPORT) || defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8822BE))) || \
...
#if IS_AC_SUPPORT && (!defined(WLAN_DUALBAND_CONCURRENT) || defined(CONFIG_WLAN0_5G_WLAN1_2G) || defined(BAND_5G_ON_WLAN0) || defined(CONFIG_NO_WLAN_DRIVER))
...
#if defined(CONFIG_WLAN0_2G_WLAN1_5G) || defined(BAND_2G_ON_WLAN0) || defined(WLAN1_QTN)
	//dualband
#define WLAN1_5G_SUPPORT 1
#endif

#if defined(CONFIG_WLAN1_5G_11AC_SUPPORT) || defined(WLAN1_QTN) || \
    (IS_AC_SUPPORT && (defined(BAND_2G_ON_WLAN0) || defined(CONFIG_WLAN0_2G_WLAN1_5G)))
...
#elif defined(CONFIG_RTL_92D_SUPPORT) || (defined(WLAN_DUALBAND_CONCURRENT) && !defined(WLAN1_QTN))
...
#if defined (WLAN_DUALBAND_CONCURRENT) && defined(CONFIG_WLAN0_5G_WLAN1_2G)
...
#if defined(WLAN_SUPPORT) && defined(CONFIG_RTK_L34_ENABLE) && defined(CONFIG_FON_GRE)
