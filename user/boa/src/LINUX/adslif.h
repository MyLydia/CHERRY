...
enum 
{
	 DSL_STATUS_DISABLED = 0,
	 DSL_STATUS_UP,
	 DSL_STATUS_INITIALIZING,
	 DSL_STATUS_ESTABLISHINGLINK,
	 DSL_STATUS_NOSINGNAL,
	 DSL_STATUS_ERROR
};
...
//#endif /*CONFIG_DSL_VTUO*/
	...
	//--
	GetHEC=83,//val[0:1]={DS US};unsigned
	GetOCD=84,//val[0:1]={DS US};unsigned
	GetLCD=85,//val[0:1]={DS US};unsigned
	GetTotalCell=86,//val[0:1]={DS US};unsigned
	GetDataCell=87,//val[0:1]={DS US};unsigned
	GetBitError=88,//val[0:1]={DS US};unsigned
	GetVdslProfileCap=90	//read Vdsl2Profile capability
};
...
enum vdsl_profile{
        PROFILE_8A_MASK = 0x01<<16,
        PROFILE_8B_MASK = 0x02<<16,
        PROFILE_8C_MASK = 0x04<<16,
        PROFILE_8D_MASK = 0x08<<16,
        PROFILE_12A_MASK = 0x10<<16,
        PROFILE_12B_MASK = 0x20<<16,
        PROFILE_17A_MASK = 0x40<<16,
        PROFILE_30A_MASK = 0x80<<16,
        PROFILE_35B_MASK = 0x100<<16,
};
#endif
...
enum gfast_profile{	
	...
	PROFILE_106C = 0x08,
	PROFILE_212C = 0x10,
	PROFILE_212B = 0x20,	/*Proprietary, not in standard*/
...
#ifdef CONFIG_USER_CMD_SUPPORT_GFAST
#define MODE_MASK (MODE_ANSI|MODE_ETSI|MODE_GDMT|MODE_GLITE|MODE_ADSL2|MODE_ADSL2LITE|MODE_ADSL2PLUS|MODE_VDSL1|MODE_VDSL2|MODE_GFAST)
#else
#define MODE_MASK (MODE_ANSI|MODE_ETSI|MODE_GDMT|MODE_GLITE|MODE_ADSL2|MODE_ADSL2LITE|MODE_ADSL2PLUS|MODE_VDSL1|MODE_VDSL2)
#endif

#if !defined(CONFIG_USER_CMD_CLIENT_SIDE)
enum Vdsl2Profile 
{ 
