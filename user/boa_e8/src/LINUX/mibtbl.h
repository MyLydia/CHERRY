...
#define _OFFSET(field)			((intptr_t)FIELD_OFFSET(MIB_T,field))
#define _SIZE(field)			sizeof(((MIB_T *)0)->field)
#define _OFFSET_CE(type, field)		((intptr_t)(long *)&(((type *)0)->field))
#define _SIZE_CE(type, field)		sizeof(((type *)0)->field)

#define _OFFSET_HW(field)		((intptr_t)FIELD_OFFSET(HW_MIB_T,field))
#define _SIZE_HW(field)			sizeof(((HW_MIB_T *)0)->field)

#define _OFFSET_RS(field)		((intptr_t)FIELD_OFFSET(RS_MIB_T,field))
