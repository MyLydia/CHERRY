...
var wlan_module_enable = new Array();
wlan_module_enable[0] = <% checkWrite("wlan_module_enable", "0"); %>;
wlan_module_enable[1] = <% checkWrite("wlan_module_enable", "1"); %>;
...
if(wlan_module_enable[i]){
	...
	if(!wlanDisabled[i]){
	document.write('<tr><td class="hdb">'+ssid_alias[i]+'名称</td><td>'+ssid_drv[i]+'</td></tr>');
	}
	...
	document.write('<tr><td class="hdb">'+ssid_alias[i]+'加密状态</td><td>');
	...
	//if (!wlanDisabled[i]) {
		for (idx=0; idx<mssid_num; idx++) {
			...
			//	document.write('<tr><td width=100% colspan="2">SSID-'+(idx+2+(mssid_num+1)*i)+'</td></tr>');
				...
				document.write('<tr><td class="hdb">'+mssid_alias[i][idx]+'名称</td><td>'+mssid_ssid_drv[i][idx]+'</td></tr>');
				document.write('<tr>\
	    			<td class="hdb">模式</td>\
			    	<td>');
				...
				document.write('</td></tr>');
				document.write('<tr><td class="hdb">'+mssid_alias[i][idx]+'加密状态</td>\
