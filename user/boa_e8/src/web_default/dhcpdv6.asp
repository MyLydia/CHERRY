...
function showDhcpv6Svr(ip)
{
	...
	if (document.dhcpd.dhcpdenable[0].checked == true)
		document.getElementById('displayDhcpSvr').innerHTML=
			'<input type="submit" value="保存/应用" name="save" onClick="return on_submit(this)">&nbsp;&nbsp;';
		...
		html += '<tr>'+
			...
			'</tr>'+							
			'</table>'+
			'<input type="submit" value="保存/应用" name="save" onClick="return saveChanges(this)">&nbsp;&nbsp;'+
			
			'<tr><hr size=1 noshade align=top></tr>'+
			'<tr>'+
				'<td><b>domain:</b></td>'+
				'<td><input type="text" name="domainStr" size="15" maxlength="50">&nbsp;&nbsp;</td>'+
				'<td><input type="submit" value="添加" name="addDomain" onClick="return on_submit(this)">&nbsp;&nbsp;</td>'+
			'</tr>'+ 
			'<br>'+
			'<br>'+
			...
			'</table>'+
			'<br>'+	
			'<input type="submit" value="删除" name="delDomain" onClick="return on_submit(this)">&nbsp;&nbsp;'+
			'<input type="submit" value="删除全部" name="delAllDomain" onClick="return on_submit(this)">&nbsp;&nbsp;&nbsp;'+
			...
			'<tr>'+
				...
				'<td><input type="submit" value="添加" name="addNameServer" onClick="return on_submit(this)">&nbsp;&nbsp;</td>'+
			'</tr>'+ 
			'<br>'+
			'<br>'+
			'<table border=0 width="300" cellspacing=4 cellpadding=0>'+
			...
			'</table>'+
			'<br>'+	
			'<input type="submit" value="删除" name="delNameServer" onClick="return on_submit(this)">&nbsp;&nbsp;'+
			'<input type="submit" value="删除全部" name="delAllNameServer" onClick="return on_submit(this)">&nbsp;&nbsp;&nbsp;';
