			...
			<form id="form" action="/boaform/admin/formPasswordSetup" method="post">
				<div align="left">
					...
					<table id="lstin" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>旧密码:</td>
							<td><input name="oldPasswd" type="password" autocomplete="off" size="20" maxlength="16" style="width:200px"></td>
						</tr>
						<tr>
							<td>新密码:</td>
							<td><input name="newPasswd" type="password" autocomplete="off" size="20" maxlength="16" style="width:200px"></td>
						</tr>
						<tr>
							<td>确认密码:</td>
							<td><input name="affirmPasswd" type="password" autocomplete="off" size="20" maxlength="16" style="width:200px"></td>
						</tr>
					</table>
				</div>
				<hr align="left" class="sep" size="1" width="90%">
				<input type="button" class="button" value="保存/应用" onclick="on_submit();">
				<input type="hidden" name="submit-url" value="/mgm_usr_user.asp">
