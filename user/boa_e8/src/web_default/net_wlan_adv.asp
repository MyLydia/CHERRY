	...
	<tr id="setting_wep" style="display:none">
		<td colspan="2" width="100%">
			<table width="100%" border="0" cellpadding="0" cellspacing="4">
				...
				<tr >
					<td width="30%">密钥长度:</td>
					<td width="70%"><select size="1" name="length0" id="length0" onChange="updateWepFormat(document.formEncrypt, 0)">
				...
				<tr>
					<td width="30%">密钥:</td>
					<td width="70%"><select id="format0" name="format0" onChange="setDefaultKeyValue(document.formEncrypt, 0)">
