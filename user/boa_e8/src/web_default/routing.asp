...
function deleteOneEntry(obj)
{
	...
	postTableEncrypt(document.route.postSecurityFlag, document.route);
	if ( !confirm('删除这项设定?') ) {
		return false;
	}
	else
...
<table border=0 width="600" cellspacing=4 cellpadding=0>
  ...
  <input type="submit" value="添加" name="addRoute" onClick="return addClick(this)">&nbsp;&nbsp;
  <input type="submit" value="更新" name="updateRoute" onClick="return addClick(this)">&nbsp;&nbsp;
  <input type="submit" value="删除" name="delRoute" onClick="return deleteOneEntry(this)">&nbsp;&nbsp;
