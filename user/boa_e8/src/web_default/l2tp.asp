...
function l2tpSelection()
{
	if (document.l2tp.l2tpen[0].checked) {
		...
		document.l2tp.pValue.disabled = true;
		...
		document.l2tp.pValue.disabled = false;
...
function addL2TPItf(obj)
{
	...
	if (document.l2tp.auth.selectedIndex!=3)
	{
		...
		if (document.l2tp.pValue.value=="") {			
			alert("please enter l2tp client password");
			document.l2tp.pValue.focus();
			return false;
		}
		if(!checkTextStr(document.l2tp.pValue.value))
		{			
...
<table border=0 width="500" cellspacing=0 cellpadding=0>
  ...
  <tr>
    ...
    <td width="60%"><input type="text" name="pValue" size="15" maxlength="35"></td>
  </tr>
  <tr>
...
<table border=0 width="500" cellspacing=0 cellpadding=0>
      ...
      <td><input type="submit" value="保存/应用" name="addL2TP" onClick="return addL2TPItf(this)">&nbsp;&nbsp;</td>
  </tr>
</table>
<br><br>
