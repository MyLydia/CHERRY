			...
			<form id="form" action=/boaform/admin/formDDNS method=POST>
				...
				<div id="orayInfo">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>密码:</td>
							<td><input type="text" name="oraypassword" autocomplete="off" style="width:200px "></td>
						</tr>
					</table>
				</div>
				<div id="dyndnsInfo">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>密码:</td>
							<td><input type="text" name="dynpassword" autocomplete="off" style="width:200px "></td>
						</tr>
					</table>
				</div>
				<div id="gnudipInfo">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>密码:</td>
							<td><input type="text" name="gnudippassword" autocomplete="off" style="width:200px "></td>
						</tr>
					</table>
				</div>
				<br>
