...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onLoad="on_init()">
	<table cellspacing="0" cellpadding="0" width="256" align="center" border="0"><tr valign="top"><td>
		<DIV align="left" style="padding-left:5px; padding-top:5px">
			<form id="form" action=/boaform/admin/formWlEncrypt method=POST>
...
-->	
				...
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<td width="180">密钥长度:</td>
		                     <td width="356" ><select name='wlKeyBit' size='1'>
					  ...
					  <td height="1">
						<table height="35" cellspacing="0" cellpadding="0" width="100%" border="0">
						  <tr>
				            ...
				            <td bgcolor="#427594" align="center"><img width="80" height="23" src="/image/cancel.gif" border="0" onClick="on_init();" style="cursor:pointer "></td>
						  </tr>
						</table>
					  </td>
					</tr>
				...
				<input type="hidden" name="submit-url" value="/ehomeclient/e8clientwlancfg.asp">
