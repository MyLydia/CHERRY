...
function on_submit(act) 
{
	with ( document.forms[0] ) 
	{
		...
		if(pValue.value!=""&&!sji_checkpswnor(pValue.value, 1, 32))
		{
			alert("请输入合法的密码！");
			return false;
		}
		...
		storage_encode.value = encode64(pValue.value);
		...
		<DIV align="left" style="padding-left:20px; padding-top:5px">
			<form id="form" action=/boaform/admin/formStorage method=POST>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="500">
					...
					<tr><td>密码:</td><td><input name="pValue" size="16" maxlength="32" type="text" autocomplete="off" style="width:140px "></td></tr>
				...
				<br>
				<input type="button" class="button" value="下载" onClick="on_submit('dl')">
				<input type="hidden" name="submit-url" value="/app_storage.asp">
				<input type="hidden" name="storage_encode" value="">
