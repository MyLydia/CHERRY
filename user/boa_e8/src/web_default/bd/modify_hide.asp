  ...
  <blockquote>
	<DIV align="left" style="padding-left:20px; padding-top:5px">
		<form id="form" action=/boaform/admin/formModify method=POST>	
			...
			<br>
			<input type="submit" class="button" value="保存" onClick="btnApply('access')"><br><br>

			
			<td><b>    用于临时开启关闭tr069 debug信息,重启后即失效:</b></td><br><br>
			<table border="0" cellpadding="0" cellspacing="0">
			<tr>
			<td><input type="submit" class="button" value="开启tr069 debug" onClick="btnApply('debugopen')">&nbsp;&nbsp;</td> 
			<td><input type="submit" class="button" value="关闭tr069 debug" onClick="btnApply('debugclose')"></td>
			</tr>
			</table>
			<br><br>
<!--
			...
			<tr>
              ...
              <br>
			<input type="button" class="button" value="保存" onClick="btnApply('modifyhard')">
			<br><br>  -->
