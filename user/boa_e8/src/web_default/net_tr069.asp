   ...
   <body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onLoad='on_init()'>
    ...
    选择期望值，并且点击“保存/应用”配置TR-069客户选项。<br>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
               ...
               <tr>
                  <td>密码:</td>
                  <td><input type='password' name='acsPwd' autocomplete="off" size="20" maxlength="256" value="<% getInfo("acs-password"); %>"></td>
               </tr>
			   <tr>
                  <td width="80">启用证书:</td>
          ...
          禁用</td>		
            ...
            <table border="0" cellpadding="0" cellspacing="0">
               ...
               <tr>
               <td>连接请求密码:</td>
                  <td><input type='password' name='connReqPwd' autocomplete="off" size="20" maxlength="256" value="<% getInfo("conreq-pw"); %>"></td>
               </tr>
            </table>
            <br>
    <p > 
