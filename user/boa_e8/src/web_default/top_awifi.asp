...
<table border="0" width="100%" cellspacing="0" cellpadding="0" height="43%">
  <tr>
    <td  width="100%"> <IMG height="100%" src="image/background_top.gif" width=100% border=0 style="height:57px !important"> </td>
  </tr>
	<tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="52%">
  <tr nowrap> 
    <td width="156" rowspan="3" bgcolor="#EF8218" style="font-size:21pt; text-align:center;" nowrap>&nbsp;<b><font color="#FFFFFF"><label id="menuname">状态</label></font></b>&nbsp;</td>
    <td height="18" bgcolor="#427594" width="100%" style="font-size:9pt" align="right"><font color="white">网关名称: 家庭网关&nbsp;&nbsp;&nbsp;&nbsp;</font><font color="black"><input type="submit" value="退出登录" onClick="return on_submit()"></font>&nbsp;&nbsp;</td>
  </tr>
  <tr> 
    <td height="43" valign="bottom"> 
		<table border="0" cellpadding="0" cellspacing="0" width="100%" height="43" bgcolor="#EF8218">
			<tr> 
			  <td width="10%" height="17" bgcolor="#EF8218" background="image/back_button.gif"></td>
			  <td width="10%"  bgcolor="#EF8218" background="image/back_button.gif"></td>
			  <td width="10%" bgcolor="#EF8218" background="image/back_button.gif"></td>
			  <td width="10%" bgcolor="#EF8218" background="image/back_button.gif"></td>
			  <td width="10%"  bgcolor="#EF8218" background="image/back_button.gif"></td>
			  <td width="10%" bgcolor="#EF8218" background="image/back_button.gif"></td>
