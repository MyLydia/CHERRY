...
<SCRIPT language="javascript" src="share.js" charset="gbk"></SCRIPT>
...
function on_lanipv6addrform_submit(reboot)
{
	...
	else
	{
		with ( document.forms[0] )
		{
			...
			postTableEncrypt(document.forms[0].postSecurityFlag, document.lanipv6addrform);
...
function on_lanipv6dnsform_submit(reboot)
{
	...
	with ( document.lanipv6dnsform )
	{
		...
		postTableEncrypt(document.forms[1].postSecurityFlag, document.lanipv6dnsform);
...
function on_lanipv6prefixmodeform_submit(reboot)
{
	with ( document.lanipv6prefixmodeform )
	{
			...
			postTableEncrypt(document.forms[2].postSecurityFlag, document.lanipv6prefixmodeform);
			submit();
	}
}
