	...
	<blockquote>
		<DIV align="left" style="padding-left:20px; padding-top:5px">
			<form id="form" action=/boaform/formMLDSnooping method=POST name="mldsnoop">
				<b>MLD Snooping 配置</b><br><br>
				这个页面允许你启用或者禁用MLD Snooping功能<br><br>
			
				<hr align="left" class="sep" size="1" width="90%">				
				<table border=0 width="500" cellspacing=4 cellpadding=0>
					<tr><td width=150>MLD Snooping:</td>
						<td width=350>
						<input type="radio" name=snoop value=0>禁用&nbsp;&nbsp;
						<input type="radio" name=snoop value=1>启用</td>
				</tr></table>
				<br>
				<input type="submit" class="button" value="保存/应用" onClick="return on_submit()">
