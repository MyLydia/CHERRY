...
<table border=0 width="600" cellspacing=4 cellpadding=0>
  ...
  <input class="btnaddup"  type="submit" value="添加" name="addRoute" onClick="return addClick()">&nbsp;&nbsp;
  <input class="btnsaveup"  type="submit" value="更新" name="updateRoute" onClick="return addClick()">&nbsp;&nbsp;
  <input class="btndeleup"  type="submit" value="删除" name="delRoute" onClick="return deleteClick()">&nbsp;&nbsp;
