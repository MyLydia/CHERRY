...
<table border=0 width="500" cellspacing=0 cellpadding=0>
  ...
  <tr>
      ...
      <td><input class="btnsaveup" type="submit" value="保存/应用" name="ripSet">&nbsp;&nbsp;</td>
  </tr>
</table>
...
<table border=0 width="500" cellspacing=0 cellpadding=0> 
  ...
  <tr>
      ...
      <td width="20%"><input class="btnaddup" type="submit" value="添加" name="ripAdd"></td>
  </tr>  
</table>   
...
<br>
   <input class="btndeleup" type="submit" value="删除" name="ripDel" onClick="return deleteClick()">&nbsp;&nbsp;      
   <input class="btndeleup" type="submit" value="删除全部" name="ripDelAll" onClick="return deleteAllClick()">&nbsp;&nbsp;&nbsp;
