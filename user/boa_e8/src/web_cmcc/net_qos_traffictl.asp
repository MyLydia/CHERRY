...
<DIV align="left" style="padding-left:20px; padding-top:5px;">
	<form id="form" action="/boaform/admin/formQosTraffictl" method="post">
			...
			<table class="flat" id="traffictl_tbl" border="1" cellpadding="0" cellspacing="1" width="100%">
			...
			<table><tr align="left">
			<td><input type="button" class="btnaddup" onClick="location.href='net_qos_traffictl_edit.asp';" value="添加"></td>
			<td><input type="button" class="btnsaveup" onClick="on_submit();" value="保存/应用"></td>
			<td>
			<div  id="apply"  style="display:none">
			<input type="button" class="btndeleup_l" onClick="on_apply_bandwidth();" value="应用总带宽设置">
			</div>
			<div  id="cancel" style="display:none">
			<input type="button" class="btndeleup_l" onClick="on_cancel_bandwidth();" value="取消总带宽限制">
			</div></td>
			</tr></table>
