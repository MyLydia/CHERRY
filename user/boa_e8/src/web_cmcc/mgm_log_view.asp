	...
	<blockquote>
		<div align="left" style="padding-left:20px; padding-top:5px">
			<form id="form" action="/boaform/admin/formSysLog" method="post">
				...
				<input type="button" class="btnsaveup" name="sysrec" onClick="btnView();" value="访问记录">
				...
				<input type="button" class="btnaddup" name="clrrec" onClick="on_submit('clr');" value="清除记录">
				<input type="button" class="btndeleup" name="saverec" onClick="on_submit('saveLog');" value="日志下载">
