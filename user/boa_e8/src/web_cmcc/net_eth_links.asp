	...
	{		
		...
		else if(obj.name == "lkmode")
		{
			...
			if (0 == obj.value)
			{
				...
				if(document.getElementById('lkname').value == 'new' || links[lk]["cmode"] > 0)
					mtu.value = 1500;
				else
	...
	<blockquote>
		<DIV align="left" style="padding-left:20px; padding-top:5px">
			<form id="form" action="/boaform/admin/formEthernet" method="post" name="adsl">
				...
				<hr align="left" class="sep" size="1" width="100%">
				<br>
				...
				<table id="tbdial" cellpadding="0px" cellspacing="2px">
					...
					<tr nowrap><td>密码：</td><td><input type="password"name="pppPassword" maxlength="30" size="16" style="width:150px "></td></tr>
				...
				<br>
				<input type="button" class="btnsaveup" onClick="on_submit('sv');;" value="应用">&nbsp; &nbsp; &nbsp; &nbsp; 
				<!--<input type="button" class="button" onClick="on_submit('rs');" value="重启">&nbsp; &nbsp; &nbsp; &nbsp;-->
				<input type="button" class="btndeleup" onClick="on_submit('rm');" value="删除">&nbsp; &nbsp; &nbsp; &nbsp; 
