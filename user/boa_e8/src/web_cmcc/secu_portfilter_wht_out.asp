...
var rcs = new Array();
with(rcs){<% ipPortFilterWhitelistOut(); %>}
	...
	<DIV align="left" style="padding-left:20px; padding-top:0px">
		<form id="form" action="/boaform/admin/formPortFilterWhiteOut" method="post">
			...
			<div class="tip" style="width:90% ">
				默认情况, 当防火墙启用时，禁止所有来自广域网的 IP 通信流入. 然而, 一些IP通信能被 <font color="green"><b>接受</b></font> 是通过设置过滤器.<br>
				选择添加或移除来配置流入IP过滤器.<br>
			</div>
			<br>
			-->
			<table id="lstrc" class="flat" border="1" cellpadding="1" cellspacing="0">
				<tr class="hdb" align="center" nowrap>
					<td width="100px">过滤名称</td>
					<!--
					<td width="100px">VPI/VCI</td>
					-->
					<td width="100px">协议</td>
					<td width="160px">源地址</td>
					<!--<td width="120px">源子网掩码</td>-->
					<td width="100px">源端口</td>
					<td width="160px">目的地址</td>
					<!--<td width="120px">目的子网掩码</td>-->
					<td width="100px">目的端口</td>
					<td width="60px">使能</td>	
					<td width="60px">删除</td>					
			...
			<br>
			<button class="btnaddupnew" onClick="parent.location.href='secu_portfilter_whtadd_out.asp';">添加</button>
			&nbsp;
			<button class="btnDelnew" onClick="on_submit();">删除</button>
