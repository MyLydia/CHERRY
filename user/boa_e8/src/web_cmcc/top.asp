...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="52%">
  <tr nowrap> 
    ...
    <td height="18" bgcolor="#427594" width="100%" style="font-size:9pt" align="right"><font color="white">网关名称: 家庭网关&nbsp;&nbsp;&nbsp;&nbsp;</font><font color="black"><input type="submit" value="退出登录"></font>&nbsp;&nbsp;</td>
  </tr>
  <tr> 
