	...
	<blockquote>
		<div align="left" style="padding-left:20px; padding-top:5px">
			<form id="form" action=/boaform/admin/formDDNS method=POST name="form">
				...
				<br><br><br>
				<div id="ddnsConfig">
				<table id="rulelst" class="flat" border="1" cellpadding="4" cellspacing="0" width="90%">
				...
				<hr align="left" class="sep" size="1" width="90%">
					<input type="button" class="btnaddup" name="add" onClick="window.location.assign('app_ddns_add.asp');" value="添加">
