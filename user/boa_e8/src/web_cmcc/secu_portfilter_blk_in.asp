...
var rcs = new Array();
with(rcs){<% ipPortFilterBlacklistIn(); %>}
...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onLoad="on_init();">
	...
	<DIV align="left" style="padding-left:20px; padding-top:0px">
		<form id="form" action="/boaform/admin/formPortFilterBlackIn" method="post">
			<!--
			<b>流出IP过滤器设置</b>
			<br><br>
...
<td width="60px">接口</td>
			...
			<br>
			<button class="btnaddupnew" onClick="parent.location.href='secu_portfilter_blkadd_in.asp';">添加</button>
			&nbsp;
