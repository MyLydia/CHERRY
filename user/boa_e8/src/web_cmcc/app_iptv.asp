...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onLoad="on_init();">
	<blockquote>
		...
		<td class="td1"></td>
		<td  class="td2">
		<input type="submit" class="btnsaveup" value="修 改" id="modify" style="display:none" onclick="return ModifyApply();" />
		<input name="back" type="button" id="back" value="取 消"  class="btndeleup" onclick="back2add()" style="display:none"/>
		</td>
		</tr>		
