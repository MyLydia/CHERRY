...
function showDhcpv6Svr(ip)
{
	...
	if (document.dhcpd.dhcpdenable[0].checked == true)
		document.getElementById('displayDhcpSvr').innerHTML=
			'<input class="btnsaveup"  type="submit" value="保存/应用" name="save">&nbsp;&nbsp;';
		...
		html += '<tr>'+
			...
			'</tr>'+							
			'</table>'+
			'<input  class="btnsaveup" type="submit" value="保存/应用" name="save" onClick="return saveChanges()">&nbsp;&nbsp;'+
			
			'<tr><hr class="sep" size=1 noshade align=top></tr>'+
			'<tr>'+
				'<td><b>domain:</b></td>'+
				'<td><input type="text" name="domainStr" size="15" maxlength="50">&nbsp;&nbsp;</td>'+
				'<td><input class="btnaddup" type="submit" value="添加" name="addDomain">&nbsp;&nbsp;</td>'+
			'</tr>'+ 
			'<br>'+
			'<br>'+
			...
			'</table>'+
			'<br>'+	
			'<input class="btndeleup" type="submit" value="删除" name="delDomain">&nbsp;&nbsp;'+
			'<input class="btndeleup" type="submit" value="删除全部" name="delAllDomain">&nbsp;&nbsp;&nbsp;'+
			...
			'<tr>'+
				...
				'<td><input class="btnaddup" type="submit" value="添加" name="addNameServer">&nbsp;&nbsp;</td>'+
			'</tr>'+ 
			'<br>'+
			'<br>'+
			'<table border=0 width="300" cellspacing=4 cellpadding=0>'+
			...
			'</table>'+
			'<br>'+	
			'<input class="btndeleup" type="submit" value="删除" name="delNameServer">&nbsp;&nbsp;'+
			'<input class="btndeleup" type="submit" value="删除全部" name="delAllNameServer">&nbsp;&nbsp;&nbsp;';
...
<hr size=1 noshade align=top class="sep">
