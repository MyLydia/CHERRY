		  ...
		  <tr>
			...
			<!-- // Mason Yu for IPv6. End-->
		     ...
		     <input type="hidden" value="/net_dns.asp" name="submit-url">
	 		  <input type="submit" class="btnsaveup" value="应用" name="save" onClick="return saveClick()">&nbsp;&nbsp;&nbsp;
	 		  <input type="button"  class="btndeleup" value="后退" name="save" onClick="history.back()">
		    </form>
		</DIV>
<script>
