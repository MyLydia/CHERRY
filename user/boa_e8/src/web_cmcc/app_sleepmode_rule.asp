		...
		<DIV align="left" style="padding-left:20px; padding-top:5px">
			<form id="form" action=/boaform/admin/formSleepMode method=POST name="form">
				...
				<div id="input_div">
					...
					<tr>
						<td  class="td2">
							<input type="submit" class="btnsaveup" value="保存" id="modify" onclick="return ModifyApply();" />
							<input name="back" type="button" id="back" value="取 消"  class="btndeleup" onclick="back2add()"/>
						</td>
					</tr>
				</div>
				<br>
				<div id="act_btn">
				<hr align="left" class="sep" size="1" width="90%">
				<input type="button" class="btnaddup" name="add" onClick="addClick()" value="添加">
				<input type="button" class="btnsaveup" name="modify" onClick="return modifyClick();" value="修改">
				<input type="button" class="btndeleup" name="remove" onClick="on_action('rm')" value="删除">
				</div>
