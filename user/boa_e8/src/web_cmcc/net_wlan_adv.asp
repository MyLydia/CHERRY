...
<table>
	<tr>
		<td width='180'><input class="btnsaveup" type='button' onClick='on_submit()' value='保存/应用'></td>
		<td><input class="btndeleup" name="button" type='button' onClick ='history.back()' value='后退'></td>
		<td>&nbsp;</td>
	</tr>
</table>
