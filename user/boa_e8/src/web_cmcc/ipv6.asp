		...
		<blockquote>
			<DIV align="left" style="padding-left:20px; padding-top:10px">
				<form action=/boaform/formlanipv6 method=POST name="lanipv6addrform">
					...
					<hr align="left" class="sep" size="1" width="90%">
					<br>
					<input type="button" class="btndeleup" onClick="on_lanipv6addrform_submit(0);" value="保存/应用">&nbsp; &nbsp; &nbsp; &nbsp;
			...
			<DIV align="left" style="padding-left:20px; padding-top:10px">
				<form action=/boaform/formlanipv6dns method=POST name="lanipv6dnsform">
					...
					<hr align="left" class="sep" size="1" width="90%">
					<br>
					<input type="button" class="btnaddup" onClick="on_lanipv6dnsform_submit(0);" value="保存/应用">&nbsp; &nbsp; &nbsp; &nbsp;
					<input type="hidden" value="/ipv6.asp" name="submit-url">
				</form>
			</div>
				...
				<form action=/boaform/formlanipv6prefix method=POST name="lanipv6prefixmodeform">
					...
					<hr align="left" class="sep" size="1" width="90%">
					<br>
					<input type="button" class="btnsaveup" onClick="on_lanipv6prefixmodeform_submit(0);" value="保存/应用">&nbsp; &nbsp; &nbsp; &nbsp;
					<input type="hidden" value="/ipv6.asp" name="submit-url">
				</form>
			</div>
		</blockquote>
