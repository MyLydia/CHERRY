...
#define 	CMD_MIB_CHAIN_BACKUP_GET 77
#ifdef CONFIG_USER_DBUS_CTC_IGD
#define 	CMD_MIB_BACKUP_CTC		78
#define 	CMD_MIB_RESTORE_CTC		79
#endif
#define		CMD_DBUS_REGISTER_PID	80
#if defined(CONFIG_IPV6) && defined(DUAL_STACK_LITE)
#define		CMD_DSLITE_AFTR_STATIC	81
#endif
#define 	CMD_MIB_BACKUP_HS 82
#define		CMD_END			83
...
extern int set_msgqueue_max_size(int qid, unsigned short msgmaxsize);
extern void send_message_nonblock(int qid, long type, long req, long tgid, MSG_T *msg);
#endif /* _h_MSGQ */
