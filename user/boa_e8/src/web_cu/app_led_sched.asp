		...
		<DIV align="left" style="padding-left:20px; padding-top:10px">
			<form id="ledchedule" action=/boaform/admin/formLedTimer method=POST name=ledschedule>
				...
				<tr>
					<td class="td1"></td>
					<td class="td2">
					<input name="Btn_Add"  class="btnaddup" type="button"  id="Btn_Add" value="添加" onclick="on_submit(0)"/>
					<input name="Btn_Edit"  class="btnsaveup" type="button"  id="Btn_Edit" value="修改" onclick="on_submit(1)" style="display:none" />
					<input name="Btn_Back" class="btndeleup" type="button"  id="Btn_Back" value="取消"  onclick="back4add()" style="display:none"/>
					</td>
				</tr>
				</table>
