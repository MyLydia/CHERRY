   ...
   <body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onLoad='on_init()'>
    ...
    本页用于配置无线虚拟SSID。点击"保存/应用"，无线虚拟SSID的配置生效。<br>
		...
		<table border="0" cellpadding="4" cellspacing="0">
            	<tr>
				<td bgColor="#aaddff" style="color:#000;">虚拟SSID0</td>
				<td bgColor="#aaddff" style="color:#000;" width='380'><input type='checkbox' name='vap0_enable' onClick='vap0_CbClick(this)' value="ON" >启用</td>         
			</tr>
		</table>
  		<div id='vap0_SecInfo'>
  		<br>
...
-->
		...
		<br><br>
 		...
 		<table border="0" cellpadding="4" cellspacing="0">
            	<tr>
				<td bgColor="#aaddff" style="color:#000;">虚拟SSID1</td>
				<td bgColor="#aaddff"  style="color:#000;" width='380'><input type='checkbox' name='vap1_enable' onClick='vap1_CbClick(this)' value="ON" >启用</td>         
			</tr>
		</table>
  		<div id='vap1_SecInfo'>
		<br>
...
-->
		...
		<br><br>
 		...
 		<table border="0" cellpadding="4" cellspacing="0">
            	<tr>
				<td bgColor="#aaddff" style="color:#000;">虚拟SSID2</td>
				<td bgColor="#aaddff" style="color:#000;" width='380'><input type='checkbox' name='vap2_enable' onClick='vap2_CbClick(this)' value="ON" >启用</td>         
			</tr>
		</table>
  		<div id='vap2_SecInfo'>
		<br>
...
-->
		...
		<br><br>
 		...
 		<table border="0" cellpadding="4" cellspacing="0">
            	<tr>
				<td bgColor="#aaddff" style="color:#000;">虚拟SSID3</td>
				<td bgColor="#aaddff" style="color:#000;" width='380'><input type='checkbox' name='vap3_enable' onClick='vap3_CbClick(this)' value="ON" >启用</td>         
			</tr>
		</table>
  		<div id='vap3_SecInfo'>
		<br>
