...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onLoad="on_init();">
	...
	<DIV align="left" style="padding-left:20px; padding-top:0px">
		<form id="form" action="/boaform/admin/formPortFilterBlack" method="post">
			<div align="left">
				<b>添加IP过滤器 -- 流出</b><br><br>
				您可以通过指定一个新的过滤器名和至少下列状态的一种来为识别流出的IP通信而创建一个过滤器规则。<br>
				在过滤器规则中所有指定的状态必须使规则有效。如果设置了源或目的IP地址范围，则无需设置相应的子网掩码。<br>
				点击"保存/应用"保存和激活过滤器。<br>
				<br>
			...
			<INPUT type="button" class="btnsaveup" value="保存/应用" onClick="on_submit();">
