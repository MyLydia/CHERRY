...
<table border=0 width="500" cellspacing=0 cellpadding=0>
      ...
      <td><input class="btnsaveup"  type="submit" value="保存/应用" name="addPPtP" onClick="return addPPtPItf()">&nbsp;&nbsp;</td>
  </tr>
</table>
<br><br>
...
<br>
<input class="btndeleup" type="submit" value="删除" name="delSel" onClick="return deleteClick()">&nbsp;&nbsp;
