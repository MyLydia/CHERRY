		...
		<DIV align="left" style="padding-left:20px; padding-top:10px">
			<form id="wlanschedule" action=/boaform/admin/formWifiTimer method=POST name=wlanschedule>
				...
				<tr>
					<td class="td1"></td>
					<td class="td2">
					<input class="btnsaveup" name="Btn_Add" type="button" id="Btn_Add" value="添加" onclick="on_submit(0)"/>
					<input class="btnaddup" name="Btn_Edit" type="button" id="Btn_Edit" value="修改" onclick="on_submit(1)" style="display:none" />
					<input class="btndeleup" name="back" type="button" id="back" value="取消"  onclick="back4add()" style="display:none"/>
					</td>
				</tr>
				</table>
