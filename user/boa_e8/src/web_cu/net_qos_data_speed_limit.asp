...
<!-------------------------------------------------------------------------------------->
				<table width="100%" style="padding-top:30px; display:inline-block;">
					<tr>
						<td>上行数据限速模式:</td>
						<td>
...
<!-------------------------------------------------------------------------------------->
				...
				<table width="750px">
					...
					<td colspan="2"><p align="center">
							<input id="btnOK" onclick="ModeSubmit();"  type="button" class="btnsaveup"  value="确定">&nbsp;&nbsp;
							<input id="btnCancel" onclick="clickPage('net_qos_data_speed_limit.asp')"  type="button" class="btnsaveup"  value="取消">
