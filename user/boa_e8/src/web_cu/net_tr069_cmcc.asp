     ...
     <div align="left" style="padding-left:20px; padding-top:10px">
         <form name="form_69config" action=/boaform/admin/formTR069Config method="post">
           <b>RMS服务器<br>
            ...
            <br>
           RMS服务器开关、RMS服务器地址、 RMS服务器用户名及密码、请求连接认证用户名密码、 通知周期等配置。
		   设置随机上报时，随机上报的时间间隔取值为30秒至周期通知时间间隔（大于30秒）之间的随机值。
           <br>
            <br>
          ...
          周期上报
				&nbsp;
                  <input name='inform' value='2' type='radio' onClick="intervalenable()" <% checkWrite("tr069-inform-2"); %> >
          随机上报</td>			  		  
               </tr>
			   <tr>
