           ...
           <table border="0" cellpadding="0" cellspacing="0">
 				<tr>
					<td>
		           		...
		           		<input class="btnsaveup" type="submit"  value="证书导入" >
					</td>
				</tr>
		   </table><br>
...
<center>
           <table border="0" cellpadding="0" cellspacing="0">
 				<tr>
					<td>
		           		<input class="btnaddup_l" type="submit"  value="删除已上传证书" name="delbutton" <% checkWrite("check-certca"); %>>
					</td>
				</tr>
		   </table><br>
</center>
