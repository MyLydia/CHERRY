        ...
        <DIV align="left" style="padding-left:20px; padding-top:10px">
         <form action=/boaform/formMacAddrBase method="post" name="form">
			...
			<table border="0" width="80%">
				<tr>
				<td align="left" width="30%"><input type="button" class="btnaddup" onClick="history.back();" value="返回"></td>
				<td align="left"><input type="button" class="btnsaveup" onClick="on_submit('sv');" value="确定"></td>
