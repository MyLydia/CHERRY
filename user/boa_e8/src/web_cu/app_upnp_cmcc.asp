  ...
  <blockquote>
	<DIV align="left" style="padding-left:20px; padding-top:5px">
		<form id="form" action=/boaform/admin/formUpnp method=POST name="upnp">
			...
			<br><br>
			<div align="center">
				<input id="btnOK" name="save" onclick="submit();"  type="button" class="btnsaveup"  value="确定">&nbsp;&nbsp;
				<input id="btnCancel" onclick="window.location.reload()" type="button" class="btnsaveup"  value="取消">
