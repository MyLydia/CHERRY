...
function on_submit() 
{
	...
	if(document.wlanSetup.disableWPS.checked == true){
...
//	var channelbound_str = document.wlanSetup.chanwid.options[channelbound_idx].value;
	...
	if(channelbound_idx > (idx-1))
		...
		document.wlanSetup.chanwid.selectedIndex = _chanwid[0];	
		
	if( document.wlanSetup.band.selectedIndex==1 && _chanwid[0]==1 )
	{
...
function BandSelected(index)
{
	...
	with (document.wlanSetup) {
		...
		wlBand.style.display = "";
		ShortGI.style.display = "";
...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onload="BandSelected(0)">
	...
	<table border="0" cellpadding="2" cellspacing="0"  width="420">
		<tr>
			...
			<td><input size="10" style="WIDTH: 180px" name='ssid' maxlength="32" value=""></td>
		</tr>
	</table>
	...
	<br><br>
			<input type="hidden" value="/net_wlan_basic_11n_24g_user_cmcc.asp" name="submit-url">
