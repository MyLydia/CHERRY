...
for(i=0; i < wlan_num; i++){
		...
		if(wlan_root_interface_up[i]){
			if(wlan_num==1){
				...
				document.write('<tr><td class="hdb">2.4GHz 信道</td><td class="hdt">'+wlDefChannel[i]+'</td></tr>');
				else
				document.write('<tr><td class="hdb">5GHz 信道</td><td class="hdt">'+wlDefChannel[i]+'</td></tr>');
			}
		}
