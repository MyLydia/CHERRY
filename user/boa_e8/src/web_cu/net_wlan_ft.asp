...
<table border=0 width="500" cellspacing=4 cellpadding=0>
	...
	<tr>
		<td width="100%" colspan="2" height="40">
			...
			<input class="btnsaveup" type="submit" name="ftSaveConfig" value="保存/应用" onclick="return check_80211r_setting()">
			<input class="btndeleup" name="button" type='button' onClick ='history.back()' value='后退'>
		</td>
	</tr>
</table>
</form>
...
<table border=0 width="90%" cellspacing=4 cellpadding=0>
	<tr><td><hr size=1 class="sep" noshade align=top></td></tr>
</table>
