	...
	<blockquote>
		<DIV align="left" style="padding-left:20px; padding-top:5px;">
			<form id="form" action="/boaform/admin/formQosRule" method="post">
				...
				<br>
				<input type="button" class="btnaddup" onClick="location.href='net_qos_cls_edit.asp';" value="添加">
				<input type="button" class="btnsaveup" onClick="on_submit();" value="保存/应用">
