			...
			<DIV align="left" style="padding-left:20px; padding-top:10px">
				<form action=/boaform/formIpRange method= "post">
					...
					<table class="flat" border="1" cellpadding="0" cellspacing="0">
						...
						<td><input type="text" name="pcRangeStart" value=<% getInfo("pcRangeStart"); %>></td>
						</tr>
						<tr>
						<td class="hd">PC终止地址:</td>
						<!--<td><input type="text" name="pcRangeEnd"></td>-->
						<td><input type="text" name="pcRangeEnd" value=<% getInfo("pcRangeEnd"); %>></td>
						</tr>
						<tr>
						<td colspan="2">&nbsp;</td>
						</tr>
						...
						<td><input type="text" name="cmrRangeStart" value=<% getInfo("cmrRangeStart"); %>></td>
						</tr>
						<tr>
						<td class="hd">摄像头终止地址:</td>
						<!--<td><input type="text" name="cmrRangeEnd"></td>-->
						<td><input type="text" name="cmrRangeEnd" value=<% getInfo("cmrRangeEnd"); %>></td>
						</tr>
						<tr>
						<td colspan="2">&nbsp;</td>
						</tr>
						...
						<td><input type="text" name="stbRangeStart" value=<% getInfo("stbRangeStart"); %>></td>
						</tr>
						<tr>
						<td class="hd">机顶盒终止地址:</td>
						<!--<td><input type="text" name="stbRangeEnd"></td>-->
						<td><input type="text" name="stbRangeEnd" value=<% getInfo("stbRangeEnd"); %>></td>
						</tr>
						<tr>
						<td colspan="2">&nbsp;</td>
						</tr>
						...
						<td><input type="text" name="phoneRangeStart" value=<% getInfo("phoneRangeStart"); %>></td>
						</tr>
						<tr>
						<td class="hd">Phone终止地址:</td>
						<!--<td><input type="text" name="phoneRangeEnd"></td>-->
						<td><input type="text" name="phoneRangeEnd" value=<% getInfo("phoneRangeEnd"); %>></td>
						</tr>
					</table>
					<br>
					&nbsp;
					<!--<input type="button" class="btndeleup" onClick="on_back()" value="后退">-->
					<input type="button" class="button" onClick="on_back()" value="后退">
					&nbsp; &nbsp; &nbsp;
					<!--<input type="button" class="btnsaveup" onClick="on_submit()" value="应用">-->
