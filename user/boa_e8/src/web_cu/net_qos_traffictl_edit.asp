	...
	<DIV align="left" style="padding-left:20px; padding-top:5px;">
		<form id="form" action="/boaform/admin/formQosTraffictlEdit" method="post">
			...
			<table cellSpacing="1" cellPadding="0" border="0">
   			...
   			<input type="button" class="btndeleup" name="return" value="返回" onClick="location.href='/net_qos_traffictl.asp';" style="width:80px">
         	<input type="button" class="btnsaveup" name="apply" value="保存" onClick="on_apply();" style="width:80px">
