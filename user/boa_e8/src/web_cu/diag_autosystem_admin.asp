...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000">
	<form id="form" action=/boaform/admin/formAutoDiag method=POST>
		<div align="left" style="padding-left:20px;"><br>
			...
			<tr><td><br><input type="submit" class="btnsaveup" name="autoDiagDisable" value="停止智能诊断" width="100px" /></td></tr>
			</table>
		</div>
	</form>
	<br><br><br><br><br><br>
	<form id="form" action=/boaform/admin/formQOE method=POST>
		<div align="left" style="padding-left:20px;"><br>
			...
			<tr><td><br><input class="btndeleup" type="submit" name="autoDiagDisable" value="关闭QOE" width="100px" /></td></tr>
			</table>
		</div>
	</form>
</body>
