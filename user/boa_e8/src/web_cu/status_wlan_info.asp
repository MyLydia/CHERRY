		...
		<div align="left" style="padding-left:20px;"><br>
			...
			<table class="flat" border="1" cellpadding="0" cellspacing="1">
				<tr>
					...
					<td width="360" class="hdt"><% getInfo("wlanState"); %></td>
				</tr>
				<tr>
					<td class="hdb">信道:</td>
					<td class="hdt"><% getInfo("wlDefChannel"); %></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="hdt"><% getInfo("wlanMode"); %></td>
				</tr>
				<tr>
					<td class="hdb">发送功率:</td>
					<td class="hdt"><% getInfo("wlTxPower"); %></td>
				</tr>
				<tr>
					<td class="hdb">BSSID:</td>
					<td class="hdt"><% getInfo("wlanBssid"); %></td>
				</tr>
				<tr>
					<td class="hdb">SSID隐藏属性:</td>
					<td class="hdt"><% getInfo("wlanSsidAttr"); %></td>
				</tr>
				<tr>
					<td class="hdb">SSID-1名称:</td>
					<td class="hdt"><% getInfo("ssidName"); %></td>
				</tr>
				<tr>
					<td class="hdb">SSID-1加密状态:</td>
					<td class="hdt"><% getInfo("encryptState"); %></td>
				</tr>
			</table>
			</div>
		</div>
