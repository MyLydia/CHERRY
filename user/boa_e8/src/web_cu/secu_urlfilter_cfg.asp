	...
	<blockquote>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tbody>
							  ...
							  <table border="0" cellpadding="0" cellspacing="0">
		                       ...
		                       <table border="0" cellpadding="0" cellspacing="0">
		                       	<tbody>
		                       		<tr>
		                              <td>
		                        		设置URL过滤模式以及过滤名单。（可设置100条）<br><br>
		                          		单击“更改模式”按钮改变URL过滤模式；<br><br>
		                          		单击“添加”按钮增加一条URL到对应的URL列表；单击“删除”按钮删除一条URL，<br><br>
		                         		URL不要带http://，URL长度不能超过31个字符。 <br><br>
		                          		<script language="JavaScript" type="text/javascript">
		                          ...
		                          <div id="dnsdomain">
		                            <table cellspacing="0" cellpadding="0" border="0">
		                              <tbody>
		                                <tr>
		                                  <td width="120">URL:</td>
		                                  <td width="170"><input type="text" onkeydown="if(event.keyCode==13)return false" maxlength="31" size="30" name="url"></td>
		                                  <td width="5"></td>
								  ...
								  <table class="tblList" id="rulelst" border="1">
									<tbody>
										<tr>
											...
											<td width="180" align="center" class="table_title"><strong><font>URL</font></strong></td>
											<td class="table_title" align="middle" width="60"><strong><font >删 除</font></strong></td>
										</tr>
									</tbody>
								  </table>
          	...
          	<div>
    		<p align="center">
				<input type="button" id="btnOK" class="btnsaveup" onclick="on_action('sw')" value="提交">					
				<input type="button" id="btnCancel" class="btnsaveup"  value="取消" ononclick="RefreshPage()">
			</p>
         	</div>
		</form>
	</blockquote>
