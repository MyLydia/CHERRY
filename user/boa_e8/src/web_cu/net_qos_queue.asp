...
<blockquote>
	<DIV align="left" style="padding-left:20px; padding-top:5px;">
		<form id="queueform" action="/boaform/admin/formQosQueue" method="post">
		  ...
		  <input type="button" class="btnaddup" value="添加" onClick="location.href='net_qos_queue_edit.asp'">
		  <input type="button" class="btndeleup" value="删除" onClick="on_delete_queue();">
		  <input type="button" class="btnsaveup" value="保存/应用" onClick="on_save_reboot();">
