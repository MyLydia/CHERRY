...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onLoad="on_init();">
	...
	<DIV align="left" style="padding-left:20px; padding-top:0px">
		<form id="form" action="/boaform/admin/formPortFilterWhite" method="post">
			...
			<br>
			<input type="button" class="btnaddup" onClick="location.href='secu_portfilter_whtadd.asp';" value="添加">
			<input type="button" class="btndeleup" onClick="on_submit();" value="删除">
