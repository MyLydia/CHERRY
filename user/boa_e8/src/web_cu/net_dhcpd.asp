		...
		<blockquote>
			<DIV align="left" style="padding-left:20px; padding-top:10px">
				<form action=/boaform/formDhcpServer method=POST name="dhcpd">
					...
					<div id="rstip"><font color="red">提示：如果修改初始或终止IP地址，请确保地址范围包含各种设备的地址区间，否则可能会无法取得IP！</font><br></div>
...
-->
					<table border="0" width="520">
						<tr>
						<td>
						<INPUT type="button" class="btnaddup_l" onClick="popUpWindow('net_mopreipaddr.asp',350,350,500,300);" value="编辑预留IP地址列表">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<hr align="left" class="sep" size="1" width="90%">
					<br>
					<input type="button" class="btnsaveup" onClick="on_submit(0);" value="应用">&nbsp; &nbsp; &nbsp; &nbsp;
