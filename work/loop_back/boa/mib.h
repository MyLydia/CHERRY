...
#define MIB_DSL_G_VECTOR						CS_ENTRY_ID + 96
...
#define MIB_SAMBA_SECURITY_ENABLE				CS_ENTRY_ID + 142
#endif
#endif
...
#define MIB_SNMPV3_RO_NAME						CS_ENTRY_ID + 212
#define MIB_SNMPV3_RO_PASSWORD					CS_ENTRY_ID + 213
#define MIB_SNMPV3_RO_AUTH						CS_ENTRY_ID + 214
#define MIB_SNMPV3_RW_NAME						CS_ENTRY_ID + 215
#define MIB_SNMPV3_RW_PASSWORD					CS_ENTRY_ID + 216
#define MIB_SNMPV3_RW_AUTH						CS_ENTRY_ID + 217
#define MIB_SNMPV3_RW_PRIVACY					CS_ENTRY_ID + 218
#define MIB_SNMP_VERSION						CS_ENTRY_ID + 219
#endif
...
#define MIB_OMCI_LOGFILE_MASK					CS_ENTRY_ID + 291
#endif
#define MIB_TFTP_SERVER_ADDR					CS_ENTRY_ID + 292
#define MIB_POSIX_TZ_STRING						CS_ENTRY_ID + 293
#define MIB_BOOT_FILENAME						CS_ENTRY_ID + 294

#ifdef CONFIG_GPON_FEATURE
//#define MIB_OMCI_VENDOR_ID						CS_ENTRY_ID + 295
#define MIB_PON_CUSTOM_SDK						CS_ENTRY_ID + 296
#endif

#ifdef USER_WEB_WIZARD
#ifdef CONFIG_00R0
#define MIB_USER_TROUBLE_WIZARD_INTERNET_STATUS	CS_ENTRY_ID + 297
#endif
#define MIB_USER_WEB_WIZARD_FLAG				CS_ENTRY_ID + 298
#endif

#ifdef CONFIG_RTK_OMCI_V1
#define MIB_OMCI_VENDOR_PRODUCT_CODE			CS_ENTRY_ID + 299
#define MIB_OMCI_FAKE_OK						CS_ENTRY_ID + 300
#define MIB_OMCI_VEIP_SLOTID						CS_ENTRY_ID + 301
#endif


#ifdef CONFIG_RTK_L34_ENABLE
/*To handle internal reserved vlan, sync with rtk_rg_define.h*/
#define MIB_UNTAG_WAN_VLAN_ID					CS_ENTRY_ID + 303
#define MIB_FWD_CPU_VLAN_ID						CS_ENTRY_ID + 304
#define MIB_FWD_PROTO_BLOCK_VLAN_ID				CS_ENTRY_ID + 305
#define MIB_FWD_BIND_INTERNET_VLAN_ID			CS_ENTRY_ID + 306
#define MIB_FWD_BIND_OTHER_VLAN_ID				CS_ENTRY_ID + 307
...
#define MIB_ONUCOMM_FW_STATUS					CS_ENTRY_ID + 308
#endif

#ifdef CONFIG_00R0
#ifdef CONFIG_USER_RTK_SYSLOG_REMOTE
#define MIB_SYSLOG_REMOTE_LEVEL				CS_ENTRY_ID + 309
#endif

#ifdef CONFIG_TR142_MODULE
#define MIB_GPON_OMCI_PORTMASK					CS_ENTRY_ID + 310
#endif
#if defined(CONFIG_GPON_FEATURE)
#define MIB_GPON_PLOAM_PASSWD_BACKUP			CS_ENTRY_ID + 311
#endif
#define MIB_ROSTELECOM_PROVINCES				CS_ENTRY_ID + 312
#endif //CONFIG_00R0
#define MIB_LOID_OLD							CS_ENTRY_ID + 313
#define MIB_LOID_PASSWD_OLD						CS_ENTRY_ID + 314
#ifdef CONFIG_NET_IPGRE
#define MIB_GRE_ENABLE							CS_ENTRY_ID + 315
#endif
#if defined(CONFIG_GPON_FEATURE)
#define MIB_NGPON_PLOAM_PASSWD						CS_ENTRY_ID + 316
#ifdef CONFIG_00R0
#define MIB_NGPON_PLOAM_PASSWD_BACKUP					CS_ENTRY_ID + 317
#endif
#endif
#ifdef CONFIG_TR142_MODULE
#define MIB_DOT1P_VALUE_BYCF					CS_ENTRY_ID + 320
#endif
#if defined(CONFIG_IPV6) && defined(IP_ACL)
#define MIB_V6_ACL_CAPABILITY					CS_ENTRY_ID + 321
#endif

#ifdef CONFIG_NF_CONNTRACK_TFTP
#define MIB_IP_ALG_TFTP							CS_ENTRY_ID + 322
#endif

#ifdef CONFIG_USER_CMD_SUPPORT_GFAST
#define MIB_GFAST_PROFILE					CS_ENTRY_ID + 323
#endif

#ifdef SUPPORT_FON_GRE
#define MIB_FON_GRE_ENABLE						CS_ENTRY_ID + 324
#endif
#ifdef CONFIG_USER_IGMPPROXY
#define MIB_IGMP_ROBUST_COUNT					CS_ENTRY_ID + 325
#define MIB_IGMP_LAST_MEMBER_QUERY_COUNT		CS_ENTRY_ID + 326
#define MIB_IGMP_QUERY_INTERVAL					CS_ENTRY_ID + 327
#define MIB_IGMP_QUERY_RESPONSE_INTERVAL		CS_ENTRY_ID + 328
#define MIB_IGMP_GROUTP_LEAVE_DELAY				CS_ENTRY_ID + 329
#define MIB_IGMP_MULTICAST_ALLOW				CS_ENTRY_ID + 330
#endif
#ifdef CONFIG_USER_ECMH
#define MIB_MLD_ROBUST_COUNT					CS_ENTRY_ID + 331
#define MIB_MLD_QUERY_INTERVAL					CS_ENTRY_ID + 332
#define MIB_MLD_QUERY_RESPONSE_INTERVAL			CS_ENTRY_ID + 333
#define MIB_MLD_LAST_MEMBER_QUERY_RESPONSE_INTERVAL			CS_ENTRY_ID + 334
#endif

#ifdef CONFIG_USER_LAN_PORT_AS_ETH_WAN
#define MIB_ETH_WAN_PORT_PHY_INDEX 				CS_ENTRY_ID + 335
#endif
#ifdef CONFIG_RTK_L34_ENABLE
#define MIB_FWD_CPU_SVLAN_ID					CS_ENTRY_ID + 336
#endif
...
#define  MIB_CATV_RX_POWER   CS_ENTRY_ID + 338
#define  MIB_CATV_TX_POWER    CS_ENTRY_ID + 339
#define  MIB_CATV_DC_VCC    CS_ENTRY_ID + 340
#define  MIB_CATV_TEMPERATURE    CS_ENTRY_ID + 341

#define  MIB_CATV_GAIN_CONTROL    CS_ENTRY_ID + 342
#define  MIB_CATV_RF_ONOFF    CS_ENTRY_ID + 343
#define  MIB_CATV_STATE    CS_ENTRY_ID + 344

#define  MIB_CATV_HARDWAREVERSION    CS_ENTRY_ID + 345
#define  MIB_CATV_SOFTWAREVERSION    CS_ENTRY_ID + 346
#endif 

#define  MIB_CONFIG_MODE    CS_ENTRY_ID + 347

#ifdef CONFIG_USER_RTK_LBD
#define MIB_LBD_ENABLE							CS_ENTRY_ID + 348
#define MIB_LBD_EXIST_PERIOD					CS_ENTRY_ID + 349
#define MIB_LBD_CANCEL_PERIOD					CS_ENTRY_ID + 350
#define MIB_LBD_ETHER_TYPE						CS_ENTRY_ID + 351
#endif
...
#ifdef WLAN_MBSSID
    MIB_MAPPING(BLOCK_MBSSID),
#endif
    
    MIB_MAPPING(MAC_CTRL),
    
#ifdef WLAN_MBSSID
    MIB_MAPPING(VAP0_ITF_GROUP),
    MIB_MAPPING(VAP1_ITF_GROUP),
    MIB_MAPPING(VAP2_ITF_GROUP),
    MIB_MAPPING(VAP3_ITF_GROUP),
#endif
    
#ifdef WLAN_QoS //Added for WMM support
    MIB_MAPPING(APSD_ENABLE),
#endif
...
#ifdef CONFIG_00R0
    MIB_MAPPING(AUTO_CHAN_REFRESH_PERIOD),
#endif

    MIB_MAPPING(TX_RESTRICT),
    MIB_MAPPING(RX_RESTRICT),
...
#define MIB_WLAN_WPA2_CIPHER_SUITE				DUAL_WLAN_START_ID + 73
#define MIB_WLAN1_WPA2_CIPHER_SUITE				DUAL_WLAN_START_ID + 74
#endif

#define MIB_WLAN_INACTIVITY_TIME				DUAL_WLAN_START_ID + 75
#define MIB_WLAN1_INACTIVITY_TIME				DUAL_WLAN_START_ID + 76

#define MIB_WLAN_RATE_ADAPTIVE_ENABLED			DUAL_WLAN_START_ID + 77
#define MIB_WLAN1_RATE_ADAPTIVE_ENABLED			DUAL_WLAN_START_ID + 78

#ifdef WLAN_ACL
// access control MIB id
#define MIB_WLAN_AC_ENABLED						DUAL_WLAN_START_ID + 79
#define MIB_WLAN1_AC_ENABLED					DUAL_WLAN_START_ID + 80
#endif

#define MIB_WLAN_DTIM_PERIOD					DUAL_WLAN_START_ID + 81
#define MIB_WLAN1_DTIM_PERIOD					DUAL_WLAN_START_ID + 82

#define MIB_WLAN_MODE							DUAL_WLAN_START_ID + 83
#define MIB_WLAN1_MODE							DUAL_WLAN_START_ID + 84

#define MIB_WLAN_NETWORK_TYPE					DUAL_WLAN_START_ID + 85
#define MIB_WLAN1_NETWORK_TYPE					DUAL_WLAN_START_ID + 86

#ifdef WLAN_WPA
#define MIB_WLAN_ACCOUNT_RS_ENABLED				DUAL_WLAN_START_ID + 87
#define MIB_WLAN1_ACCOUNT_RS_ENABLED			DUAL_WLAN_START_ID + 88

#define MIB_WLAN_ACCOUNT_RS_IP					DUAL_WLAN_START_ID + 89
#define MIB_WLAN1_ACCOUNT_RS_IP					DUAL_WLAN_START_ID + 90

#define MIB_WLAN_ACCOUNT_RS_PORT				DUAL_WLAN_START_ID + 91
#define MIB_WLAN1_ACCOUNT_RS_PORT				DUAL_WLAN_START_ID + 92

#define MIB_WLAN_ACCOUNT_RS_PASSWORD			DUAL_WLAN_START_ID + 93
#define MIB_WLAN1_ACCOUNT_RS_PASSWORD			DUAL_WLAN_START_ID + 94

#define MIB_WLAN_ACCOUNT_UPDATE_ENABLED			DUAL_WLAN_START_ID + 95
#define MIB_WLAN1_ACCOUNT_UPDATE_ENABLED		DUAL_WLAN_START_ID + 96

#define MIB_WLAN_ACCOUNT_UPDATE_DELAY			DUAL_WLAN_START_ID + 97
#define MIB_WLAN1_ACCOUNT_UPDATE_DELAY			DUAL_WLAN_START_ID + 98

#define MIB_WLAN_ENABLE_MAC_AUTH				DUAL_WLAN_START_ID + 99
#define MIB_WLAN1_ENABLE_MAC_AUTH				DUAL_WLAN_START_ID + 100

#define MIB_WLAN_RS_RETRY						DUAL_WLAN_START_ID + 101
#define MIB_WLAN1_RS_RETRY						DUAL_WLAN_START_ID + 102

#define MIB_WLAN_RS_INTERVAL_TIME				DUAL_WLAN_START_ID + 103
#define MIB_WLAN1_RS_INTERVAL_TIME				DUAL_WLAN_START_ID + 104

#define MIB_WLAN_ACCOUNT_RS_RETRY				DUAL_WLAN_START_ID + 105
#define MIB_WLAN1_ACCOUNT_RS_RETRY				DUAL_WLAN_START_ID + 106

#define MIB_WLAN_ACCOUNT_RS_INTERVAL_TIME		DUAL_WLAN_START_ID + 107
#define MIB_WLAN1_ACCOUNT_RS_INTERVAL_TIME		DUAL_WLAN_START_ID + 108
#endif

//#ifdef WLAN_WDS
#define MIB_WLAN_WDS_ENABLED					DUAL_WLAN_START_ID + 109
#define MIB_WLAN1_WDS_ENABLED					DUAL_WLAN_START_ID + 110

#define MIB_WLAN_WDS_NUM						DUAL_WLAN_START_ID + 111
#define MIB_WLAN1_WDS_NUM						DUAL_WLAN_START_ID + 112

#define MIB_WLAN_WDS_ENCRYPT					DUAL_WLAN_START_ID + 113
#define MIB_WLAN1_WDS_ENCRYPT					DUAL_WLAN_START_ID + 114
#define MIB_WLAN_WDS_WEP_FORMAT					DUAL_WLAN_START_ID + 115
#define MIB_WLAN1_WDS_WEP_FORMAT				DUAL_WLAN_START_ID + 116
#define MIB_WLAN_WDS_WEP_KEY					DUAL_WLAN_START_ID + 117
#define MIB_WLAN1_WDS_WEP_KEY					DUAL_WLAN_START_ID + 118
#define MIB_WLAN_WDS_PSK_FORMAT					DUAL_WLAN_START_ID + 119
#define MIB_WLAN1_WDS_PSK_FORMAT				DUAL_WLAN_START_ID + 120
#define MIB_WLAN_WDS_PSK						DUAL_WLAN_START_ID + 121
#define MIB_WLAN1_WDS_PSK						DUAL_WLAN_START_ID + 122

#define MIB_WLAN_BAND							DUAL_WLAN_START_ID + 123
#define MIB_WLAN1_BAND							DUAL_WLAN_START_ID + 124

#define MIB_WLAN_FIX_RATE						DUAL_WLAN_START_ID + 125
#define MIB_WLAN1_FIX_RATE						DUAL_WLAN_START_ID + 126

#define MIB_WLAN_BLOCK_RELAY					DUAL_WLAN_START_ID + 127
#define MIB_WLAN1_BLOCK_RELAY					DUAL_WLAN_START_ID + 128

// Added by jiunming for setting an option "ethernet to wireless blocking" in page wladvanced.asp
#define MIB_WLAN_BLOCK_ETH2WIR					DUAL_WLAN_START_ID + 129
#define MIB_WLAN1_BLOCK_ETH2WIR					DUAL_WLAN_START_ID + 130

#define MIB_WLAN_ITF_GROUP						DUAL_WLAN_START_ID + 131
#define MIB_WLAN1_ITF_GROUP						DUAL_WLAN_START_ID + 132

#ifdef WLAN_WEB_REDIRECT  //jiunming,web_redirect
#define MIB_WLAN_WEB_REDIR_URL					DUAL_WLAN_START_ID + 133
#define MIB_WLAN1_WEB_REDIR_URL					DUAL_WLAN_START_ID + 134
#endif

#ifdef WLAN_QoS	//Added for WMM support
#define MIB_WLAN_QoS							DUAL_WLAN_START_ID + 135
#define MIB_WLAN1_QoS							DUAL_WLAN_START_ID + 136
#endif

#define MIB_WLAN_DIG							DUAL_WLAN_START_ID + 137
#define MIB_WLAN1_DIG							DUAL_WLAN_START_ID + 138

#define MIB_WLAN_BEACON_ADVERTISEMENT			DUAL_WLAN_START_ID + 139
#define MIB_WLAN1_BEACON_ADVERTISEMENT			DUAL_WLAN_START_ID + 140

#ifdef WLAN_MBSSID
#define MIB_WLAN_BLOCK_MBSSID					DUAL_WLAN_START_ID + 141
#define MIB_WLAN1_BLOCK_MBSSID					DUAL_WLAN_START_ID + 142
#endif

#define MIB_WLAN_MAC_CTRL						DUAL_WLAN_START_ID + 143
#define MIB_WLAN1_MAC_CTRL						DUAL_WLAN_START_ID + 144

#ifdef WLAN_MBSSID
#define MIB_WLAN_VAP0_ITF_GROUP					DUAL_WLAN_START_ID + 145
#define MIB_WLAN1_VAP0_ITF_GROUP				DUAL_WLAN_START_ID + 146

#define MIB_WLAN_VAP1_ITF_GROUP					DUAL_WLAN_START_ID + 147
#define MIB_WLAN1_VAP1_ITF_GROUP				DUAL_WLAN_START_ID + 148


#define MIB_WLAN_VAP2_ITF_GROUP					DUAL_WLAN_START_ID + 149
#define MIB_WLAN1_VAP2_ITF_GROUP				DUAL_WLAN_START_ID + 150

#define MIB_WLAN_VAP3_ITF_GROUP					DUAL_WLAN_START_ID + 151
#define MIB_WLAN1_VAP3_ITF_GROUP				DUAL_WLAN_START_ID + 152
#endif

#ifdef WLAN_QoS	//Added for WMM support
#define MIB_WLAN_APSD_ENABLE					DUAL_WLAN_START_ID + 153
#define MIB_WLAN1_APSD_ENABLE					DUAL_WLAN_START_ID + 154
#endif

#define MIB_WLAN_PROTECTION_DISABLED			DUAL_WLAN_START_ID + 155
#define MIB_WLAN1_PROTECTION_DISABLED			DUAL_WLAN_START_ID + 156

#define MIB_WLAN_AGGREGATION 					DUAL_WLAN_START_ID + 157
#define MIB_WLAN1_AGGREGATION					DUAL_WLAN_START_ID + 158

#define MIB_WLAN_SHORTGI_ENABLED				DUAL_WLAN_START_ID + 159
#define MIB_WLAN1_SHORTGI_ENABLED				DUAL_WLAN_START_ID + 160

#define MIB_WLAN_CHANNEL_WIDTH  				DUAL_WLAN_START_ID + 161
#define MIB_WLAN1_CHANNEL_WIDTH					DUAL_WLAN_START_ID + 162

#define MIB_WLAN_CONTROL_BAND					DUAL_WLAN_START_ID + 163
#define MIB_WLAN1_CONTROL_BAND					DUAL_WLAN_START_ID + 164

#define MIB_WLAN_WAPI_PSK						DUAL_WLAN_START_ID + 165
#define MIB_WLAN1_WAPI_PSK						DUAL_WLAN_START_ID + 166

#define MIB_WLAN_WAPI_PSKLEN					DUAL_WLAN_START_ID + 167
#define MIB_WLAN1_WAPI_PSKLEN					DUAL_WLAN_START_ID + 168

#define MIB_WLAN_WAPI_PSK_FORMAT				DUAL_WLAN_START_ID + 169
#define MIB_WLAN1_WAPI_PSK_FORMAT				DUAL_WLAN_START_ID + 170

#define MIB_WLAN_WAPI_AUTH						DUAL_WLAN_START_ID + 171
#define MIB_WLAN1_WAPI_AUTH						DUAL_WLAN_START_ID + 172

#define MIB_WLAN_WAPI_ASIPADDR    				DUAL_WLAN_START_ID + 173
#define MIB_WLAN1_WAPI_ASIPADDR					DUAL_WLAN_START_ID + 174

#define MIB_WLAN_WAPI_SEARCH_CERTINFO   		DUAL_WLAN_START_ID + 175
#define MIB_WLAN1_WAPI_SEARCH_CERTINFO			DUAL_WLAN_START_ID + 176

#define MIB_WLAN_WAPI_SEARCH_CERTINDEX  		DUAL_WLAN_START_ID + 177
#define MIB_WLAN1_WAPI_SEARCH_CERTINDEX			DUAL_WLAN_START_ID + 178

#define MIB_WLAN_WAPI_MCAST_REKEYTYPE   		DUAL_WLAN_START_ID + 179
#define MIB_WLAN1_WAPI_MCAST_REKEYTYPE			DUAL_WLAN_START_ID + 180

#define MIB_WLAN_WAPI_MCAST_TIME				DUAL_WLAN_START_ID + 181
#define MIB_WLAN1_WAPI_MCAST_TIME				DUAL_WLAN_START_ID + 182

#define MIB_WLAN_WAPI_MCAST_PACKETS      		DUAL_WLAN_START_ID + 183
#define MIB_WLAN1_WAPI_MCAST_PACKETS			DUAL_WLAN_START_ID + 184

#define MIB_WLAN_WAPI_UCAST_REKETTYPE    		DUAL_WLAN_START_ID + 185
#define MIB_WLAN1_WAPI_UCAST_REKETTYPE			DUAL_WLAN_START_ID + 186

#define MIB_WLAN_WAPI_UCAST_TIME    	 		DUAL_WLAN_START_ID + 187
#define MIB_WLAN1_WAPI_UCAST_TIME				DUAL_WLAN_START_ID + 188

#define MIB_WLAN_WAPI_UCAST_PACKETS    	 		DUAL_WLAN_START_ID + 189
#define MIB_WLAN1_WAPI_UCAST_PACKETS			DUAL_WLAN_START_ID + 190

#define MIB_WLAN_WAPI_CA_INIT            		DUAL_WLAN_START_ID + 191
#define MIB_WLAN1_WAPI_CA_INIT					DUAL_WLAN_START_ID + 192

#define MIB_WLAN_PHY_BAND_SELECT				DUAL_WLAN_START_ID + 193
#define MIB_WLAN1_PHY_BAND_SELECT				DUAL_WLAN_START_ID + 194

#define MIB_WLAN_MAC_PHY_MODE					DUAL_WLAN_START_ID + 195
#define MIB_WLAN1_MAC_PHY_MODE					DUAL_WLAN_START_ID + 196

// WPS
//#ifdef WIFI_SIMPLE_CONFIG
#define MIB_WSC_DISABLE 						DUAL_WLAN_START_ID + 197
#define MIB_WLAN1_WSC_DISABLE					DUAL_WLAN_START_ID + 198

#define MIB_WSC_METHOD							DUAL_WLAN_START_ID + 199
#define MIB_WLAN1_WSC_METHOD					DUAL_WLAN_START_ID + 200

#define MIB_WSC_AUTH							DUAL_WLAN_START_ID + 201
#define MIB_WLAN1_WSC_AUTH						DUAL_WLAN_START_ID + 202

#define MIB_WSC_ENC								DUAL_WLAN_START_ID + 203
#define MIB_WLAN1_WSC_ENC						DUAL_WLAN_START_ID + 204

#define MIB_WSC_MANUAL_ENABLED 					DUAL_WLAN_START_ID + 205
#define MIB_WLAN1_WSC_MANUAL_ENABLED			DUAL_WLAN_START_ID + 206

#define MIB_WSC_PSK								DUAL_WLAN_START_ID + 207
#define MIB_WLAN1_WSC_PSK						DUAL_WLAN_START_ID + 208

#define MIB_WSC_SSID							DUAL_WLAN_START_ID + 209
#define MIB_WLAN1_WSC_SSID						DUAL_WLAN_START_ID + 210

#define MIB_WSC_UPNP_ENABLED					DUAL_WLAN_START_ID + 211
#define MIB_WLAN1_WSC_UPNP_ENABLED				DUAL_WLAN_START_ID + 212

#define MIB_WSC_REGISTRAR_ENABLED 				DUAL_WLAN_START_ID + 213
#define MIB_WLAN1_WSC_REGISTRAR_ENABLED			DUAL_WLAN_START_ID + 214

#define MIB_WSC_CONFIG_BY_EXT_REG 				DUAL_WLAN_START_ID + 215
#define MIB_WLAN1_WSC_CONFIG_BY_EXT_REG			DUAL_WLAN_START_ID + 216

#define MIB_WLAN_11N_COEXIST  					DUAL_WLAN_START_ID + 217
#define MIB_WLAN1_11N_COEXIST					DUAL_WLAN_START_ID + 218
//#endif

#ifdef WLAN_UNIVERSAL_REPEATER
#define MIB_REPEATER_ENABLED1					DUAL_WLAN_START_ID + 219
#define MIB_REPEATER_ENABLED2					DUAL_WLAN_START_ID + 220
#define MIB_REPEATER_SSID1						DUAL_WLAN_START_ID + 221
#define MIB_REPEATER_SSID2						DUAL_WLAN_START_ID + 222
#endif
#define MIB_WLAN_AUTO_CHAN_ENABLED              DUAL_WLAN_START_ID + 223
#define MIB_WLAN1_AUTO_CHAN_ENABLED             DUAL_WLAN_START_ID + 224

#ifdef WLAN_WPA
#ifdef WLAN_11W
#define MIB_WLAN_DOTIEEE80211W					DUAL_WLAN_START_ID + 225
#define MIB_WLAN1_DOTIEEE80211W					DUAL_WLAN_START_ID + 226

#define MIB_WLAN_SHA256							DUAL_WLAN_START_ID + 227
#define MIB_WLAN1_SHA256						DUAL_WLAN_START_ID + 228
#endif
#endif

#define MIB_WLAN_MESH_ENABLE    				DUAL_WLAN_START_ID + 229
#define MIB_WLAN1_MESH_ENABLE    				DUAL_WLAN_START_ID + 230

#define MIB_WLAN_MESH_ROOT_ENABLE				DUAL_WLAN_START_ID + 231
#define MIB_WLAN1_MESH_ROOT_ENABLE				DUAL_WLAN_START_ID + 232

#define MIB_WLAN_MESH_ID						DUAL_WLAN_START_ID + 233
#define MIB_WLAN1_MESH_ID						DUAL_WLAN_START_ID + 234

#define MIB_WLAN_MESH_MAX_NEIGHTBOR				DUAL_WLAN_START_ID + 235
#define MIB_WLAN1_MESH_MAX_NEIGHTBOR			DUAL_WLAN_START_ID + 236

#define MIB_WLAN_MESH_ENCRYPT					DUAL_WLAN_START_ID + 237
#define MIB_WLAN1_MESH_ENCRYPT					DUAL_WLAN_START_ID + 238

#define MIB_WLAN_MESH_PSK_FORMAT				DUAL_WLAN_START_ID + 239
#define MIB_WLAN1_MESH_PSK_FORMAT				DUAL_WLAN_START_ID + 240

#define MIB_WLAN_MESH_WPA_PSK					DUAL_WLAN_START_ID + 241
#define MIB_WLAN1_MESH_WPA_PSK					DUAL_WLAN_START_ID + 242

#define MIB_WLAN_MESH_WPA_AUTH					DUAL_WLAN_START_ID + 243
#define MIB_WLAN1_MESH_WPA_AUTH					DUAL_WLAN_START_ID + 244

#define MIB_WLAN_MESH_WPA2_CIPHER_SUITE			DUAL_WLAN_START_ID + 245
#define MIB_WLAN1_MESH_WPA2_CIPHER_SUITE		DUAL_WLAN_START_ID + 246

#define MIB_WLAN_MESH_CROSSBAND_ENABLED			DUAL_WLAN_START_ID + 247
#define MIB_WLAN1_MESH_CROSSBAND_ENABLED		DUAL_WLAN_START_ID + 248

#define MIB_WLAN_MESH_ACL_ENABLED				DUAL_WLAN_START_ID + 249
#define MIB_WLAN1_MESH_ACL_ENABLED				DUAL_WLAN_START_ID + 250

#ifdef CONFIG_00R0
#define MIB_WLAN_AUTO_CHAN_REFRESH_PERIOD       DUAL_WLAN_START_ID + 251
#define MIB_WLAN1_AUTO_CHAN_REFRESH_PERIOD      DUAL_WLAN_START_ID + 252
#endif
#define MIB_WLAN_TX_RESTRICT                    DUAL_WLAN_START_ID + 253
#define MIB_WLAN1_TX_RESTRICT                   DUAL_WLAN_START_ID + 254
#define MIB_WLAN_RX_RESTRICT                    DUAL_WLAN_START_ID + 255
#define MIB_WLAN1_RX_RESTRICT                   DUAL_WLAN_START_ID + 256
#define MIB_WLAN_IAPP_ENABLED                   DUAL_WLAN_START_ID + 257
#define MIB_WLAN1_IAPP_ENABLED                  DUAL_WLAN_START_ID + 258
#define MIB_WLAN_STBC_ENABLED                   DUAL_WLAN_START_ID + 259
#define MIB_WLAN1_STBC_ENABLED                  DUAL_WLAN_START_ID + 260
#define MIB_WLAN_LDPC_ENABLED                   DUAL_WLAN_START_ID + 261
#define MIB_WLAN1_LDPC_ENABLED                  DUAL_WLAN_START_ID + 262
#define MIB_WLAN_TDLS_PROHIBITED                DUAL_WLAN_START_ID + 263
#define MIB_WLAN1_TDLS_PROHIBITED               DUAL_WLAN_START_ID + 264
#define MIB_WLAN_TDLS_CS_PROHIBITED             DUAL_WLAN_START_ID + 265
#define MIB_WLAN1_TDLS_CS_PROHIBITED            DUAL_WLAN_START_ID + 266

#ifdef SUPPORT_FON_GRE
/*vap0*/
#define MIB_WLAN_FREE_SSID_GRE_ENABLE			DUAL_WLAN_START_ID + 267
#define MIB_WLAN1_FREE_SSID_GRE_ENABLE			DUAL_WLAN_START_ID + 268

#define MIB_WLAN_FREE_SSID_GRE_NAME				DUAL_WLAN_START_ID + 269
#define MIB_WLAN1_FREE_SSID_GRE_NAME			DUAL_WLAN_START_ID + 270

#define MIB_WLAN_FREE_SSID_GRE_SERVER			DUAL_WLAN_START_ID + 271
#define MIB_WLAN1_FREE_SSID_GRE_SERVER			DUAL_WLAN_START_ID + 272

#define MIB_WLAN_FREE_SSID_GRE_VLAN				DUAL_WLAN_START_ID + 273
#define MIB_WLAN1_FREE_SSID_GRE_VLAN			DUAL_WLAN_START_ID + 274

/*vap1*/
#define MIB_WLAN_CLOSED_SSID_GRE_ENABLE			DUAL_WLAN_START_ID + 275
#define MIB_WLAN1_CLOSED_SSID_GRE_ENABLE		DUAL_WLAN_START_ID + 276

#define MIB_WLAN_CLOSED_SSID_GRE_NAME			DUAL_WLAN_START_ID + 277
#define MIB_WLAN1_CLOSED_SSID_GRE_NAME			DUAL_WLAN_START_ID + 278

#define MIB_WLAN_CLOSED_SSID_GRE_SERVER			DUAL_WLAN_START_ID + 279
#define MIB_WLAN1_CLOSED_SSID_GRE_SERVER		DUAL_WLAN_START_ID + 280

#define MIB_WLAN_CLOSED_SSID_GRE_VLAN			DUAL_WLAN_START_ID + 281
#define MIB_WLAN1_CLOSED_SSID_GRE_VLAN			DUAL_WLAN_START_ID + 282
#endif

#define DUAL_WLAN_END_ID						DUAL_WLAN_START_ID + 283
...
#define MIB_CAPWAP_MODE 						DUAL_WLAN_END_ID + 8
#define MIB_CAPWAP_WTP_ID 					DUAL_WLAN_END_ID + 9
#endif
/***************************** end of WLAN setting *****************************/
...
#define MIB_DSL_ANNEX_B					HS_ENTRY_ID + 13
...
#ifdef CONFIG_RTK_OMCI_V1
#define MIB_OMCI_WAN_QOS_QUEUE_NUM		HS_ENTRY_ID + 225
#endif

#define MIB_HW_WLAN0_COUNTRYCODE                HS_ENTRY_ID + 226
#define MIB_HW_WLAN0_COUNTRYSTR                HS_ENTRY_ID + 227
#define MIB_HW_WLAN1_COUNTRYCODE                HS_ENTRY_ID + 228
#define MIB_HW_WLAN1_COUNTRYSTR                HS_ENTRY_ID + 229
...
#define MIB_HW_RF_DPK_DP_PATH_C_OK      HS_ENTRY_ID+246
#define MIB_HW_RF_DPK_DP_PATH_D_OK      HS_ENTRY_ID+247
#define MIB_HW_RF_DPK_PWSF_2G_C         HS_ENTRY_ID+248
#define MIB_HW_RF_DPK_PWSF_2G_D         HS_ENTRY_ID+249
#define MIB_HW_RF_DPK_LUT_2G_EVEN_C0    HS_ENTRY_ID+250
#define MIB_HW_RF_DPK_LUT_2G_EVEN_C1    HS_ENTRY_ID+251
#define MIB_HW_RF_DPK_LUT_2G_EVEN_C2    HS_ENTRY_ID+252
#define MIB_HW_RF_DPK_LUT_2G_ODD_C0     HS_ENTRY_ID+253
#define MIB_HW_RF_DPK_LUT_2G_ODD_C1     HS_ENTRY_ID+254
#define MIB_HW_RF_DPK_LUT_2G_ODD_C2     HS_ENTRY_ID+255
#define MIB_HW_RF_DPK_LUT_2G_EVEN_D0    HS_ENTRY_ID+256
#define MIB_HW_RF_DPK_LUT_2G_EVEN_D1    HS_ENTRY_ID+257
#define MIB_HW_RF_DPK_LUT_2G_EVEN_D2    HS_ENTRY_ID+258
#define MIB_HW_RF_DPK_LUT_2G_ODD_D0     HS_ENTRY_ID+259
#define MIB_HW_RF_DPK_LUT_2G_ODD_D1     HS_ENTRY_ID+260
#define MIB_HW_RF_DPK_LUT_2G_ODD_D2     HS_ENTRY_ID+261

#define MIB_HW_RF_DPK_DP_5G_PATH_A_OK    HS_ENTRY_ID+262
#define MIB_HW_RF_DPK_DP_5G_PATH_B_OK    HS_ENTRY_ID+263
#define MIB_HW_RF_DPK_PWSF_5G_A          HS_ENTRY_ID+264
#define MIB_HW_RF_DPK_PWSF_5G_B          HS_ENTRY_ID+265
#define MIB_HW_RF_DPK_LUT_5G_EVEN_A0     HS_ENTRY_ID+266
#define MIB_HW_RF_DPK_LUT_5G_ODD_A0      HS_ENTRY_ID+267
#define MIB_HW_RF_DPK_LUT_5G_EVEN_B0     HS_ENTRY_ID+268
#define MIB_HW_RF_DPK_LUT_5G_ODD_B0      HS_ENTRY_ID+269
#define MIB_HW_RF_DPK_LUT_5G_EVEN_A1     HS_ENTRY_ID+270
#define MIB_HW_RF_DPK_LUT_5G_ODD_A1      HS_ENTRY_ID+271
#define MIB_HW_RF_DPK_LUT_5G_EVEN_B1     HS_ENTRY_ID+272
#define MIB_HW_RF_DPK_LUT_5G_ODD_B1      HS_ENTRY_ID+273
#define MIB_HW_RF_DPK_LUT_5G_EVEN_A2     HS_ENTRY_ID+274
#define MIB_HW_RF_DPK_LUT_5G_ODD_A2      HS_ENTRY_ID+275
#define MIB_HW_RF_DPK_LUT_5G_EVEN_B2     HS_ENTRY_ID+276
#define MIB_HW_RF_DPK_LUT_5G_ODD_B2      HS_ENTRY_ID+277
#define MIB_HW_RF_DPK_LUT_5G_EVEN_A3     HS_ENTRY_ID+278
#define MIB_HW_RF_DPK_LUT_5G_ODD_A3      HS_ENTRY_ID+279
#define MIB_HW_RF_DPK_LUT_5G_EVEN_B3     HS_ENTRY_ID+280
#define MIB_HW_RF_DPK_LUT_5G_ODD_B3      HS_ENTRY_ID+281
#define MIB_HW_RF_DPK_LUT_5G_EVEN_A4     HS_ENTRY_ID+282
#define MIB_HW_RF_DPK_LUT_5G_ODD_A4      HS_ENTRY_ID+283
#define MIB_HW_RF_DPK_LUT_5G_EVEN_B4     HS_ENTRY_ID+284
#define MIB_HW_RF_DPK_LUT_5G_ODD_B4      HS_ENTRY_ID+285
#define MIB_HW_RF_DPK_LUT_5G_EVEN_A5     HS_ENTRY_ID+286
#define MIB_HW_RF_DPK_LUT_5G_ODD_A5      HS_ENTRY_ID+287
#define MIB_HW_RF_DPK_LUT_5G_EVEN_B5     HS_ENTRY_ID+288
#define MIB_HW_RF_DPK_LUT_5G_ODD_B5      HS_ENTRY_ID+289
#define MIB_HW_RF_DPK_LUT_5G_EVEN_A6     HS_ENTRY_ID+290
#define MIB_HW_RF_DPK_LUT_5G_ODD_A6      HS_ENTRY_ID+291
#define MIB_HW_RF_DPK_LUT_5G_EVEN_B6     HS_ENTRY_ID+292
#define MIB_HW_RF_DPK_LUT_5G_ODD_B6      HS_ENTRY_ID+293
#define MIB_HW_RF_DPK_LUT_5G_EVEN_A7     HS_ENTRY_ID+294
#define MIB_HW_RF_DPK_LUT_5G_ODD_A7      HS_ENTRY_ID+295
#define MIB_HW_RF_DPK_LUT_5G_EVEN_B7     HS_ENTRY_ID+296
#define MIB_HW_RF_DPK_LUT_5G_ODD_B7      HS_ENTRY_ID+297
#define MIB_HW_RF_DPK_LUT_5G_EVEN_A8     HS_ENTRY_ID+298
#define MIB_HW_RF_DPK_LUT_5G_ODD_A8      HS_ENTRY_ID+299
#define MIB_HW_RF_DPK_LUT_5G_EVEN_B8     HS_ENTRY_ID+300
#define MIB_HW_RF_DPK_LUT_5G_ODD_B8      HS_ENTRY_ID+301

#define MIB_HW_RF_DPK_DP_5G_PATH_C_OK    HS_ENTRY_ID+302
#define MIB_HW_RF_DPK_DP_5G_PATH_D_OK    HS_ENTRY_ID+303
#define MIB_HW_RF_DPK_PWSF_5G_C          HS_ENTRY_ID+304
#define MIB_HW_RF_DPK_PWSF_5G_D          HS_ENTRY_ID+305
#define MIB_HW_RF_DPK_LUT_5G_EVEN_C0     HS_ENTRY_ID+306
#define MIB_HW_RF_DPK_LUT_5G_ODD_C0      HS_ENTRY_ID+307
#define MIB_HW_RF_DPK_LUT_5G_EVEN_D0     HS_ENTRY_ID+308
#define MIB_HW_RF_DPK_LUT_5G_ODD_D0      HS_ENTRY_ID+309
#define MIB_HW_RF_DPK_LUT_5G_EVEN_C1     HS_ENTRY_ID+310
#define MIB_HW_RF_DPK_LUT_5G_ODD_C1      HS_ENTRY_ID+311
#define MIB_HW_RF_DPK_LUT_5G_EVEN_D1     HS_ENTRY_ID+312
#define MIB_HW_RF_DPK_LUT_5G_ODD_D1      HS_ENTRY_ID+313
#define MIB_HW_RF_DPK_LUT_5G_EVEN_C2     HS_ENTRY_ID+314
#define MIB_HW_RF_DPK_LUT_5G_ODD_C2      HS_ENTRY_ID+315
#define MIB_HW_RF_DPK_LUT_5G_EVEN_D2     HS_ENTRY_ID+316
#define MIB_HW_RF_DPK_LUT_5G_ODD_D2      HS_ENTRY_ID+317
#define MIB_HW_RF_DPK_LUT_5G_EVEN_C3     HS_ENTRY_ID+318
#define MIB_HW_RF_DPK_LUT_5G_ODD_C3      HS_ENTRY_ID+319
#define MIB_HW_RF_DPK_LUT_5G_EVEN_D3     HS_ENTRY_ID+320
#define MIB_HW_RF_DPK_LUT_5G_ODD_D3      HS_ENTRY_ID+321
#define MIB_HW_RF_DPK_LUT_5G_EVEN_C4     HS_ENTRY_ID+322
#define MIB_HW_RF_DPK_LUT_5G_ODD_C4      HS_ENTRY_ID+323
#define MIB_HW_RF_DPK_LUT_5G_EVEN_D4     HS_ENTRY_ID+324
#define MIB_HW_RF_DPK_LUT_5G_ODD_D4      HS_ENTRY_ID+325
#define MIB_HW_RF_DPK_LUT_5G_EVEN_C5     HS_ENTRY_ID+326
#define MIB_HW_RF_DPK_LUT_5G_ODD_C5      HS_ENTRY_ID+327
#define MIB_HW_RF_DPK_LUT_5G_EVEN_D5     HS_ENTRY_ID+328
#define MIB_HW_RF_DPK_LUT_5G_ODD_D5      HS_ENTRY_ID+329
#define MIB_HW_RF_DPK_LUT_5G_EVEN_C6     HS_ENTRY_ID+330
#define MIB_HW_RF_DPK_LUT_5G_ODD_C6      HS_ENTRY_ID+331
#define MIB_HW_RF_DPK_LUT_5G_EVEN_D6     HS_ENTRY_ID+332
#define MIB_HW_RF_DPK_LUT_5G_ODD_D6      HS_ENTRY_ID+333
#define MIB_HW_RF_DPK_LUT_5G_EVEN_C7     HS_ENTRY_ID+334
#define MIB_HW_RF_DPK_LUT_5G_ODD_C7      HS_ENTRY_ID+335
#define MIB_HW_RF_DPK_LUT_5G_EVEN_D7     HS_ENTRY_ID+336
#define MIB_HW_RF_DPK_LUT_5G_ODD_D7      HS_ENTRY_ID+337
#define MIB_HW_RF_DPK_LUT_5G_EVEN_C8     HS_ENTRY_ID+338
#define MIB_HW_RF_DPK_LUT_5G_ODD_C8      HS_ENTRY_ID+339
#define MIB_HW_RF_DPK_LUT_5G_EVEN_D8     HS_ENTRY_ID+340
#define MIB_HW_RF_DPK_LUT_5G_ODD_D8      HS_ENTRY_ID+341

#define MIB_VENDOR_SPEC_INFO					HS_ENTRY_ID + 342

#if defined(CONFIG_GPON_FEATURE) || defined(CONFIG_EPON_FEATURE)
#define MIB_PON_SPEED							HS_ENTRY_ID + 343
#endif

#define MIB_HW_11N_TSSI_ENABLE				HS_ENTRY_ID + 344
#define MIB_HW_TX_POWER_TSSI_5G_HT40_1S_A		HS_ENTRY_ID + 345
#define MIB_HW_TX_POWER_TSSI_5G_HT40_1S_B		HS_ENTRY_ID + 346

#define MIB_HW_WLAN1_11N_TSSI_ENABLE			HS_ENTRY_ID + 347
#define MIB_HW_WLAN1_TX_POWER_TSSI_5G_HT40_1S_A		HS_ENTRY_ID + 348
#define MIB_HW_WLAN1_TX_POWER_TSSI_5G_HT40_1S_B		HS_ENTRY_ID + 349

#define MIB_DEFAULT_WLAN_SSID          HS_ENTRY_ID + 350
...
#define MIB_PORT_BINDING_TBL CHAIN_ENTRY_TBL_ID+74
#else
...
#define MIB_PORT_BINDING_TBL CHAIN_ENTRY_TBL_ID+74
#endif
#define MIB_L2BRIDGING_FILTER_TBL CHAIN_ENTRY_TBL_ID+75
#define MIB_L2BRIDGING_MARKING_TBL CHAIN_ENTRY_TBL_ID+76
#endif //CONFIG_00R0
#endif
#endif

#ifdef _CWMP_MIB_
#define MIB_CWMP_ACL_IP_TBL			CHAIN_ENTRY_TBL_ID + 77
#endif

#ifdef CONFIG_NET_IPGRE
#define MIB_GRE_TBL				CHAIN_ENTRY_TBL_ID + 78
#endif

#ifdef CONFIG_USER_TR232_IPDRFTP	//TR157 Bulk Data support
#define MIB_BULK_DATA_TBL			CHAIN_ENTRY_TBL_ID+79
#define MIB_BULK_PROFILE_TBL		CHAIN_ENTRY_TBL_ID+80
#define MIB_BULK_PROF_PRMT_TBL	CHAIN_ENTRY_TBL_ID+81
#define MIB_BULK_PROF_CSV_TBL		CHAIN_ENTRY_TBL_ID+82
#define MIB_BULK_PROF_JSON_TBL	CHAIN_ENTRY_TBL_ID+83
#define MIB_BULK_PROF_HTTP_TBL	CHAIN_ENTRY_TBL_ID+84
#define MIB_BULK_HTTP_REQ_URI_TBL	CHAIN_ENTRY_TBL_ID+85
#endif
#if defined(CONFIG_IPV6) && defined(IP_ACL)
#define MIB_V6_ACL_IP_TBL			CHAIN_ENTRY_TBL_ID+86
#endif

#ifdef CONFIG_USER_RTK_LBD
#define MIB_LBD_VLAN_TBL			CHAIN_ENTRY_TBL_ID+87
#endif
...
#if defined(TRIBAND_SUPPORT)
enum {
    DUAL_WLAN_CHAIN_START_ID = WLAN_CHAIN_ENTRY_ID,
...
#ifdef WLAN_WDS
    MIB_MAPPING2(WDS_TBL),
#endif

#ifdef WLAN_11R
    MIB_MAPPING(FTKH_TBL),
#endif
...
#define MIB_WLAN_MESH_ACL_TBL		DUAL_WLAN_CHAIN_START_ID+9
#define MIB_WLAN1_MESH_ACL_TBL		DUAL_WLAN_CHAIN_START_ID+10

#define DUAL_WLAN_CHAIN_END_ID		DUAL_WLAN_CHAIN_START_ID+11
#endif /* defined(TRIBAND_SUPPORT) */
...
#define CWMP_INFORM_USER_EVENTCODE		CWMP_ID + 89
#define CWMP_ACL_ENABLE				CWMP_ID + 90
#define CWMP_DELAY_RESTARTWAN_ENABLE CWMP_ID + 91
#define CWMP_DELAY_RESTARTWAN_CHECK_TIME CWMP_ID + 92
...
#define Y1731_WAN_INTERFACE						Y1731_ID+8
#define Y1731_ENABLE_CCM						Y1731_ID+9
#define Y1731_VLANID							Y1731_ID+10
#endif

#ifdef CONFIG_USER_8023AH
#define EFM_8023AH_ID							7000
#define EFM_8023AH_MODE							EFM_8023AH_ID+1
#define EFM_8023AH_WAN_INTERFACE					EFM_8023AH_ID+2
#define EFM_8023AH_ACTIVE						EFM_8023AH_ID+3
#endif

#define MULTI_PROVINCE_ID						8000
...
#endif
#define MIB_RS_PING_INTF RS_ENTRY_ID + 6
#define MIB_RS_PING_HOST RS_ENTRY_ID + 7
#define MIB_RS_TRACEROUTE_INTF RS_ENTRY_ID + 8
#define MIB_RS_TRACEROUTE_HOST RS_ENTRY_ID + 9

#ifdef CONFIG_USER_CWMP_TR069
#ifdef CONFIG_TR142_MODULE
#define RS_OMCI_TR069_IF_NAME	RS_ENTRY_ID + 10
#endif
#define RS_DHCP_ACS_URL			RS_ENTRY_ID + 11
#define RS_DHCP_TR069_IF_NAME	RS_ENTRY_ID + 12
#define RS_CWMP_STATUS			RS_ENTRY_ID + 13
#define RS_CWMP_USED_ACS_URL	RS_ENTRY_ID + 14
#define RS_CWMP_USED_ACS_FROM	RS_ENTRY_ID + 15
#endif //CONFIG_USER_CWMP_TR069

#ifdef CONFIG_00R0
#ifdef USER_WEB_WIZARD
#define RS_WEB_WIZARD_REDIRECTTROUBLEWIZARD RS_ENTRY_ID + 16
#endif

#ifdef CONFIG_TR142_MODULE
#define RS_OMCI_MANAGED_PORT_CONFIGURED	RS_ENTRY_ID + 17
#define RS_OMCI_MANAGED_PORT			RS_ENTRY_ID + 18
#endif
#define RS_OMCI_CONFIG_STATUS			RS_ENTRY_ID + 19
#endif //CONFIG_00R0
#define MIB_RS_CWMP_SESSION_START_TIME RS_ENTRY_ID + 20
#define MIB_RS_CWMP_SESSION_END_TIME RS_ENTRY_ID + 21

#define MIB_RS_LBD_PORT_STATUS		RS_ENTRY_ID + 22
...
#define CWMP_FLAG2_CWMP_PRINT_PACKET		0x80
...
typedef enum { DHCP_LAN_NONE=0, DHCP_LAN_RELAY=1, DHCP_LAN_SERVER=2, DHCP_LAN_CLIENT=3,  DHCP_LAN_SERVER_AUTO=4} DHCP_TYPE_T;
#else
...
typedef enum { IPQOS_PORT_BASE=0, IPQOS_ETHERTYPE_BASE, IPQOS_IP_PROTO_BASE, IPQOS_MAC_BASE, IPQOS_CONNTYPE_BASE, IPQOS_APPLICATION_BASE, IPQOS_DHCPOPT_BASE, IPQOS_8021P_BASE } IPQOS_TYPE_T;
...
//	unsigned char elanMacAddr[6]; // Ethernet Lan MAC address
...
#if defined(CONFIG_RTL_92D_SUPPORT)
	unsigned char wlan2_macPhyMode;	//0:SMACSPHY, 1:DMACSPHY, 2:DMACDPHY
#endif
	...
	unsigned long wlan2_wpaGroupRekeyTime; // group key rekey time in second
	...
	unsigned char wlan2_BlockEth2Wir; // block/un-block ethernet to wireless
...
#if defined(WLAN_DUALBAND_CONCURRENT)
    unsigned int wlan1_tx_restrict;
    unsigned int wlan1_rx_restrict;
...
#if defined(TRIBAND_SUPPORT)
    unsigned int wlan2_tx_restrict;
    unsigned int wlan2_rx_restrict;
...
#ifdef CONFIG_MULTI_SMBD_ACCOUNT
	unsigned char samba_security_enable;
#endif
#endif
...
//for FIELD_TRY_SAFE_MODE web control
	...
	unsigned int lan_alias_vlan_id;
...
#ifdef CONFIG_00R0
	unsigned char gpon_ploam_passwd_backup[11];
	unsigned char ngpon_ploam_passwd_backup[37];
#endif
#endif
#ifdef CONFIG_00R0
...
#endif
#ifdef CONFIG_USER_CATV_WEB	 
	unsigned char catv_rx_power[30];
	unsigned char catv_tx_power[30];
	unsigned char catv_state[30];
	unsigned char catv_dc_vcc[30];
	unsigned char catv_temperature[30];
	unsigned char catv_gain_control[30];
	unsigned char catv_rf_onoff[30];
	unsigned char catv_HardwareVersion[30];
	unsigned char catv_SoftwareVersion[30];
#endif
	unsigned char config_mode[30];
...
//#endif // defined(CONFIG_WLAN_HAL_8814AE) && (defined(WLAN_DUALBAND_CONCURRENT)
	...
	char snmpSysDescr[SNMP_STRING_LEN];
#endif
...
// and it is supposed that NOR flash platform does not use wifi-DPK.
#ifdef CONFIG_RF_DPK_SETTING_SUPPORT
...
#else
#ifdef CONFIG_USER_COMPRESS_HARDWARE_SETTING
#define HW_SETTING_MAX_LEN		0x4000
#define HW_SETTING_MAX_REAL_LEN	0x2000	//real size in flash
#else
