...
XML_ENTRY_ENCRYPT_STRING2("pppUser", pppUsername, atmvc, (atmvc+atmvc_Idx)->pppUsername, 0);	//STRING_T
XML_ENTRY_ENCRYPT_STRING2("pppPasswd", pppPassword, atmvc, (atmvc+atmvc_Idx)->pppPassword, 0);	//STRING_T
#else
...
XML_ENTRY_PRIMITIVE2("pppLcpEcho", pppLcpEcho, atmvc, "%hu", (atmvc+atmvc_Idx)->pppLcpEcho, 0);	//WORD_T
XML_ENTRY_PRIMITIVE2("pppLcpEchoRetry", pppLcpEchoRetry, atmvc, "%hu", (atmvc+atmvc_Idx)->pppLcpEchoRetry, 0);	//WORD_T
...
XML_ENTRY_PRIMITIVE2("enableMLD", enableMLD, atmvc, "%hhu", (atmvc+atmvc_Idx)->enableMLD, 0);   //BYTE_T
#endif	//CONFIG_MLDPROXY_MULTIWAN
#ifdef CONFIG_00R0
XML_ENTRY_PRIMITIVE2("enableRIPv2", enableRIPv2, atmvc, "%hhu", (atmvc+atmvc_Idx)->enableRIPv2, 0);   //BYTE_T
#endif
...
XML_ENTRY_PRIMITIVE2("mVid", mVid, atmvc, "%hu", (atmvc+atmvc_Idx)->mVid, 0);   //WORD_T
//#endif
...
XML_ENTRY_PRIMITIVE2("othertype", othertype, atmvc, "%u", (atmvc+atmvc_Idx)->othertype, 0);   //DWORD_T
#endif
XML_ENTRY_PRIMITIVE2("disableLanDhcp", disableLanDhcp, atmvc, "%hhu", (atmvc+atmvc_Idx)->disableLanDhcp, 0);   //BYTE_T
...
XML_ENTRY_PRIMITIVE2("dnsv6Mode", dnsv6Mode, atmvc, "%hhu", (atmvc+atmvc_Idx)->dnsv6Mode, 0);	 //BYTE_T
...
/* CHAIN MIB_CWMP_ACL_IP_TBL */
#ifdef _CWMP_MIB_
static int cwmp_aclip_Idx=0;
MIB_CWMP_ACL_IP_T _cwmp_aclip[8];
MIB_CWMP_ACL_IP_Tp cwmp_aclip = _cwmp_aclip;
XML_DIR_ARRAY("MIB_CWMP_ACL_IP_TBL", cwmp_aclip, root, cwmp_aclip_Idx, 8, MIB_CWMP_ACL_IP_TBL);
XML_ENTRY_ADDR("IPAddr", ipAddr, cwmp_aclip, (cwmp_aclip+cwmp_aclip_Idx)->ipAddr, 0);   //IA_T
XML_ENTRY_PRIMITIVE2("NetMask", maskbit, cwmp_aclip, "%hhu", (cwmp_aclip+cwmp_aclip_Idx)->maskbit, 0);   //BYTE_T
#endif
...
static int w2lac_Idx=0;
MIB_CE_WLAN_AC_T _w2lac[MAX_WLAN_AC_NUM];
MIB_CE_WLAN_AC_Tp w2lac = _w2lac;
XML_DIR_ARRAY("WLAN2_AC_TBL", w2lac, root, w2lac_Idx, MAX_WLAN_AC_NUM, MIB_WLAN2_AC_TBL);
XML_ENTRY_PRIMITIVE2("wlanIdx", wlanIdx, w2lac, "%hhu", (w2lac+w2lac_Idx)->wlanIdx, 0);   //BYTE_T
XML_ENTRY_BYTE6("MacAddr", macAddr, w2lac, (w2lac+w2lac_Idx)->macAddr, 0);   //BYTE6_T
#endif
...
#endif
#if defined(TRIBAND_SUPPORT)
static int wlan2_ftkh_Idx=0;
MIB_CE_WLAN_FTKH_T _wlan2_ftkh[MAX_WLAN_FTKH_NUM];
MIB_CE_WLAN_FTKH_Tp wlan2_ftkh = _wlan2_ftkh;
XML_DIR_ARRAY("WLAN2_FTKH_TBL", wlan2_ftkh, root, wlan2_ftkh_Idx, MAX_WLAN_FTKH_NUM, MIB_WLAN2_FTKH_TBL);
XML_ENTRY_PRIMITIVE2("wlanIdx", wlanIdx, wlan2_ftkh, "%hhu", (wlan2_ftkh+wlan2_ftkh_Idx)->wlanIdx, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("intfIdx", intfIdx, wlan2_ftkh, "%hhu", (wlan2_ftkh+wlan2_ftkh_Idx)->intfIdx, 0);   //BYTE_T
XML_ENTRY_BYTE6("addr", addr, wlan2_ftkh, (wlan2_ftkh+wlan2_ftkh_Idx)->addr, 0);   //BYTE6_T
XML_ENTRY_STRING2("r0kh_id", r0kh_id, wlan2_ftkh, (wlan2_ftkh+wlan2_ftkh_Idx)->r0kh_id, 0);   //STRING_T
XML_ENTRY_STRING2("key", key, wlan2_ftkh, (wlan2_ftkh+wlan2_ftkh_Idx)->key, 0);   //STRING_T
#endif
#endif
#if defined(WLAN_MESH_ACL_ENABLE)
/* CHAIN WLAN_MESH_ACL_TBL*/
static int wlan_mesh_acl_Idx=0;
MIB_CE_WLAN_AC_T _wlan_mesh_acl[MAX_WLAN_AC_NUM];
MIB_CE_WLAN_AC_Tp wlan_mesh_acl = _wlan_mesh_acl;
XML_DIR_ARRAY("WLAN_MESH_ACL_TBL", wlan_mesh_acl, root, wlan_mesh_acl_Idx, MAX_WLAN_AC_NUM, MIB_WLAN_MESH_ACL_TBL);
XML_ENTRY_PRIMITIVE2("wlanIdx", wlanIdx, wlan_mesh_acl, "%hhu", (wlan_mesh_acl+wlan_mesh_acl_Idx)->wlanIdx, 0);   //BYTE_T
XML_ENTRY_BYTE6("MacAddr", macAddr, wlan_mesh_acl, (wlan_mesh_acl+wlan_mesh_acl_Idx)->macAddr, 0);   //BYTE6_T
#if defined(WLAN_DUALBAND_CONCURRENT)
static int wlan1_mesh_acl_Idx=0;
MIB_CE_WLAN_AC_T _wlan1_mesh_acl[MAX_WLAN_AC_NUM];
MIB_CE_WLAN_AC_Tp wlan1_mesh_acl = _wlan1_mesh_acl;
XML_DIR_ARRAY("WLAN1_MESH_ACL_TBL", wlan1_mesh_acl, root, wlan1_mesh_acl_Idx, MAX_WLAN_AC_NUM, MIB_WLAN1_MESH_ACL_TBL);
XML_ENTRY_PRIMITIVE2("wlanIdx", wlanIdx, wlan1_mesh_acl, "%hhu", (wlan1_mesh_acl+wlan1_mesh_acl_Idx)->wlanIdx, 0);   //BYTE_T
XML_ENTRY_BYTE6("MacAddr", macAddr, wlan1_mesh_acl, (wlan1_mesh_acl+wlan1_mesh_acl_Idx)->macAddr, 0);   //BYTE6_T
#endif
#if defined(TRIBAND_SUPPORT)
static int wlan2_mesh_acl_Idx=0;
MIB_CE_WLAN_AC_T _wlan2_mesh_acl[MAX_WLAN_AC_NUM];
MIB_CE_WLAN_AC_Tp wlan2_mesh_acl = _wlan2_mesh_acl;
XML_DIR_ARRAY("WLAN2_MESH_ACL_TBL", wlan2_mesh_acl, root, wlan2_mesh_acl_Idx, MAX_WLAN_AC_NUM, MIB_WLAN2_MESH_ACL_TBL);
XML_ENTRY_PRIMITIVE2("wlanIdx", wlanIdx, wlan2_mesh_acl, "%hhu", (wlan2_mesh_acl+wlan2_mesh_acl_Idx)->wlanIdx, 0);   //BYTE_T
XML_ENTRY_BYTE6("MacAddr", macAddr, wlan2_mesh_acl, (wlan2_mesh_acl+wlan2_mesh_acl_Idx)->macAddr, 0);   //BYTE6_T
#endif
/* CHAIN WLAN_MESH_ACL_TBL END*/
#endif
#endif
...
#ifdef CONFIG_00R0
XML_DIR_HIDDEN_ARRAY("IP_QOS_TBL", ipqos, root, ipqos_Idx, MAX_QOS_RULE, MIB_IP_QOS_TBL);
XML_ENTRY_HIDDEN_PRIMITIVE2("TYPE", ipqos_rule_type, ipqos, "%hhu", (ipqos+ipqos_Idx)->ipqos_rule_type, 0);   //BYTE_T
XML_ENTRY_HIDDEN_STRING2("Name", RuleName, ipqos, (ipqos+ipqos_Idx)->RuleName, 0);   //STRING_T
XML_ENTRY_HIDDEN_ADDR("SrcIP", sip, ipqos, (ipqos+ipqos_Idx)->sip, 0);   //IA_T
XML_ENTRY_HIDDEN_PRIMITIVE2("SrcMask", smaskbit, ipqos, "%hhu", (ipqos+ipqos_Idx)->smaskbit, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("SrcPort", sPort, ipqos, "%hu", (ipqos+ipqos_Idx)->sPort, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("SrcPortRangeMax", sPortRangeMax, ipqos, "%hu", (ipqos+ipqos_Idx)->sPortRangeMax, 0);   //WORD_T
XML_ENTRY_HIDDEN_ADDR("DstIP", dip, ipqos, (ipqos+ipqos_Idx)->dip, 0);   //IA_T
XML_ENTRY_HIDDEN_PRIMITIVE2("DstMask", dmaskbit, ipqos, "%hhu", (ipqos+ipqos_Idx)->dmaskbit, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("DstPort", dPort, ipqos, "%hu", (ipqos+ipqos_Idx)->dPort, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("DstPortRangeMax", dPortRangeMax, ipqos, "%hu", (ipqos+ipqos_Idx)->dPortRangeMax, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("EthernetType", ethType, ipqos, "%hu", (ipqos+ipqos_Idx)->ethType, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("Protocol", protoType, ipqos, "%hhu", (ipqos+ipqos_Idx)->protoType, 0);   //BYTE_T
XML_ENTRY_HIDDEN_BYTE6("SMac", smac, ipqos, (ipqos+ipqos_Idx)->smac, 0);   //BYTE6_T
XML_ENTRY_HIDDEN_BYTE6("DMac", dmac, ipqos, (ipqos+ipqos_Idx)->dmac, 0);   //BYTE6_T
XML_ENTRY_HIDDEN_PRIMITIVE2("PhyPort", phyPort, ipqos, "%hhu", (ipqos+ipqos_Idx)->phyPort, 0);   //BYTE_T
#if defined(CONFIG_USER_IP_QOS) || defined(QOS_DIFFSERV)
XML_ENTRY_HIDDEN_PRIMITIVE2("qosDscp", qosDscp, ipqos, "%hhu", (ipqos+ipqos_Idx)->qosDscp, 0);   //BYTE_T
#endif
#ifdef CONFIG_USER_IP_QOS
XML_ENTRY_HIDDEN_PRIMITIVE2("vlan1p", vlan1p, ipqos, "%hhu", (ipqos+ipqos_Idx)->vlan1p, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("tos", tos, ipqos, "%hhu", (ipqos+ipqos_Idx)->tos, 0);   //BYTE_T
#endif
XML_ENTRY_HIDDEN_PRIMITIVE2("OutInf", outif, ipqos, "%u", (ipqos+ipqos_Idx)->outif, 0);   //INTEGER_T
XML_ENTRY_HIDDEN_PRIMITIVE2("Prior", prior, ipqos, "%hhu", (ipqos+ipqos_Idx)->prior, 0);   //BYTE_T
#ifdef QOS_DSCP
XML_ENTRY_HIDDEN_PRIMITIVE2("Dscp", dscp, ipqos, "%hhu", (ipqos+ipqos_Idx)->dscp, 0);   //BYTE_T
#endif
XML_ENTRY_HIDDEN_PRIMITIVE2("m_ipprio", m_ipprio, ipqos, "%hhu", (ipqos+ipqos_Idx)->m_ipprio, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("m_iptos", m_iptos, ipqos, "%hhu", (ipqos+ipqos_Idx)->m_iptos, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("m_vid", m_vid, ipqos, "%hu", (ipqos+ipqos_Idx)->m_vid, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("m_1p", m_1p, ipqos, "%hhu", (ipqos+ipqos_Idx)->m_1p, 0);   //BYTE_T
#ifdef CONFIG_USER_IP_QOS
XML_ENTRY_HIDDEN_PRIMITIVE2("m_dscp", m_dscp, ipqos, "%hhu", (ipqos+ipqos_Idx)->m_dscp, 0);   //BYTE_T
#endif
XML_ENTRY_HIDDEN_PRIMITIVE2("Enable", enable, ipqos, "%hhu", (ipqos+ipqos_Idx)->enable, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("QoSOrder", QoSOrder, ipqos, "%u", (ipqos+ipqos_Idx)->QoSOrder, 0);   //INTEGER_T
#ifdef _CWMP_MIB_ /*jiunming, mib for cwmp-tr069*/
XML_ENTRY_HIDDEN_PRIMITIVE2("InstanceNum", InstanceNum, ipqos, "%u", (ipqos+ipqos_Idx)->InstanceNum, 0);   //DWORD_T
#endif
#ifdef QOS_SPEED_LIMIT_SUPPORT
XML_ENTRY_HIDDEN_PRIMITIVE2("limitSpeedEnabled", limitSpeedEnabled, ipqos, "%hhu", (ipqos+ipqos_Idx)->limitSpeedEnabled, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("limitSpeedRank", limitSpeedRank, ipqos, "%hhu", (ipqos+ipqos_Idx)->limitSpeedRank, 0);   //BYTE_T
#endif
#ifdef QOS_DIFFSERV
XML_ENTRY_HIDDEN_PRIMITIVE2("ifIndex", ifIndex, ipqos, "%u", (ipqos+ipqos_Idx)->ifIndex, 0);   //INTEGER_T
XML_ENTRY_HIDDEN_PRIMITIVE2("enDiffserv", enDiffserv, ipqos, "%hhu", (ipqos+ipqos_Idx)->enDiffserv, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("totalBandwidth", totalBandwidth, ipqos, "%hu", (ipqos+ipqos_Idx)->totalBandwidth, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("htbRate", htbRate, ipqos, "%hu", (ipqos+ipqos_Idx)->htbRate, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("latency", latency, ipqos, "%u", (ipqos+ipqos_Idx)->latency, 0);   //DWORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("limitSpeed", limitSpeed, ipqos, "%u", (ipqos+ipqos_Idx)->limitSpeed, 0);   //DWORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("policing", policing, ipqos, "%hhu", (ipqos+ipqos_Idx)->policing, 0);   //BYTE_T
#endif
XML_ENTRY_HIDDEN_PRIMITIVE2("flags", flags, ipqos, "%hu", (ipqos+ipqos_Idx)->flags, 0);   //WORD_T
#ifdef BR_ROUTE_ONEPVC
XML_ENTRY_HIDDEN_PRIMITIVE2("cmode", cmode, ipqos, "%hhu", (ipqos+ipqos_Idx)->cmode, 0);   //BYTE_T
#endif
#ifdef CONFIG_IPV6
XML_ENTRY_HIDDEN_PRIMITIVE2("IPVersion", IpProtocol, ipqos, "%hhu", (ipqos+ipqos_Idx)->IpProtocol, 0);   //BYTE_T
XML_ENTRY_HIDDEN_ADDR6("SrcIP6", sip6, ipqos, (ipqos+ipqos_Idx)->sip6, 0);   //IA6_T
XML_ENTRY_HIDDEN_ADDR6("DstIP6", dip6, ipqos, (ipqos+ipqos_Idx)->dip6, 0);   //IA6_T
XML_ENTRY_HIDDEN_PRIMITIVE2("SrcIP6PrefixLen", sip6PrefixLen, ipqos, "%hhu", (ipqos+ipqos_Idx)->sip6PrefixLen, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("DstIP6PrefixLen", dip6PrefixLen, ipqos, "%hhu", (ipqos+ipqos_Idx)->dip6PrefixLen, 0);   //BYTE_T
#endif
#ifdef CONFIG_BRIDGE_EBT_DHCP_OPT
XML_ENTRY_HIDDEN_PRIMITIVE2("dhcpopt_type", dhcpopt_type, ipqos, "%hhu", (ipqos+ipqos_Idx)->dhcpopt_type, 0);   //BYTE_T
XML_ENTRY_HIDDEN_STRING2("opt60_vendorclass", opt60_vendorclass, ipqos, (ipqos+ipqos_Idx)->opt60_vendorclass, 0);   //STRING_T
XML_ENTRY_HIDDEN_PRIMITIVE2("opt61_iaid", opt61_iaid, ipqos, "%u", (ipqos+ipqos_Idx)->opt61_iaid, 0);   //DWORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("opt61_duid_type", opt61_duid_type, ipqos, "%hhu", (ipqos+ipqos_Idx)->opt61_duid_type, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("duid_hw_type", duid_hw_type, ipqos, "%hu", (ipqos+ipqos_Idx)->duid_hw_type, 0);   //WORD_T
XML_ENTRY_HIDDEN_BYTE6("duid_mac", duid_mac, ipqos, (ipqos+ipqos_Idx)->duid_mac, 0);   //BYTE6_T
XML_ENTRY_HIDDEN_PRIMITIVE2("duid_time", duid_time, ipqos, "%hu", (ipqos+ipqos_Idx)->duid_time, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("duid_ent_num", duid_ent_num, ipqos, "%hu", (ipqos+ipqos_Idx)->duid_ent_num, 0);   //WORD_T
XML_ENTRY_HIDDEN_STRING2("duid_ent_id", duid_ent_id, ipqos, (ipqos+ipqos_Idx)->duid_ent_id, 0);   //STRING_T
XML_ENTRY_HIDDEN_PRIMITIVE2("opt125_ent_num", opt125_ent_num, ipqos, "%hu", (ipqos+ipqos_Idx)->opt125_ent_num, 0);   //WORD_T
XML_ENTRY_HIDDEN_STRING2("opt125_manufacturer", opt125_manufacturer, ipqos, (ipqos+ipqos_Idx)->opt125_manufacturer, 0);   //STRING_T
XML_ENTRY_HIDDEN_STRING2("opt125_product_class", opt125_product_class, ipqos, (ipqos+ipqos_Idx)->opt125_product_class, 0);   //STRING_T
XML_ENTRY_HIDDEN_STRING2("opt125_model", opt125_model, ipqos, (ipqos+ipqos_Idx)->opt125_model, 0);   //STRING_T
XML_ENTRY_HIDDEN_STRING2("opt125_serial", opt125_serial, ipqos, (ipqos+ipqos_Idx)->opt125_serial, 0);   //STRING_T
#endif
XML_ENTRY_HIDDEN_PRIMITIVE2("applicationtype", applicationtype, ipqos, "%u", (ipqos+ipqos_Idx)->applicationtype, 0);   //INTEGER_T
XML_ENTRY_HIDDEN_PRIMITIVE2("application", application, ipqos, "%u", (ipqos+ipqos_Idx)->application, 0);   //INTEGER_T
#else
...
XML_ENTRY_PRIMITIVE2("QoSOrder", QoSOrder, ipqos, "%u", (ipqos+ipqos_Idx)->QoSOrder, 0);   //INTEGER_T
#ifdef _CWMP_MIB_ /*jiunming, mib for cwmp-tr069*/
...
#ifdef CONFIG_00R0
XML_DIR_HIDDEN_ARRAY("IP_QOS_TC_TBL", ipqos_tc, root, ipqos_tc_Idx, MAX_QOS_RULE, MIB_IP_QOS_TC_TBL);
XML_ENTRY_HIDDEN_PRIMITIVE2("entryid", entryid, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->entryid, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("ifIndex", ifIndex, ipqos_tc, "%u", (ipqos_tc+ipqos_tc_Idx)->ifIndex, 0);   //INTEGER_T
XML_ENTRY_HIDDEN_ADDR("Srcip", srcip, ipqos_tc, (ipqos_tc+ipqos_tc_Idx)->srcip, 0);   //IA_T
XML_ENTRY_HIDDEN_PRIMITIVE2("srcmask", smaskbits, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->smaskbits, 0);   //BYTE_T
XML_ENTRY_HIDDEN_ADDR("dstip", dstip, ipqos_tc, (ipqos_tc+ipqos_tc_Idx)->dstip, 0);   //IA_T
XML_ENTRY_HIDDEN_PRIMITIVE2("dstmask", dmaskbits, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->dmaskbits, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("srcport", sport, ipqos_tc, "%hu", (ipqos_tc+ipqos_tc_Idx)->sport, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("dstport", dport, ipqos_tc, "%hu", (ipqos_tc+ipqos_tc_Idx)->dport, 0);   //WORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("protocol", protoType, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->protoType, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("rate", limitSpeed, ipqos_tc, "%u", (ipqos_tc+ipqos_tc_Idx)->limitSpeed, 0);   //DWORD_T
#ifdef BR_ROUTE_ONEPVC
XML_ENTRY_HIDDEN_PRIMITIVE2("cmode", cmode, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->cmode, 0);   //BYTE_T
#endif
#ifdef CONFIG_IPV6
XML_ENTRY_HIDDEN_PRIMITIVE2("IPVersion", IpProtocol, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->IpProtocol, 0);   //BYTE_T
XML_ENTRY_HIDDEN_ADDR6("SrcIP6", sip6, ipqos_tc, (ipqos_tc+ipqos_tc_Idx)->sip6, 0);   //IA6_T
XML_ENTRY_HIDDEN_ADDR6("DstIP6", dip6, ipqos_tc, (ipqos_tc+ipqos_tc_Idx)->dip6, 0);   //IA6_T
XML_ENTRY_HIDDEN_PRIMITIVE2("SrcIP6PrefixLen", sip6PrefixLen, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->sip6PrefixLen, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("DstIP6PrefixLen", dip6PrefixLen, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->dip6PrefixLen, 0);   //BYTE_T
#endif
XML_ENTRY_HIDDEN_PRIMITIVE2("direction", direction, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->direction, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("vlanID", vlanID, ipqos_tc, "%u", (ipqos_tc+ipqos_tc_Idx)->vlanID, 0);   //INTEGER_T
XML_ENTRY_HIDDEN_STRING2("ssid", ssid, ipqos_tc, (ipqos_tc+ipqos_tc_Idx)->ssid, 0);   //STRING_T
#else
...
#ifdef CONFIG_00R0
XML_DIR_HIDDEN_ARRAY("IP_QOS_QUEUE_TBL", ipqos_queue, root, ipqos_queue_Idx, MAX_QOS_QUEUE_NUM, MIB_IP_QOS_QUEUE_TBL);
XML_ENTRY_HIDDEN_PRIMITIVE2("outif", outif, ipqos_queue, "%u", (ipqos_queue+ipqos_queue_Idx)->outif, 0);   //DWORD_T
XML_ENTRY_HIDDEN_PRIMITIVE2("prior", prior, ipqos_queue, "%hhu", (ipqos_queue+ipqos_queue_Idx)->prior, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("weight", weight, ipqos_queue, "%hhu", (ipqos_queue+ipqos_queue_Idx)->weight, 0);   //BYTE_T
XML_ENTRY_HIDDEN_PRIMITIVE2("shaping_rate", shaping_rate, ipqos_queue, "%d", (ipqos_queue+ipqos_queue_Idx)->shaping_rate, 0);   //INTEGER_T
XML_ENTRY_HIDDEN_PRIMITIVE2("enable", enable, ipqos_queue, "%hhu", (ipqos_queue+ipqos_queue_Idx)->enable, 0);   //BYTE_T
XML_ENTRY_HIDDEN_STRING2("desc", desc, ipqos_queue, (ipqos_queue+ipqos_queue_Idx)->desc, 0);   //STRING_T
//#ifdef _CWMP_MIB_ /*mib for cwmp-tr069*/
XML_ENTRY_HIDDEN_PRIMITIVE2("QueueInstNum", QueueInstNum, ipqos_queue, "%u", (ipqos_queue+ipqos_queue_Idx)->QueueInstNum, 0);   //DWORD_T
//#endif
#else
...
XML_ENTRY_PRIMITIVE2("shaping_rate", shaping_rate, ipqos_queue, "%d", (ipqos_queue+ipqos_queue_Idx)->shaping_rate, 0);   //INTEGER_T
...
#ifdef CONFIG_00R0
XML_ENTRY_PRIMITIVE2("add_by_wan", add_by_wan, rip, "%hhu", (rip+rip_Idx)->add_by_wan, 0);   //BYTE_T
#endif
/* CHAIN RIP_TBL END*/
...
MIB_CE_MBSSIB_T _mbssid[6];
MIB_CE_MBSSIB_Tp mbssid=_mbssid;
XML_DIR_ARRAY("WLAN_MBSSIB_TBL", mbssid, root, mbssid_Idx, 6, MIB_MBSSIB_TBL);
...
XML_ENTRY_PRIMITIVE2("rs2Port", rs2Port, mbssid, "%hu", (mbssid+mbssid_Idx)->rs2Port, 0);   //WORD_T
XML_ENTRY_ADDR("rs2IpAddr", rs2IpAddr, mbssid, (mbssid+mbssid_Idx)->rs2IpAddr, 0);   //IA_T
XML_ENTRY_STRING2("rs2Password", rs2Password, mbssid, (mbssid+mbssid_Idx)->rs2Password, 0);   //STRING_T
#endif
...
XML_ENTRY_BYTE5("wep64Key1", wep64Key1, mbssid, (mbssid+mbssid_Idx)->wep64Key1, 0);   //BYTE5_T
XML_ENTRY_BYTE5("wep64Key2", wep64Key2, mbssid, (mbssid+mbssid_Idx)->wep64Key2, 0);   //BYTE5_T
XML_ENTRY_BYTE5("wep64Key3", wep64Key3, mbssid, (mbssid+mbssid_Idx)->wep64Key3, 0);   //BYTE5_T
XML_ENTRY_BYTE5("wep64Key4", wep64Key4, mbssid, (mbssid+mbssid_Idx)->wep64Key4, 0);   //BYTE5_T
XML_ENTRY_BYTE13("wep128Key1", wep128Key1, mbssid, (mbssid+mbssid_Idx)->wep128Key1, 0);   //BYTE13_T
XML_ENTRY_BYTE13("wep128Key2", wep128Key2, mbssid, (mbssid+mbssid_Idx)->wep128Key2, 0);   //BYTE13_T
XML_ENTRY_BYTE13("wep128Key3", wep128Key3, mbssid, (mbssid+mbssid_Idx)->wep128Key3, 0);   //BYTE13_T
XML_ENTRY_BYTE13("wep128Key4", wep128Key4, mbssid, (mbssid+mbssid_Idx)->wep128Key4, 0);   //BYTE13_T
...
#endif
#ifdef WLAN_11K
XML_ENTRY_PRIMITIVE2("rm_activated", rm_activated, mbssid, "%hhu", (mbssid+mbssid_Idx)->rm_activated, 0);   //BYTE_T
#endif
#ifdef WLAN_11V
XML_ENTRY_PRIMITIVE2("BssTransEnable", BssTransEnable, mbssid, "%hhu", (mbssid+mbssid_Idx)->BssTransEnable, 0);   //BYTE_T
#endif
#ifdef WLAN_LIMITED_STA_NUM
XML_ENTRY_PRIMITIVE2("stanum", stanum, mbssid, "%u", (mbssid+mbssid_Idx)->stanum, 0);   //INTEGER_T
#endif
XML_ENTRY_PRIMITIVE2("txbf", txbf, mbssid, "%hhu", (mbssid+mbssid_Idx)->txbf, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("txbf_mu", txbf_mu, mbssid, "%hhu", (mbssid+mbssid_Idx)->txbf_mu, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("mc2u_disable", mc2u_disable, mbssid, "%hhu", (mbssid+mbssid_Idx)->mc2u_disable, 0);   //BYTE_T
#if defined(CONFIG_00R0) && defined(_CWMP_MIB_)
XML_ENTRY_PRIMITIVE2("func_off", func_off, mbssid, "%hhu", (mbssid+mbssid_Idx)->func_off, 0);   //BYTE_T
#endif
...
MIB_CE_MBSSIB_T _wlan1_mbssid[6];
MIB_CE_MBSSIB_Tp wlan1_mbssid=_wlan1_mbssid;
XML_DIR_ARRAY("WLAN1_MBSSIB_TBL", wlan1_mbssid, root, wlan1_mbssid_Idx, 6, MIB_WLAN1_MBSSIB_TBL);
...
#ifdef WLAN_RADIUS_2SET
XML_ENTRY_PRIMITIVE2("rs2Port", rs2Port, wlan1_mbssid, "%hu", (wlan1_mbssid+wlan1_mbssid_Idx)->rs2Port, 0);   //WORD_T
XML_ENTRY_ADDR("rs2IpAddr", rs2IpAddr, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->rs2IpAddr, 0);   //IA_T
XML_ENTRY_STRING2("rs2Password", rs2Password, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->rs2Password, 0);   //STRING_T
#endif
...
XML_ENTRY_BYTE5("wep64Key1", wep64Key1, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->wep64Key1, 0);   //BYTE5_T
XML_ENTRY_BYTE5("wep64Key2", wep64Key2, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->wep64Key2, 0);   //BYTE5_T
XML_ENTRY_BYTE5("wep64Key3", wep64Key3, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->wep64Key3, 0);   //BYTE5_T
XML_ENTRY_BYTE5("wep64Key4", wep64Key4, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->wep64Key4, 0);   //BYTE5_T
XML_ENTRY_BYTE13("wep128Key1", wep128Key1, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->wep128Key1, 0);   //BYTE13_T
XML_ENTRY_BYTE13("wep128Key2", wep128Key2, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->wep128Key2, 0);   //BYTE13_T
XML_ENTRY_BYTE13("wep128Key3", wep128Key3, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->wep128Key3, 0);   //BYTE13_T
XML_ENTRY_BYTE13("wep128Key4", wep128Key4, wlan1_mbssid, (wlan1_mbssid+wlan1_mbssid_Idx)->wep128Key4, 0);   //BYTE13_T
...
#endif
#ifdef WLAN_11K
XML_ENTRY_PRIMITIVE2("rm_activated", rm_activated, wlan1_mbssid, "%hhu", (wlan1_mbssid+wlan1_mbssid_Idx)->rm_activated, 0);   //BYTE_T
#endif
#ifdef WLAN_11V
XML_ENTRY_PRIMITIVE2("BssTransEnable", BssTransEnable, wlan1_mbssid, "%hhu", (wlan1_mbssid+wlan1_mbssid_Idx)->BssTransEnable, 0);   //BYTE_T
#endif
#ifdef WLAN_LIMITED_STA_NUM
XML_ENTRY_PRIMITIVE2("stanum", stanum, wlan1_mbssid, "%u", (wlan1_mbssid+wlan1_mbssid_Idx)->stanum, 0);   //INTEGER_T
#endif
XML_ENTRY_PRIMITIVE2("txbf", txbf, wlan1_mbssid, "%hhu", (wlan1_mbssid+wlan1_mbssid_Idx)->txbf, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("txbf_mu", txbf_mu, wlan1_mbssid, "%hhu", (wlan1_mbssid+wlan1_mbssid_Idx)->txbf_mu, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("mc2u_disable", mc2u_disable, wlan1_mbssid, "%hhu", (wlan1_mbssid+wlan1_mbssid_Idx)->mc2u_disable, 0);   //BYTE_T
#if defined(CONFIG_00R0) && defined(_CWMP_MIB_)
XML_ENTRY_PRIMITIVE2("func_off", func_off, wlan1_mbssid, "%hhu", (wlan1_mbssid+wlan1_mbssid_Idx)->func_off, 0);   //BYTE_T
#endif
/* CHAIN WLAN1_MBSSIB_TBL END*/
#endif /*END of defined(CONFIG_RTL_92D_SUPPORT) || defined(WLAN_DUALBAND_CONCURRENT)*/

#if defined(TRIBAND_SUPPORT)
/* CHAIN WLAN2_MBSSIB_TBL*/
static int wlan2_mbssid_Idx=0;
MIB_CE_MBSSIB_T _wlan2_mbssid[6];
MIB_CE_MBSSIB_Tp wlan2_mbssid=_wlan2_mbssid;
XML_DIR_ARRAY("WLAN2_MBSSIB_TBL", wlan2_mbssid, root, wlan2_mbssid_Idx, 6, MIB_WLAN2_MBSSIB_TBL);
XML_ENTRY_PRIMITIVE2("idx", idx, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->idx, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("encrypt", encrypt, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->encrypt, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("enable1X", enable1X, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->enable1X, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wep", wep, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wep, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wpaAuth", wpaAuth, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wpaAuth, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wpaPSKFormat", wpaPSKFormat, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wpaPSKFormat, 0);   //BYTE_T
XML_ENTRY_STRING2("wpaPSK", wpaPSK, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wpaPSK, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("wpaGroupRekeyTime", wpaGroupRekeyTime, wlan2_mbssid, "%ld", (wlan2_mbssid+wlan2_mbssid_Idx)->wpaGroupRekeyTime, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("rsPort", rsPort, wlan2_mbssid, "%hu", (wlan2_mbssid+wlan2_mbssid_Idx)->rsPort, 0);   //WORD_T
XML_ENTRY_ADDR("rsIpAddr", rsIpAddr, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->rsIpAddr, 0);   //IA_T
XML_ENTRY_STRING2("rsPassword", rsPassword, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->rsPassword, 0);   //STRING_T
#ifdef WLAN_RADIUS_2SET
XML_ENTRY_PRIMITIVE2("rs2Port", rs2Port, wlan2_mbssid, "%hu", (wlan2_mbssid+wlan2_mbssid_Idx)->rs2Port, 0);   //WORD_T
XML_ENTRY_ADDR("rs2IpAddr", rs2IpAddr, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->rs2IpAddr, 0);   //IA_T
XML_ENTRY_STRING2("rs2Password", rs2Password, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->rs2Password, 0);   //STRING_T
#endif
XML_ENTRY_PRIMITIVE2("wlanDisabled", wlanDisabled, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wlanDisabled, 0);   //BYTE_T
XML_ENTRY_STRING2("ssid", ssid, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->ssid, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("wlanMode", wlanMode, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wlanMode, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("authType", authType, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->authType, 0);   //BYTE_T
#ifdef _CWMP_MIB_ /*jiunming, mib for cwmp-tr069*/
XML_ENTRY_PRIMITIVE2("cwmp_WLAN_BasicEncry", cwmp_WLAN_BasicEncry, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->cwmp_WLAN_BasicEncry, 0);   //BYTE_T
#endif
XML_ENTRY_PRIMITIVE2("unicastCipher", unicastCipher, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->unicastCipher, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wpa2UnicastCipher", wpa2UnicastCipher, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wpa2UnicastCipher, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("bcnAdvtisement", bcnAdvtisement, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->bcnAdvtisement, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("hidessid", hidessid, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->hidessid, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("userIsolation", userisolation, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->userisolation, 0);   //BYTE_T
#ifdef CONFIG_RTL_WAPI_SUPPORT
XML_ENTRY_STRING2("wapiPsk", wapiPsk, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wapiPsk, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("wapiPskLen", wapiPskLen, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wapiPskLen, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wapiAuth", wapiAuth, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wapiAuth, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wapiPskFormat", wapiPskFormat, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wapiPskFormat, 0);   //BYTE_T
XML_ENTRY_BYTE_ARRAY("wapiAsIpAddr", wapiAsIpAddr, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wapiAsIpAddr, 0); //BYTE_ARRAY_T
#endif
XML_ENTRY_PRIMITIVE2("wepKeyType", wepKeyType, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wepKeyType, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wepDefaultKey", wepDefaultKey, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wepDefaultKey, 0);   //BYTE_T
XML_ENTRY_BYTE5("wep64Key1", wep64Key1, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wep64Key1, 0);   //BYTE5_T
XML_ENTRY_BYTE5("wep64Key2", wep64Key2, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wep64Key2, 0);   //BYTE5_T
XML_ENTRY_BYTE5("wep64Key3", wep64Key3, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wep64Key3, 0);   //BYTE5_T
XML_ENTRY_BYTE5("wep64Key4", wep64Key4, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wep64Key4, 0);   //BYTE5_T
XML_ENTRY_BYTE13("wep128Key1", wep128Key1, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wep128Key1, 0);   //BYTE13_T
XML_ENTRY_BYTE13("wep128Key2", wep128Key2, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wep128Key2, 0);   //BYTE13_T
XML_ENTRY_BYTE13("wep128Key3", wep128Key3, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wep128Key3, 0);   //BYTE13_T
XML_ENTRY_BYTE13("wep128Key4", wep128Key4, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wep128Key4, 0);   //BYTE13_T
XML_ENTRY_PRIMITIVE2("wmmEnabled", wmmEnabled, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wmmEnabled, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("rateAdaptiveEnabled", rateAdaptiveEnabled, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->rateAdaptiveEnabled, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wlanBand", wlanBand, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wlanBand, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("fixedTxRate", fixedTxRate, wlan2_mbssid, "%d", (wlan2_mbssid+wlan2_mbssid_Idx)->fixedTxRate, 0);   //INTEGER_T
#ifdef CONFIG_WIFI_SIMPLE_CONFIG
XML_ENTRY_PRIMITIVE2("wsc_disabled", wsc_disabled, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wsc_disabled, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wsc_configured", wsc_configured, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wsc_configured, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wsc_upnp_enabled", wsc_upnp_enabled, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wsc_upnp_enabled, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wsc_auth", wsc_auth, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wsc_auth, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("wsc_enc", wsc_enc, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->wsc_enc, 0);   //BYTE_T
XML_ENTRY_STRING2("wscPsk", wscPsk, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->wscPsk, 0);   //STRING_T
#endif
#ifdef CONFIG_USB_RTL8187SU_SOFTAP
XML_ENTRY_PRIMITIVE2("mlcstRate", mlcstRate, wlan2_mbssid, "%hu", (wlan2_mbssid+wlan2_mbssid_Idx)->mlcstRate, 0);   //WORD_T
#endif
#ifdef WLAN_11W
XML_ENTRY_PRIMITIVE2("dotIEEE80211W", dotIEEE80211W, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->dotIEEE80211W, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("sha256", sha256, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->sha256, 0);   //BYTE_T
#endif
#ifdef WLAN_11R
XML_ENTRY_PRIMITIVE2("WLAN_FT_ENABLE", ft_enable, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->ft_enable, 0);   //BYTE_T
XML_ENTRY_STRING2("WLAN_FT_MDID", ft_mdid, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->ft_mdid, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("WLAN_FT_OVER_DS", ft_over_ds, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->ft_over_ds, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("WLAN_FT_RES_REQUEST", ft_res_request, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->ft_res_request, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("WLAN_FT_R0KEY_TO", ft_r0key_timeout, wlan2_mbssid, "%d", (wlan2_mbssid+wlan2_mbssid_Idx)->ft_r0key_timeout, 0);   //INTEGER_T
XML_ENTRY_PRIMITIVE2("WLAN_FT_REASOC_TO", ft_reasoc_timeout, wlan2_mbssid, "%d", (wlan2_mbssid+wlan2_mbssid_Idx)->ft_reasoc_timeout, 0);   //INTEGER_T
XML_ENTRY_STRING2("WLAN_FT_R0KH_ID", ft_r0kh_id, wlan2_mbssid, (wlan2_mbssid+wlan2_mbssid_Idx)->ft_r0kh_id, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("WLAN_FT_PUSH", ft_push, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->ft_push, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("WLAN_FT_KH_NUM", ft_kh_num, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->ft_kh_num, 0);   //BYTE_T
#endif
#ifdef WLAN_11K
XML_ENTRY_PRIMITIVE2("rm_activated", rm_activated, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->rm_activated, 0);   //BYTE_T
#endif
#ifdef WLAN_11V
XML_ENTRY_PRIMITIVE2("BssTransEnable", BssTransEnable, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->BssTransEnable, 0);   //BYTE_T
#endif
#ifdef WLAN_LIMITED_STA_NUM
XML_ENTRY_PRIMITIVE2("stanum", stanum, wlan2_mbssid, "%u", (wlan2_mbssid+wlan2_mbssid_Idx)->stanum, 0);   //INTEGER_T
#endif
XML_ENTRY_PRIMITIVE2("txbf", txbf, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->txbf, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("txbf_mu", txbf_mu, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->txbf_mu, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("mc2u_disable", mc2u_disable, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->mc2u_disable, 0);   //BYTE_T
#if defined(CONFIG_00R0) && defined(_CWMP_MIB_)
XML_ENTRY_PRIMITIVE2("func_off", func_off, wlan2_mbssid, "%hhu", (wlan2_mbssid+wlan2_mbssid_Idx)->func_off, 0);   //BYTE_T
#endif
/* CHAIN WLAN2_MBSSIB_TBL END*/
...
XML_ENTRY_PRIMITIVE2("auth_method", auth_method, ipsec, "%hhu", (ipsec+ipsec_Idx)->auth_method, 0); //BYTE_T
...
XML_ENTRY_PRIMITIVE2("pfs_group", pfs_group, ipsec, "%u", (ipsec+ipsec_Idx)->pfs_group, 0); //INTEGER_T
XML_ENTRY_PRIMITIVE2("encrypt_group", encrypt_group, ipsec, "%u", (ipsec+ipsec_Idx)->encrypt_group, 0); //INTEGER_T
XML_ENTRY_PRIMITIVE2("auth_group", auth_group, ipsec, "%u", (ipsec+ipsec_Idx)->auth_group, 0); //INTEGER_T
...
#ifdef IP_ACL
static int aclipv6_Idx=0;
MIB_CE_V6_ACL_IP_T _aclipv6[8];
MIB_CE_V6_ACL_IP_Tp aclipv6 = _aclipv6;
XML_DIR_ARRAY("V6_ACL_IP_TBL", aclipv6, root, aclipv6_Idx, 8, MIB_V6_ACL_IP_TBL);
XML_ENTRY_ADDR6("sip6Start", sip6Start, aclipv6, (aclipv6+aclipv6_Idx)->sip6Start, 0);   //IA6_T
XML_ENTRY_PRIMITIVE2("sip6PrefixLen", sip6PrefixLen, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->sip6PrefixLen, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("Enabled", Enabled, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->Enabled, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("Interface", Interface, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->Interface, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("any", any, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->any, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("telnet", telnet, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->telnet, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("ftp", ftp, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->ftp, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("tftp", tftp, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->tftp, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("web", web, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->web, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("ssh", ssh, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->ssh, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("icmp", icmp, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->icmp, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("https", https, aclipv6, "%hhu", (aclipv6+aclipv6_Idx)->https, 0);   //BYTE_T
#endif
...
#if defined(TRIBAND_SUPPORT)
static int wl2_wds_Idx=0;
WDS_T _wl2_wds[MAX_WDS_NUM];
WDS_Tp wl2_wds=_wl2_wds;
XML_DIR_ARRAY("WLAN2_WDS_TBL", wl2_wds, root, wl2_wds_Idx, MAX_WDS_NUM, MIB_WLAN2_WDS_TBL);
XML_ENTRY_ADDR6("MacAddr", macAddr, wl2_wds, (wl2_wds+wl2_wds_Idx)->macAddr, 0);   //IA6_T
XML_ENTRY_PRIMITIVE2("fixedTxRate", fixedTxRate, wl2_wds, "%u", (wl2_wds+wl2_wds_Idx)->fixedTxRate, 0); //INTEGER_T
XML_ENTRY_STRING2("Comment", comment, wl2_wds, (wl2_wds+wl2_wds_Idx)->comment, 0); //STRING_T
#endif
#endif
...
#if defined(CONFIG_RTL867X_VLAN_MAPPING)
static int port_binding_Idx=0;
MIB_CE_PORT_BINDING_T _port_binding[MAX_LANIF_NUM];
MIB_CE_PORT_BINDING_Tp port_binding=_port_binding;
XML_DIR_ARRAY("PORT_BINDING_TBL", port_binding, root, port_binding_Idx, MAX_LANIF_NUM, MIB_PORT_BINDING_TBL);
XML_ENTRY_PRIMITIVE2("pb_mode", pb_mode, port_binding, "%hhu", (port_binding+port_binding_Idx)->pb_mode, 0); //BYTE_T
XML_ENTRY_PRIMITIVE2("pb_vlan0_a", pb_vlan0_a, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan0_a, 0);   //WORD_T
XML_ENTRY_PRIMITIVE2("pb_vlan0_b", pb_vlan0_b, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan0_b, 0);   //WORD_T
#ifdef CONFIG_RTK_L34_ENABLE
XML_ENTRY_PRIMITIVE2("rg_vlan0_entryID", rg_vlan0_entryID, port_binding, "%hu", (port_binding+port_binding_Idx)->rg_vlan0_entryID, 0);   //WORD_T
#endif
XML_ENTRY_PRIMITIVE2("pb_vlan1_a", pb_vlan1_a, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan1_a, 0);   //WORD_T
XML_ENTRY_PRIMITIVE2("pb_vlan1_b", pb_vlan1_b, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan1_b, 0);   //WORD_T
#ifdef CONFIG_RTK_L34_ENABLE
XML_ENTRY_PRIMITIVE2("rg_vlan1_entryID", rg_vlan1_entryID, port_binding, "%hu", (port_binding+port_binding_Idx)->rg_vlan1_entryID, 0);   //WORD_T
#endif
XML_ENTRY_PRIMITIVE2("pb_vlan2_a", pb_vlan2_a, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan2_a, 0);   //WORD_T
XML_ENTRY_PRIMITIVE2("pb_vlan2_b", pb_vlan2_b, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan2_b, 0);   //WORD_T
#ifdef CONFIG_RTK_L34_ENABLE
XML_ENTRY_PRIMITIVE2("rg_vlan2_entryID", rg_vlan2_entryID, port_binding, "%hu", (port_binding+port_binding_Idx)->rg_vlan2_entryID, 0);   //WORD_T
#endif
XML_ENTRY_PRIMITIVE2("pb_vlan3_a", pb_vlan3_a, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan3_a, 0);   //WORD_T
XML_ENTRY_PRIMITIVE2("pb_vlan3_b", pb_vlan3_b, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan3_b, 0);   //WORD_T
#ifdef CONFIG_RTK_L34_ENABLE
XML_ENTRY_PRIMITIVE2("rg_vlan3_entryID", rg_vlan3_entryID, port_binding, "%hu", (port_binding+port_binding_Idx)->rg_vlan3_entryID, 0);   //WORD_T
#endif
#else
#ifdef _SUPPORT_L2BRIDGING_PROFILE_
static int l2bridging_bridge_group_Idx = 0;
#ifdef CONFIG_00R0
MIB_L2BRIDGE_GROUP_T _l2bridging_bridge_group[IFGROUP_NUM];
#else
MIB_L2BRIDGE_GROUP_T _l2bridging_bridge_group[5];
#endif
MIB_L2BRIDGE_GROUP_Tp l2bridging_bridge_group = _l2bridging_bridge_group;
#ifdef CONFIG_00R0
XML_DIR_ARRAY("L2BRIDGING_BRIDGE_GROUP_TBL", l2bridging_bridge_group, root, l2bridging_bridge_group_Idx, IFGROUP_NUM, MIB_L2BRIDGING_BRIDGE_GROUP_TBL);
#else
...
#if defined(CONFIG_00R0) && defined(CONFIG_RTK_L34_ENABLE) // Rostelecom, Port Binding function
static int port_binding_Idx = 0;
MIB_CE_PORT_BINDING_T _port_binding[5];
MIB_CE_PORT_BINDING_Tp port_binding = _port_binding;
XML_DIR_ARRAY("PORT_BINDING_TBL", port_binding, root, port_binding_Idx, 5, MIB_PORT_BINDING_TBL);
XML_ENTRY_PRIMITIVE2("pb_vlan0_a", pb_vlan0_a, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan0_a, 0);   //WORD_T
XML_ENTRY_PRIMITIVE2("pb_vlan0_b", pb_vlan0_b, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan0_b, 0);   //WORD_T
XML_ENTRY_PRIMITIVE2("rg_vlan0_entryID", rg_vlan0_entryID, port_binding, "%hu", (port_binding+port_binding_Idx)->rg_vlan0_entryID, 0);   //WORD_T
XML_ENTRY_PRIMITIVE2("pb_vlan1_a", pb_vlan1_a, port_binding, "%hu", (port_binding+port_binding_Idx)->pb_vlan1_a, 0);   //WORD_T
...
#endif
#if defined(CONFIG_00R0) 
static int l2bridging_filter_Idx = 0;
MIB_L2BRIDGE_FILTER_T _l2bridging_filter[32];
MIB_L2BRIDGE_FILTER_Tp l2bridging_filter = _l2bridging_filter;
XML_DIR_ARRAY("L2BRIDGING_FILTER_TBL", l2bridging_filter, root, l2bridging_filter_Idx, 32, MIB_L2BRIDGING_FILTER_TBL);
XML_ENTRY_PRIMITIVE2("enable", enable, l2bridging_filter, "%hhu", (l2bridging_filter+l2bridging_filter_Idx)->enable, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("groupnum", groupnum, l2bridging_filter, "%d", (l2bridging_filter+l2bridging_filter_Idx)->groupnum, 0);  //INTEGER_T
XML_ENTRY_PRIMITIVE2("ifdomain", ifdomain, l2bridging_filter, "%u", (l2bridging_filter+l2bridging_filter_Idx)->ifdomain, 0); //INTEGER_T
XML_ENTRY_PRIMITIVE2("ifid", ifid, l2bridging_filter, "%u", (l2bridging_filter+l2bridging_filter_Idx)->ifid, 0); //INTEGER_T
XML_ENTRY_STRING2("itfname", itfname, l2bridging_filter, (l2bridging_filter+l2bridging_filter_Idx)->itfname, 0);  //STRING_T

static int l2bridging_marking_Idx = 0;
MIB_L2BRIDGE_MARKING_T _l2bridging_marking[32];
MIB_L2BRIDGE_MARKING_Tp l2bridging_marking = _l2bridging_marking;
XML_DIR_ARRAY("L2BRIDGING_MARKING_TBL", l2bridging_marking, root, l2bridging_marking_Idx, 32, MIB_L2BRIDGING_MARKING_TBL);
XML_ENTRY_PRIMITIVE2("enable", enable, l2bridging_marking, "%hhu", (l2bridging_marking+l2bridging_marking_Idx)->enable, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("groupnum", groupnum, l2bridging_marking, "%d", (l2bridging_marking+l2bridging_marking_Idx)->groupnum, 0);  //INTEGER_T
XML_ENTRY_PRIMITIVE2("ifdomain", ifdomain, l2bridging_marking, "%u", (l2bridging_marking+l2bridging_marking_Idx)->ifdomain, 0); //INTEGER_T
XML_ENTRY_PRIMITIVE2("ifid", ifid, l2bridging_marking, "%u", (l2bridging_marking+l2bridging_marking_Idx)->ifid, 0); //INTEGER_T
XML_ENTRY_STRING2("itfname", itfname, l2bridging_marking, (l2bridging_marking+l2bridging_marking_Idx)->itfname, 0);  //STRING_T
XML_ENTRY_PRIMITIVE2("vid", vid, l2bridging_marking, "%d", (l2bridging_marking+l2bridging_marking_Idx)->vid, 0);   //INTEGER_T
XML_ENTRY_PRIMITIVE2("vprio", vprio, l2bridging_marking, "%d", (l2bridging_marking+l2bridging_marking_Idx)->vprio, 0);   //INTEGER_T
...
static int lbd_Idx = 0;
MIB_CE_LBD_VLAN_T _lbd_vlan[100];
MIB_CE_LBD_VLAN_Tp lbd_vlan = _lbd_vlan;
XML_DIR_ARRAY("LBD_VLAN_TBL", lbd_vlan, root, lbd_Idx, 100, MIB_LBD_VLAN_TBL);
XML_ENTRY_PRIMITIVE2("vid", vid, lbd_vlan, "%hu", (lbd_vlan+lbd_Idx)->vid, 0);  //WORD_T
#endif
...
#endif
#ifdef _CWMP_MIB_
    {MIB_CWMP_ACL_IP_TBL, _cwmp_aclip, sizeof(MIB_CWMP_ACL_IP_T)},
#endif
#ifdef _PRMT_X_TELEFONICA_ES_DHCPOPTION_
...
#endif
#if defined(TRIBAND_SUPPORT)
	{MIB_WLAN2_AC_TBL, _w2lac, sizeof(MIB_CE_WLAN_AC_T)},
#endif
#endif
#ifdef WLAN_11R
...
#endif
#if defined(TRIBAND_SUPPORT)
	{MIB_WLAN2_FTKH_TBL, _wlan2_ftkh, sizeof(MIB_CE_WLAN_FTKH_T)},
#endif
#endif
#ifdef WLAN_MESH_ACL_ENABLE
    {MIB_WLAN_MESH_ACL_TBL, _wlan_mesh_acl, sizeof(MIB_CE_WLAN_AC_T)},
#if defined(WLAN_DUALBAND_CONCURRENT)
	{MIB_WLAN1_MESH_ACL_TBL, _wlan1_mesh_acl, sizeof(MIB_CE_WLAN_AC_T)},
#endif
#if defined(TRIBAND_SUPPORT)
	{MIB_WLAN2_MESH_ACL_TBL, _wlan2_mesh_acl, sizeof(MIB_CE_WLAN_AC_T)},
#endif
#endif
#endif
...
#endif
#if defined(TRIBAND_SUPPORT)
	{MIB_WLAN2_MBSSIB_TBL, _wlan2_mbssid, sizeof(MIB_CE_MBSSIB_T)},
#endif
#endif
#ifdef LAYER7_FILTER_SUPPORT
...
#ifdef IP_ACL
	{MIB_V6_ACL_IP_TBL, _aclipv6, sizeof(MIB_CE_V6_ACL_IP_T)},
#endif
#endif
#ifdef WLAN_WDS
...
#endif
#if defined(TRIBAND_SUPPORT)
	{MIB_WLAN2_WDS_TBL, _wl2_wds, sizeof(WDS_T)},
#endif
#endif

#if defined(CONFIG_RTL867X_VLAN_MAPPING)
	{MIB_PORT_BINDING_TBL, _port_binding, sizeof(MIB_CE_PORT_BINDING_T)},
#else
#ifdef _SUPPORT_L2BRIDGING_PROFILE_
...
#endif
#if defined(CONFIG_00R0)
	{MIB_L2BRIDGING_FILTER_TBL, _l2bridging_filter, sizeof(MIB_L2BRIDGE_FILTER_T)},
	{MIB_L2BRIDGING_MARKING_TBL, _l2bridging_marking, sizeof(MIB_L2BRIDGE_MARKING_T)},
#endif
#endif
#endif
#ifdef CONFIG_IPV6
...
#endif
#ifdef CONFIG_USER_RTK_LBD
	{MIB_LBD_VLAN_TBL, _lbd_vlan, sizeof(MIB_CE_LBD_VLAN_T)},
#endif
...
int getChainType(unsigned int id)
{
